...
\subsection{Transformation of non-regular grid \label{s-transform}}
   ...
   and variables, but only some of the plotmodes are available for 
   ...
   To allow all plotmodes (and cuts across the grid), the data
...
the origin. While the {\bf body} modifier in the plotmode simply covers
