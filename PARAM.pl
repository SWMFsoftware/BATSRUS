...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'COMPONENT'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'NameComp'},'content' => [{'attrib' => {'if' => '$_NameComp eq \'SC\'','default' => 'T','name' => 'SC'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','default' => 'T','name' => 'IH'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'GM\'','default' => 'T','name' => 'GM'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
! DoCoupleImPressure:
!
! Logical which sets whether GM pressure is driven by IM pressure, default T
! 
! DoCoupleImDensity:
!
! Logical which sets whether GM density is driven by IM density, default F
! 
