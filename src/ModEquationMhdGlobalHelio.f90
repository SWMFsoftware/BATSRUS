Module ModVarIndexes
  ...
  character (len=*), parameter :: NameEquation='Global Heliosphere MHD'
...
! 6. should be updated by advance_*
  ...
  integer, parameter :: MaxSpecies=4
  integer, parameter :: nVar=8+MaxSpecies
...
! CellCenteredVars... can result in an error
  ...
  integer, parameter::rhoU_=5,B_=8
