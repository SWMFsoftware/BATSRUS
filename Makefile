...
install: src/ModHdf5.f90 src/ModImplHypre.f90 src/ModUpdateParamFast.f90 \
...
src/ModUpdateParamFast.f90: src/ModUpdateParamFast_orig.f90
	cp -f src/ModUpdateParamFast_orig.f90 src/ModUpdateParamFast.f90
