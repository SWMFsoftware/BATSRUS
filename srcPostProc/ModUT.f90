...
contains
  ...
  integer function JulianDay(iYear,iMonth,iDay)
    ...
    !--------------------------------------------------------------------------
    IF(iYear < 1801.OR.iYear > 2099)then
  ...
  double precision function day_of_epoc( &
       iYear,iMonth,iDay,iHour,iMin,iSec,FracSecond)
    integer,intent(in)::iYear,iMonth,iDay,iHour,iMin,iSec
    real,intent(in)::FracSecond
    optional::FracSecond,iMin,iSec
    !--------------------------------------------------------------------------
  ...
  double precision function day_2000_epoc( &
       iYear,iMonth,iDay,iHour,iMin,iSec,FracSecond)
    integer,intent(in)::iYear,iMonth,iDay,iHour,iMin,iSec
    real,intent(in)::FracSecond
    optional::FracSecond,iMin,iSec
