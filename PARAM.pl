...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'COMPONENT'},'content' => [{'attrib' => {'input' => 'options','type' => 'string','name' => 'NameComp'},'content' => [{'attrib' => {'if' => '$_NameComp eq \'SC\'','default' => 'T','name' => 'SC'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','default' => 'T','name' => 'IH'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'GM\'','default' => 'T','name' => 'GM'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
