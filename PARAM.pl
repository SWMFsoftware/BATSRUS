...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'COORDSYSTEM'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeCoordSystem'},'content' => [{'attrib' => {'value' => 'GSM','default' => 'T','if' => '$_NameComp eq \'GM\'','name' => 'GeoSolarMagnetic, GSM'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'HGI','default' => 'T','if' => '$_NameComp ne \'GM\'','name' => 'HelioGraphicInertial, HGI'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
! (close to the body).
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'CONSERVATIVECRITERIA'},'content' => [{'attrib' => {'min' => '0','max' => '3','default' => '1','type' => 'integer','name' => 'nConservCrit'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'to' => '$nConservCrit','from' => '1'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeConservCrit'},'content' => [{'attrib' => {'value' => 'r/R/radius/Radius','default' => 'T','name' => 'radius'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'p/P','name' => 'p'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'gradp/GradP','name' => 'grad P'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$rBody','if' => '$TypeConservCrit =~ /^r|radius$/i','default' => '2*$rBody','type' => 'real','name' => 'rConserv'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','if' => '$TypeConservCrit =~ /^p$/i','default' => '0.05','type' => 'real','name' => 'pCoeffConserv'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','if' => '$TypeConservCrit =~ /gradp/i','default' => '0.1','type' => 'real','name' => 'GradPCoeffConserv'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'},{'content' => '
