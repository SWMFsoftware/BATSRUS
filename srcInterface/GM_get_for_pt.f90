...
subroutine GM_get_for_pt(IsNew, NameVar, nVarIn, nDimIn, nPoint, Xyz_DI, &
  ...
  use ModPhysics, ONLY: Si2No_V, UnitX_, No2Si_V, UnitB_, UnitU_, UnitP_, UnitRho_, StateIndexToUnitIndex_V
  ...
  do iPoint = 1, nPoint
     ...
     Data_VI(:,iPoint) = State_V*No2Si_V(StateIndexToUnitIndex_V)
