...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'COMPONENT'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'StringDescription','type' => 'string','length' => '100'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DESCRIPTION','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoEcho','default' => 'F','type' => 'logical'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'ECHO','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DnProgressShort','default' => '10','type' => 'integer','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DnProgressLong','default' => '100','type' => 'integer','min' => '-1'}},{'content' => '
#PROGRESS
10			DnProgressShort
100			DnProgressLong
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PROGRESS','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoTimeAccurate','default' => 'T','type' => 'logical'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TIMEACCURATE','if' => '$_IsStandAlone'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'multiple' => 'T','name' => 'BEGIN_COMP','if' => '$_IsStandAlone'}},{'content' => [{'content' => '

This command is allowed in stand alone mode only for the sake of the 
test suite, which contains these commands when the framework is tested.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'multiple' => 'T','name' => 'END_COMP','if' => '$_IsStandAlone'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RUN','if' => '$_IsStandAlone'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PLANET','if' => '$_IsFirstSession and $_IsStandAlone','alias' => 'MOON,COMET'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'IsRotAxisPrimary','default' => 'T','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RotAxisTheta','type' => 'real','min' => '0','max' => '180'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RotAxisPhi','type' => 'real','min' => '0','max' => '360'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$IsRotAxisPrimary'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'name' => 'PlanetCommand','type' => 'string','value' => 'ROTATIONAXIS'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'ROTATIONAXIS','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseRotation','default' => 'T','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RotationPeriod','type' => 'real'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseRotation'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'name' => 'PlanetCommand','type' => 'string','value' => 'MAGNETICAXIS'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'ROTATION','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'IsMagAxisPrimary','default' => 'T','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MagAxisTheta','type' => 'real','min' => '0','max' => '180'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MagAxisPhi','type' => 'real','min' => '0','max' => '360'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$IsMagAxisPrimary'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'name' => 'PlanetCommand','type' => 'string','value' => 'MAGNETICAXIS'}},{'content' => '
...
date and time given by #STARTTIME.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'MAGNETICAXIS','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DipoleStrength','type' => 'real'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DIPOLE','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DtUpdateB0','default' => '0.0001','type' => 'real','min' => '-1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'UPDATEB0','if' => '$_IsStandAlone'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'USERFLAGS','alias' => 'USER_FLAGS'}},{'content' => [{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TestString','type' => 'string','length' => '100'}},{'content' => '
#TEST
read_inputs
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TESTIJK'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'xTest','type' => 'real','min' => '$xMin','max' => '$xMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'yTest','type' => 'real','min' => '$yMin','max' => '$yMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'zTest','type' => 'real','min' => '$zMin','max' => '$zMax'}},{'content' => '
#TESTXYZ
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TESTXYZ'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nIterTest','default' => '-1','type' => 'integer','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TimeTest','default' => '1e30','type' => 'real','min' => '-1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'VERBOSE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoDebug','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoDebugGhost','default' => 'F','type' => 'logical'}},{'content' => '
#DEBUG
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CODEVERSION','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameUserModule','default' => 'EMPTY','type' => 'string','length' => '100'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'VersionUserModule','default' => '1.0','type' => 'real','min' => '0'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'USERMODULE','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameEquation','default' => 'MHD','type' => 'string','length' => '100'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nVar','default' => '8','type' => 'integer'}},{'content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'EQUATION','if' => '$_IsFirstSession'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'single precision (4)','default' => '$_nByteReal==4','value' => '4'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'double precision (8)','default' => '$_nByteReal==8','value' => '8'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nByteReal','type' => 'integer','input' => 'select'}},{'content' => [{'content' => '
		nByteReal in file must agree with _nByteReal in strict mode.
	','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '$nByteReal==$_nByteReal or not $UseStrict'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PRECISION','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nI','default' => '$nI','type' => 'integer','min' => '$nI','max' => '$nI'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nJ','default' => '$nJ','type' => 'integer','min' => '$nJ','max' => '$nJ'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nK','default' => '$nK','type' => 'integer','min' => '$nK','max' => '$nK'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MinBlockALL','type' => 'integer','min' => '1','max' => '$MaxBlockALL'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CHECKGRIDSIZE','if' => '$_IsFirstSession'}},{'content' => [{'content' => '
#BLOCKLEVELSRELOADED
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TIMING','if' => '$_IsStandAlone'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'TESTING AND TIMING'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!! MAIN INITIAL AND BOUNDARY CONDITION PARAMETERS  !!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameRestartInDir','default' => 'GM/restartIN','type' => 'string','length' => '100'}},{'content' => [{'content' => '
		Restart input directory $NameRestartInDir must exist!
	','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '-d $NameRestartInDir'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RESTARTINDIR','if' => '$_IsFirstSession'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'block','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'one'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeRestartInFile','type' => 'string','input' => 'select'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RESTARTINFILE','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoRestartBFace','default' => 'F','type' => 'logical'}},{'content' => ' 
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'EXTRABOUNDARY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MaxBoundary','default' => '0','type' => 'integer','min' => '0','max' => '6'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoFixOuterBoundary','default' => 'F','type' => 'logical'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$MaxBoundary >= 1'}},{'content' => '
#FACEOUTERBC
0              MaxBoundary            
...
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nRootBlockX','default' => '2','type' => 'integer','min' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nRootBlockY','default' => '1','type' => 'integer','min' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nRootBlockZ','default' => '1','type' => 'integer','min' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'xMin','default' => '-192.0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'xMax','default' => '  64.0','type' => 'real','min' => '$xMin'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'yMin','default' => ' -64.0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'yMax','default' => '  64.0','type' => 'real','min' => '$yMin'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'zMin','default' => ' -64.0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'zMax','default' => '  64.0','type' => 'real','min' => '$zMin'}},{'content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'GRID','if' => '$_IsFirstSession','required' => 'T'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'GSM','if' => '$_NameComp eq \'GM\'','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'HGI','if' => '$_NameComp eq \'IH\'','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'HGC','if' => '$_NameComp eq \'IH\''}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'HGR','if' => '$_NameComp eq \'SC\'','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'HGI','if' => '$_NameComp eq \'SC\''}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeCoordSystem','type' => 'string','input' => 'select'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'multiple' => 'T','name' => 'COORDSYSTEM','alias' => 'COORDINATESYSTEM'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseVertexBasedGrid','default' => 'F','type' => 'logical'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'VERTEXBASEDGRID','if' => '$_IsFirstSession and $_IsStandAlone'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'GRID GEOMETRY'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!! INITIAL TIME AND STEP !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'iYear','default' => '2000','type' => 'integer'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'iMonth','default' => '3','type' => 'integer','min' => '1','max' => '12'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'iDay','default' => '21','type' => 'integer','min' => '1','max' => '31'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'iHour','default' => '0','type' => 'integer','min' => '0','max' => '23'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'iMinute','default' => '0','type' => 'integer','min' => '0','max' => '59'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'iSecond','default' => '0','type' => 'integer','min' => '0','max' => '59'}},{'content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'STARTTIME','if' => '$_IsFirstSession','alias' => 'SETREALTIME'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'tSimulation','default' => '0.0','type' => 'real','min' => '0'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TIMESIMULATION','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nStep','default' => '0','type' => 'integer','min' => '0'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'NSTEP','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nPrevious','default' => '-1','type' => 'integer','min' => '-1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'NPREVIOUS','if' => '$_IsFirstSession'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'INITIAL TIME'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  TIME INTEGRATION PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '1'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','value' => '2'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nStage','type' => 'integer','input' => 'select'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CflExpl','default' => '0.8','type' => 'real','min' => '0','max' => '1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TIMESTEPPING'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseDtFixed','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DtFixedDim','if' => '$UseDtFixed','default' => '1.0','type' => 'real','min' => '0'}},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'FIXEDTIMESTEP'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UsePartSteady','default' => 'F','type' => 'logical'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PARTSTEADY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MinCheckVar','default' => '1','type' => 'integer','min' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MaxCheckVar','default' => '8','type' => 'integer','min' => '$MinCheckVar'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RelativeEps','default' => '0.001','type' => 'real','min' => '0','max' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'AbsoluteEps','default' => '0.0001','type' => 'real','min' => '0'}}],'name' => 'for','type' => 'e','attrib' => {'from' => '$MinCheckVar','to' => '$MaxCheckVar'}},{'content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PARTSTEADYCRITERIA','alias' => 'STEADYCRITERIA'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UsePointImplicit','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BetaPointImplicit','if' => '$UsePointImplicit','default' => '0.5','type' => 'real','min' => '0.5','max' => '1'}},{'content' => '
#POINTIMPLICIT
T		UsePointImplicit
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'POINTIMPLICIT'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UsePartLocal','default' => 'F','type' => 'logical'}},{'content' => '
#PARTLOCAL
T               UsePartLocal
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'IMPLICITCRITERIA','alias' => 'STEPPINGCRITERIA'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UsePartImplicit2','default' => 'F','type' => 'logical'}},{'content' => '
...
backward compatible.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PARTIMPL','alias' => 'PARTIMPLICIT'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ImplCoeff','default' => '1','type' => 'real','min' => '0','max' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseBdf2','default' => 'T','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseSourceImpl','default' => 'F','type' => 'logical'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'IMPLSCHEME','alias' => 'IMPLICITSCHEME'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RejectStepLevel','default' => '0.3','type' => 'real','min' => '0','max' => '0.9'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RejectStepFactor','default' => '0.5','type' => 'real','min' => '0','max' => '0.9'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ReduceStepLevel','default' => '0.6','type' => 'real','min' => '0','max' => '0.9'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ReduceStepFactor','default' => '0.9','type' => 'real','min' => '0','max' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'IncreaseStepLevel','default' => '0.8','type' => 'real','min' => '0','max' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'IncreaseStepFactor','default' => '1.05','type' => 'real','min' => '1','max' => '2'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'IMPLCHECK','alias' => 'IMPLICITCHECK'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseConservativeImplicit','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseNewton','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseNewMatrix','default' => 'T','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MaxIterNewton','default' => '10','type' => 'integer','min' => '1'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseNewton'}},{'content' => '
#NEWTON
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'KRYLOV'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nKrylovVector','default' => 'MaxMatvecKrylov','type' => 'integer','min' => '1'}},{'content' => '
#KRYLOVSIZE
10		nKrylovVector
...
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MaxIteration','default' => '-1','type' => 'integer','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'tSimulationMax','default' => '-1','type' => 'real','min' => '-1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'STOP','if' => '$_IsStandAlone','required' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoCheckStopFile','default' => 'T','type' => 'logical'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CHECKSTOPFILE','if' => '$_IsStandAlone'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CpuTimeMax','default' => '-1','type' => 'real','min' => '-1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CPUTIMEMAX','if' => '$_IsStandAlone'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'STOPPING CRITERIA'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  OUTPUT PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameRestartOutDir','default' => 'GM/restartOUT','type' => 'string','length' => '100'}},{'content' => [{'content' => '
		Restart output directory $NameRestartOutDir must exist
	','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '-d $NameRestartOutDir'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RESTARTOUTDIR'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'block'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'one','default' => 'T'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeRestartOutFile','type' => 'string','input' => 'select'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RESTARTOUTFILE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoSaveRestart','default' => 'T','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DnSaveRestart','default' => '-1','type' => 'integer','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DtSaveRestart','default' => '-1','type' => 'real','min' => '-1'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$DoSaveRestart'}},{'content' => '
#SAVERESTART
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVERESTART'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NamePlotDir','default' => 'GM/IO2','type' => 'string','length' => '100'}},{'content' => [{'content' => '
		Plot directory $NamePlotDir must exist
	','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '-d $NamePlotDir'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVELOGFILE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nSatellite','default' => '0','type' => 'integer','min' => '0'}},{'content' => [{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'MHD vars. dimensional','default' => 'T','value' => 'MHD'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'All vars. dimensional','value' => 'FUL'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Set vars. dimensional','value' => 'VAR'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'All vars. scaled','value' => 'ful'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Set vars. scaled','value' => 'var'}}],'name' => 'part','type' => 'e','attrib' => {'name' => 'TypeSatelliteVar','type' => 'string','required' => 'T','input' => 'select'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'file','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'equation','value' => 'eqn'}}],'name' => 'part','type' => 'e','attrib' => {'name' => 'TypeTrajectory','type' => 'string','required' => 'F','input' => 'select'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'none','exclusive' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'step'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'date'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'time'}}],'name' => 'part','type' => 'e','attrib' => {'multiple' => 'T','name' => 'TypeTime','type' => 'string','required' => 'F','input' => 'select'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'StringSatellite','type' => 'strings','min' => '1','max' => '5'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DnOutput','default' => '1','type' => 'integer','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DtOutput','default' => '-1','type' => 'real','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameTrajectoryFile','type' => 'string','length' => '100'}},{'content' => [{'content' => '
			Trajectory file $NameTrajectoryFile must exist
		','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '-f $NameTrajectoryFile'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameSatelliteVars','if' => '$TypeSatelliteVar =~ /\\bvar\\b/i','type' => 'string','length' => '100'}}],'name' => 'for','type' => 'e','attrib' => {'from' => '1','to' => '$nSatellite'}},{'content' => '
#SATELLITE
2                       nSatellite
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SATELLITE','if' => '$_IsFirstSession'}},{'content' => '

!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++


','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SatelliteTimeStart','default' => '0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SatelliteTimeEnd','default' => '0','type' => 'real'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVEPLOT'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoSaveBinary','default' => 'T','type' => 'logical'}},{'content' => '
#SAVEBINARY
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVEBINARY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoSavePlotsAmr','default' => 'F','type' => 'logical'}},{'content' => '
#SAVEPLOTSAMR
F			DoSavePlotsAmr

! Save plots before each AMR. Default is DoSavePlotsAMR=.false.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVEPLOTSAMR'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoFlush','default' => 'T','type' => 'logical'}},{'content' => '
...
!\\end{verbatim}
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'AMRINIT','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nRefineLevelIC','default' => '0','type' => 'integer','min' => '0'}},{'content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'multiple' => 'T','name' => 'GRIDRESOLUTION','alias' => 'GRIDLEVEL'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MinBlockLevel','default' => '0','type' => 'integer','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MaxBlockLevel','default' => '99','type' => 'integer','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoFixBodyLevel','default' => 'F','type' => 'logical'}},{'content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
! for AMR.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'AMRLEVELS'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DxCellMin','default' => '0','type' => 'real','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DxCellMax','default' => '99999','type' => 'real','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoFixBodyLevel','default' => 'F','type' => 'logical'}},{'content' => '
#AMRRESOLUTION
0.			DxCellMin
99999.			DxCellMax
F			DoFixBodyLevel
...
! both.  If both are set, the final one in the session will set the values
! for AMR.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'AMRRESOLUTION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DnRefine','default' => '-1','type' => 'integer','min' => '-1'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoAutoRefine','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'PercentCoarsen','default' => '20','type' => 'real','min' => '0','max' => '100'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'PercentRefine','default' => '20','type' => 'real','min' => '0','max' => '100'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MaxTotalBlocks','default' => '99999','type' => 'integer','min' => '1'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$DoAutoRefine'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$DnRefine>0'}},{'content' => '
#AMR
2001			DnRefine
...
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => '1'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => '2','default' => 'T'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nOrder','type' => 'integer','input' => 'select'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Roe','value' => 'Roe/roe/1'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Rusanov','default' => 'T','value' => 'Rusanov/rusanov/2/TVDLF'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Linde','value' => 'Linde/linde/3/HLLEL'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Sokolov','value' => 'Sokolov/sokolov/4/AW'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeFlux','type' => 'string','input' => 'select'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'minmod','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'mc'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'mc3'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'beta'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeLimiter','type' => 'string','input' => 'select'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'LimiterBeta','if' => '$TypeLimiter ne \'minmod\'','default' => '1.2','type' => 'real','min' => '1','max' => '2'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$nOrder == 2'}},{'content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SCHEME'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseNonConservative','default' => 'T','type' => 'logical'}},{'content' => '
#NONCONSERVATIVE
T		UseNonConservative

! For Earth the default is using non-conservative equations 
! (close to the body).
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'NONCONSERVATIVE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nConservCrit','default' => '1','type' => 'integer','min' => '0','max' => '3'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'radius','default' => 'T','value' => 'r/R/radius/Radius'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'parabola','value' => 'parabola/paraboloid'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'p','value' => 'p/P'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'grad P','value' => 'gradp/GradP'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeConservCrit','type' => 'string','input' => 'select'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rConserv','if' => '$TypeConservCrit =~ /^r|radius$/i','default' => '6','type' => 'real','min' => '$rBody'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'xParabolaConserv','if' => '$TypeConservCrit =~ /^parabol/i','default' => '6','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'yParabolaConserv','if' => '$TypeConservCrit =~ /^parabol/i','default' => '36','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'pCoeffConserv','if' => '$TypeConservCrit =~ /^p$/i','default' => '0.05','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'GradPCoeffConserv','if' => '$TypeConservCrit =~ /gradp/i','default' => '0.1','type' => 'real','min' => '0'}}],'name' => 'for','type' => 'e','attrib' => {'from' => '1','to' => '$nConservCrit'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CONSERVATIVECRITERIA'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseUpdateCheck','default' => 'T','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RhoMinPercent','default' => '40','type' => 'real','min' => '0','max' => '100'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RhoMaxPercent','default' => '400','type' => 'real','min' => '100'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'pMinPercent','default' => '40','type' => 'real','min' => '0','max' => '100'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'pMaxPercent','default' => '400','type' => 'real','min' => '100'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseUpdateCheck'}},{'content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'MESSAGEPASS','alias' => 'OPTIMIZE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseAccurateReschange','default' => 'F','type' => 'logical'}},{'content' => '
#RESCHANGE
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RESCHANGE','alias' => 'RESOLUTIONCHANGE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseTvdReschange','default' => 'F','type' => 'logical'}},{'content' => '
#TVDRESCHANGE
T		UseTvdResChange
...
! Default value is false, which results in first order 
! prolongation and restriction operators at the resolution changes.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TVDRESCHANGE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseBorisCorrection','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BorisClightFactor','if' => '$UseBorisCorrection','default' => '1','type' => 'real','min' => '0','max' => '1'}},{'content' => '
#BORIS
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'BORIS'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseBorisSimple','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BorisClightFactor','if' => '$UseBorisSimple','default' => '1','type' => 'real','min' => '0','max' => '1'}},{'content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! If UseConstrainB is true, all others should be false.
! At least one of the options should be true.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DIVB'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseB0Source','default' => 'T','type' => 'logical'}},{'content' => '
#DIVBSOURCE
T			UseB0Source

! Add extra source terms related to the non-zero divergence and curl of B0.
! Default is true.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DIVBSOURCE'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Conjugate Gradients','default' => 'T','value' => 'cg'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'BiCGSTAB','value' => 'bicgstab'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeProjectIter','type' => 'string','input' => 'select'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Relative norm','default' => 'T','value' => 'rel'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Maximum error','value' => 'max'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeProjectStop','type' => 'string','input' => 'select'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RelativeLimit','default' => '0.1','type' => 'real','min' => '0','max' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'AbsoluteLimit','default' => '0.0','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MaxMatvec','default' => '50','type' => 'integer','min' => '1'}},{'content' => '
#PROJECTION
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PROJECTION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'pRatioLow','default' => '0.01','type' => 'real','min' => '0','max' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'pRatioHigh','default' => '0.1','type' => 'real','min' => '$pRatioLow','max' => '1'}},{'content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CORRECTP'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseAccurateIntegral','default' => 'T','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseAccurateTrace','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DtExchangeRay','default' => '0.1','type' => 'real','min' => '0.01','max' => '60'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DnRaytrace','default' => '1','type' => 'integer','min' => '1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RAYTRACE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TauCoupleIm','type' => 'real','min' => '1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'IM'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TauCoupleIm','type' => 'real','min' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoCoupleImPressure','default' => 'T','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoCoupleImDensity','default' => 'F','type' => 'logical'}},{'content' => '
...
tested.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'IMCOUPLING'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'SCHEME PARAMETERS'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'Gamma','default' => '1.6666666667','type' => 'real','min' => '1'}},{'content' => '
#GAMMA
1.6666666667		Gamma
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'GAMMA','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'AverageIonMass','default' => '1','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'AverageIonCharge','default' => '1','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ElectronTemperatureRatio','default' => '0','type' => 'real','min' => '0'}},{'content' => '
#PLASMA
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SHOCKTUBE','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwRhoDim','default' => '5','type' => 'real','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwTDim','default' => '181712.175','type' => 'real','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwUxDim','default' => '-400','type' => 'real','max' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwUyDim','default' => '0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwUzDim','default' => '0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwBxDim','default' => '0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwByDim','default' => '0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SwBzDim','default' => '5','type' => 'real'}},{'content' => '
#SOLARWIND
5.0			SwRhoDim [n/cc]
181712.175		SwTDim [K]
-400.0			SwUxDim [km/s]
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SOLARWIND','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseSolarWindFile','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameSolarWindFile','type' => 'string','length' => '100'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseSolarWindFile'}},{'content' => [{'content' => '
		Solar wind file $NameSolarWindFile must exist
	','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '-f $NameSolarWindFile'}},{'content' => '
#SOLARWINDFILE
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SOLARWINDFILE','alias' => 'UPSTREAM_INPUT_FILE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseBody','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rBody','default' => '3','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rCurrents','if' => '$_NameComp eq \'GM\'','default' => '4','type' => 'real','min' => '-1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BodyRhoDim','default' => '1','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BodyTDim','default' => '1000','type' => 'real','min' => '0'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseBody'}},{'content' => '
#BODY
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'GRAVITY','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseHallResist','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'HallFactor','default' => '1','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'HallCmaxFactor','default' => '1','type' => 'real','min' => '0','max' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'HallHyperFactor','default' => '0','type' => 'real','min' => '0','max' => '1'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseHallResist'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HALLRESISTIVITY'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'all','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'shell'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameHallRegion','type' => 'string','input' => 'select'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'R1Hall','default' => '0','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'R2Hall','default' => '0','type' => 'real','min' => '$R1Hall'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'HallWidth','default' => '0','type' => 'real','min' => '0'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$NameHallRegion eq \'shell\''}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HALLREGION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseMassLoading','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoAccelerateMassLoading','default' => 'F','type' => 'logical'}},{'content' => '
#MASSLOADING
F			UseMassLoading
F			DoAccelerateMassLoading
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'MASSLOADING'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseHeatFlux','default' => 'F','type' => 'logical'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseSpitzerForm','default' => 'T','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'Kappa0Heat','default' => '1.23E-11','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'Kappa0Heat','default' => '2.5','type' => 'real'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => 'not $UseSpitzerForm'}},{'content' => '
#HEATFLUX
T		UseHeatFlux
F		UseSpitzerForm
1.23E-11	Kappa0Heat [W/m/K]	! Only if not UseSpitzerForm
2.50E+00	ExponentHeat [-]	! Only if not UseSpitzerForm
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HEATFLUX'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseResistivity','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'constant','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'spitzer'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'anomalous'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'user'}}],'name' => 'parameter','type' => 'e','attrib' => {'case' => 'lower','name' => 'TypeResistivity','type' => 'string','input' => 'select'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'Eta0Si','default' => '1.0E+11','type' => 'real','min' => '0.0'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$TypeResistivity =~ /constant/'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CoulombLogarithm','default' => '20','type' => 'real'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$TypeResistivity =~ /spitzer/'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'Eta0Si','default' => '1.0E+9','type' => 'real','min' => '0.0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'Eta0AnomSi','default' => '2E+09','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'EtaMaxAnomSi','default' => '2E+10','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'jCritAnomSi','default' => '1.0E-9','type' => 'real','min' => '0'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$TypeResistivity =~ /anomalous/'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseResistivity'}},{'content' => '
#RESISTIVITY
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TESTDISSMHD','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UseBody2','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rBody2','default' => '0.1','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'xBody2','default' => '-40','type' => 'real','min' => '$xMin','max' => '$xMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'yBody2','default' => '0','type' => 'real','min' => '$yMin','max' => '$yMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'zBody2','default' => '0','type' => 'real','min' => '$zMin','max' => '$zMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rCurrents2','default' => '1.3*$rBody2','type' => 'real','min' => '$rBody2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RhoDimBody2','default' => '5','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'tDimBody2','default' => '25000','type' => 'real','min' => '0'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseBody2'}},{'content' => '
...
! a second body.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SECONDBODY','if' => '$_IsFirstSession'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BdpDimBody2x','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BdpDimBody2y','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BdpDimBody2z','type' => 'real'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DIPOLEBODY2','if' => '$_IsFirstSession'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'PHYSICS PARAMETERS'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!! SOLAR PROBLEM TYPES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BodyTDim','default' => '2.85E06','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'BodyRhoDim','default' => '1.50E8','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'qSun','default' => '25.0','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'tHeat','default' => '1.75','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rHeat','default' => '1.0','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'SigmaHeat','default' => '4.5','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoInitRope','default' => 'F','type' => 'logical'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeA','default' => '0.7','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeR1','default' => '1.2','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeR0','default' => '1.0','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeA1','default' => '0.23','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeAlpha','default' => '0.0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeRho1','default' => '2.5E-12','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeRho2','default' => '2.0E-13','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ModulationRho','default' => '0.0','type' => 'real','min' => '0','max' => '10'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ModulationP','default' => '0.0','type' => 'real','min' => '0','max' => '10'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'OrientationGL98','default' => '0.0','type' => 'real','min' => '-360','max' => '360'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'LatitudeGL98','default' => '0.0','type' => 'real','min' => '-90','max' => '90'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'LongitudeGL98','default' => '0.0','type' => 'real','min' => '-360','max' => '360'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$DoInitRope'}},{'content' => '
...
(clock-wise).
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HELIOSPHERE','if' => '$_IsFirstSession and $_NameComp ne \'GM\''}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DtUpdateB0','default' => '0.0001','type' => 'real','min' => '-1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HELIOUPDATEB0','if' => '$_NameComp ne \'GM\''}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'HelioDipoleStrength','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'HelioDipoleTilt','default' => '0','type' => 'real','min' => '-90','max' => '90'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HELIODIPOLE','if' => '$_NameComp ne \'GM\''}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'DoSendMHD','default' => 'F','type' => 'logical'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HELIOTEST','if' => '$_NameComp ne \'GM\''}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rBuffMin','default' => '19','type' => 'real','min' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'rBuffMax','default' => '21','type' => 'real','min' => '1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nThetaBuff','default' => '45','type' => 'integer','min' => '18'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'nPhiBuff','default' => '90','type' => 'integer','min' => '36'}},{'content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
Default values are shown above.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HELIOBUFFERGRID','if' => '$_IsFirstSession and $_NameComp eq \'IH\''}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'Low','default' => 'T'}}],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'TypeCme','type' => 'string','input' => 'select'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeA','default' => '0.7','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeR1','default' => '1.2','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeR0','default' => '1.0','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeA1','default' => '0.23','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeAlpha','default' => '0.0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeRho1','default' => '2.5E-12','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeRho2','default' => '2.0E-13','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeB1Dim','default' => '1.0','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'CmeUErupt','default' => '4.0E5','type' => 'real','min' => '0'}},{'content' => '
#CME
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CME','if' => '$_IsFirstSession and $_NameComp ne \'GM\''}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'tArcDim','default' => '1.0E6','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'RhoArcDim','default' => '1.0E-12','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'bArcDim','default' => '0.718144','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ByArcDim','default' => '1.0E6','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'UzArcDim','default' => '5.0E3','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'Phi0Arc','default' => '0.5','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'MuArc','default' => '1.3','type' => 'real'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'ExpArc','default' => '3','type' => 'real','min' => '0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'WidthArc','default' => '0.5','type' => 'real','min' => '0'}},{'content' => '
#ARCADE
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'ARCADE','if' => '$_IsFirstSession and $_NameComp ne \'GM\''}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'SOLAR PROBLEM TYPES'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!! COMET PROBLEM TYPE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'COMET','if' => '$_IsFirstSession'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'COMET PROBLEM TYPE'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'name' => 'NameIncludeFile','default' => 'Param/','type' => 'string','length' => '100'}},{'content' => '

#INCLUDE
Param/SSS_3000		NameIncludeFile

! Include a library file from Param/ or any file from anywhere else.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'INCLUDE'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'SCRIPT COMMANDS'}},{'content' => [{'content' => '
	Either command #SOLARWIND or #SOLARWINDFILE must be used!
','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '($SwRhoDim > 0) or $UseSolarWindFile or $_NameComp ne \'GM\''}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '-d $NamePlotDir or not $_IsFirstSession'}}],'name' => 'commandList','type' => 'e','attrib' => {'name' => 'BATSRUS: GM, SC and IH Components'}}];