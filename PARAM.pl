...
','type' => 't'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_GridSize[0]','name' => 'nI','type' => 'integer'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_GridSize[1]','name' => 'nJ','type' => 'integer'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_GridSize[2]','name' => 'nK','type' => 'integer'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_GridSize[3]','name' => 'MaxBlock','type' => 'integer'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_GridSize[4]','name' => 'MaxImplBlock','type' => 'integer'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_nProc and $MaxBlock and $_nProc*$MaxBlock','name' => 'MaxBlockALL','type' => 'integer'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_NameComp/restartOUT','name' => 'NameRestartOutDir','type' => 'string'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => '$_NameComp/IO2','name' => 'NamePlotDir','type' => 'string'},'type' => 'e'},{'name' => 'commandgroup','content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
','type' => 't'}],'attrib' => {'name' => 'ROTATION','if' => '$_IsStandAlone'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'IsMagAxisPrimary','default' => 'T','type' => 'logical'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MagAxisTheta','max' => '180','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MagAxisPhi','max' => '360','min' => '0','type' => 'real'},'type' => 'e'}],'attrib' => {'expr' => '$IsMagAxisPrimary'},'type' => 'e'},{'name' => 'set','content' => [],'attrib' => {'value' => 'MAGNETICAXIS','name' => 'PlanetCommand','type' => 'string'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'TEST'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iTest','max' => '$nI+2','min' => '-2','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'jTest','max' => '$nJ+2','min' => '-2','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'kTest','max' => '$nK+2','min' => '-2','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iBlockTest','max' => '$MaxBlock','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iProcTest','min' => '0','type' => 'integer'},'type' => 'e'},{'content' => '
#TESTIJK
...
','type' => 't'}],'attrib' => {'name' => 'TESTIJK'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xTest','max' => '$xMax','min' => '$xMin','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yTest','max' => '$yMax','min' => '$yMin','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zTest','max' => '$zMax','min' => '$zMin','type' => 'real'},'type' => 'e'},{'content' => '
#TESTXYZ
...
','type' => 't'}],'attrib' => {'name' => 'TESTTIME'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '1','name' => 'Rho','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '2','name' => 'RhoUx'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '3','name' => 'RhoUy'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '4','name' => 'RhoUz'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '5','name' => 'Bx'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '6','name' => 'By'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '7','name' => 'Bz'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '8','name' => 'e'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '9','name' => 'p'},'type' => 'e'}],'attrib' => {'name' => 'iVarTest','input' => 'select','type' => 'integer'},'type' => 'e'},{'content' => '
#TESTVAR
1                       iVarTest

! Index of variable to be tested. Default is rho_="1", i.e. density.
','type' => 't'}],'attrib' => {'name' => 'TESTVAR'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '0','name' => 'all'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '1','name' => 'x','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '2','name' => 'y'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '3','name' => 'z'},'type' => 'e'}],'attrib' => {'name' => 'iVarTest','input' => 'select','type' => 'integer'},'type' => 'e'},{'content' => '
#TESTDIM
1                       iDimTest
...
','type' => 't'}],'attrib' => {'multiple' => 'T','name' => 'STRICT'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '-1','name' => 'errors and warnings only'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '0','name' => 'start and end of sessions'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '1','name' => 'normal','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '10','name' => 'calls on test processor'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '100','name' => 'calls on all processors'},'type' => 'e'}],'attrib' => {'name' => 'lVerbose','input' => 'select','type' => 'integer'},'type' => 'e'},{'content' => '
#VERBOSE
-1                      lVerbose
...
','type' => 't'}],'attrib' => {'name' => 'DEBUG'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'CodeVersion','default' => '7.50','type' => 'real','min' => '0'},'type' => 'e'},{'content' => '
#CODEVERSION
7.50                    CodeVersion
...
','type' => 't'}],'attrib' => {'name' => 'CODEVERSION','if' => '$_IsFirstSession'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameEquation','default' => 'MHD','length' => '100','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nVar','default' => '8','type' => 'integer'},'type' => 'e'},{'content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
','type' => 't'}],'attrib' => {'name' => 'EQUATION','if' => '$_IsFirstSession'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '4','name' => 'single precision (4)','default' => '$_nByteReal==4'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '8','name' => 'double precision (8)','default' => '$_nByteReal==8'},'type' => 'e'}],'attrib' => {'name' => 'nByteReal','input' => 'select','type' => 'integer'},'type' => 'e'},{'name' => 'rule','content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'PRECISION','if' => '$_IsFirstSession'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nI','default' => '$nI','max' => '$nI','min' => '$nI','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nJ','default' => '$nJ','max' => '$nJ','min' => '$nJ','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nK','default' => '$nK','max' => '$nK','min' => '$nK','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MinBlockALL','max' => '$MaxBlockALL','min' => '1','type' => 'integer'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'BLOCKLEVELSRELOADED'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseTiming','default' => 'T','type' => 'logical'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '-3','name' => 'none'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '-2','name' => 'final only','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '-1','name' => 'end of sessions'},'type' => 'e'},{'name' => 'optioninput','content' => [],'attrib' => {'name' => 'every X steps','default' => '100','min' => '1'},'type' => 'e'}],'attrib' => {'name' => 'Frequency','input' => 'select','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nDepthTiming','default' => '-1','min' => '-1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'cumu','name' => 'cumulative','default' => '1'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'list'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'tree'},'type' => 'e'}],'attrib' => {'name' => 'TypeTimingReport','input' => 'select','type' => 'string'},'type' => 'e'}],'attrib' => {'expr' => '$UseTiming'},'type' => 'e'},{'content' => '
#TIMING
...
!\\end{verbatim}
','type' => 't'}],'attrib' => {'name' => 'PROBLEMTYPE','if' => '$_IsFirstSession','required' => 'T'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameRestartInDir','default' => 'GM/restartIN','length' => '100','type' => 'string'},'type' => 'e'},{'name' => 'rule','content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'EXTRABOUNDARY'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MaxBoundary','default' => '0','max' => '6','min' => '0','type' => 'integer'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DoFixOuterBoundary','default' => 'F','type' => 'logical'},'type' => 'e'}],'attrib' => {'expr' => '$MaxBoundary >= 1'},'type' => 'e'},{'content' => '
#FACEOUTERBC
0              MaxBoundary            
...
','type' => 't'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nRootBlockX','default' => '2','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nRootBlockY','default' => '1','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nRootBlockZ','default' => '1','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xMin','default' => '-192.0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xMax','default' => '  64.0','min' => '$xMin','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yMin','default' => ' -64.0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yMax','default' => '  64.0','min' => '$yMin','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zMin','default' => ' -64.0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zMax','default' => '  64.0','min' => '$zMin','type' => 'real'},'type' => 'e'},{'content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
','type' => 't'}],'attrib' => {'name' => 'GRID','if' => '$_IsFirstSession','required' => 'T'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => 'GSM','default' => 'T','if' => '$_NameComp eq \'GM\''},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'HGI','default' => 'T','if' => '$_NameComp eq \'IH\''},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'HGC','if' => '$_NameComp eq \'IH\''},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'HGR','default' => 'T','if' => '$_NameComp eq \'SC\''},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'HGI','if' => '$_NameComp eq \'SC\''},'type' => 'e'}],'attrib' => {'name' => 'TypeCoordSystem','input' => 'select','type' => 'string'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'multiple' => 'T','alias' => 'COORDINATESYSTEM','name' => 'COORDSYSTEM'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseVertexBasedGrid','default' => 'F','type' => 'logical'},'type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iYear','default' => '2000','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iMonth','default' => '3','max' => '12','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iDay','default' => '21','max' => '31','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iHour','default' => '0','max' => '23','min' => '0','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iMinute','default' => '0','max' => '59','min' => '0','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'iSecond','default' => '0','max' => '59','min' => '0','type' => 'integer'},'type' => 'e'},{'content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
','type' => 't'}],'attrib' => {'alias' => 'SETREALTIME','name' => 'STARTTIME','if' => '$_IsFirstSession'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'tSimulation','default' => '0.0','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '1','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '2'},'type' => 'e'}],'attrib' => {'name' => 'nStage','input' => 'select','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'CflExpl','default' => '0.8','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'TIMESTEPPING'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseDtFixed','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DtFixedDim','default' => '1.0','if' => '$UseDtFixed','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'attrib' => {'name' => 'PARTSTEADY'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MinCheckVar','default' => '1','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MaxCheckVar','default' => '8','min' => '$MinCheckVar','type' => 'integer'},'type' => 'e'},{'name' => 'for','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'RelativeEps','default' => '0.001','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'AbsoluteEps','default' => '0.0001','min' => '0','type' => 'real'},'type' => 'e'}],'attrib' => {'to' => '$MaxCheckVar','from' => '$MinCheckVar'},'type' => 'e'},{'content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
','type' => 't'}],'attrib' => {'alias' => 'STEADYCRITERIA','name' => 'PARTSTEADYCRITERIA'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UsePartLocal','default' => 'F','type' => 'logical'},'type' => 'e'},{'content' => '
#PARTLOCAL
T               UsePartLocal
...
','type' => 't'}],'attrib' => {'name' => 'PARTLOCAL'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UsePointImplicit','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UsePartImplicit','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseFullImplicit','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'CflImpl','default' => '100','if' => '$UsePartImplicit or $UseFullImplicit','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'rule','content' => [{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'dt','name' => 'Time step','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'r/R','name' => 'Radial distance'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'test','name' => 'Test block'},'type' => 'e'}],'attrib' => {'name' => 'TypeImplCrit','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'rImplicit','if' => '$TypeImplCrit eq \'R\'','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'STEPPINGCRITERIA','name' => 'IMPLICITCRITERIA'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'ImplCoeff','default' => '1','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseBdf2','default' => 'T','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseSourceImpl','default' => 'F','type' => 'logical'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'IMPLICITSTEP','name' => 'IMPLSTEP'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => '1','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => '2'},'type' => 'e'}],'attrib' => {'name' => 'nOrderImpl','input' => 'select','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'Roe/roe/1','name' => 'Roe'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'Rusanov/rusanov/2/TVDLF','name' => 'Rusanov','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'Linde/linde/3/HLLEL','name' => 'Linde'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'Sokolov/sokolov/4/AW','name' => 'Sokolov'},'type' => 'e'}],'attrib' => {'name' => 'TypeFluxImpl','input' => 'select','type' => 'string'},'type' => 'e'},{'content' => '
#IMPLSCHEME
1               nOrderImpl
...
','type' => 't'}],'attrib' => {'alias' => 'IMPLICITSCHEME','name' => 'IMPLSCHEME'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'RejectStepLevel','default' => '0.3','max' => '0.9','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'RejectStepFactor','default' => '0.5','max' => '0.9','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'ReduceStepLevel','default' => '0.6','max' => '0.9','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'ReduceStepFactor','default' => '0.9','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'IncreaseStepLevel','default' => '0.8','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'IncreaseStepFactor','default' => '1.05','max' => '2','min' => '1','type' => 'real'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'IMPLICITCHECK','name' => 'IMPLCHECK'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseConservativeImplicit','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseNewton','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseNewMatrix','default' => 'T','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MaxIterNewton','default' => '10','min' => '1','type' => 'integer'},'type' => 'e'}],'attrib' => {'expr' => '$UseNewton'},'type' => 'e'},{'content' => '
#NEWTON
...
','type' => 't'}],'attrib' => {'name' => 'NEWTON'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'prec','name' => 'Preconditioned','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'free','name' => 'No preconditioning'},'type' => 'e'}],'attrib' => {'name' => 'TypeJacobian','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'JacobianEps','default' => '$doublePrecision ? 1.e-12 : 1.e-6','max' => '1.e-5','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
#JACOBIAN
...
','type' => 't'}],'attrib' => {'name' => 'PRECONDITIONER'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => 'gmres','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'bicgstab'},'type' => 'e'}],'attrib' => {'name' => 'TypeKrylov','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'nul','name' => '0','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'old','name' => 'previous'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'explicit'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'explicit','name' => 'scaled explicit'},'type' => 'e'}],'attrib' => {'name' => 'TypeInitKrylov','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'ErrorMaxKrylov','default' => '0.001','max' => '0.1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MaxMatvecKrylov','default' => '100','min' => '1','type' => 'integer'},'type' => 'e'},{'content' => '
#KRYLOV
...
','type' => 't'}],'attrib' => {'name' => 'STOP','if' => '$_IsStandAlone','required' => '$_IsStandAlone'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DoCheckStopFile','default' => 'T','type' => 'logical'},'type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!  OUTPUT PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameRestartOutDir','default' => 'GM/restartOUT','length' => '100','type' => 'string'},'type' => 'e'},{'name' => 'rule','content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'SAVERESTART'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NamePlotDir','default' => 'GM/IO2','length' => '100','type' => 'string'},'type' => 'e'},{'name' => 'rule','content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'PLOTDIR'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DoSaveLogfile','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'MHD','name' => 'MHD vars. dimensional','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'FLX','name' => 'Flux vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'RAW','name' => 'Raw vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'VAR','name' => 'Set vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'flx','name' => 'Flux vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'raw','name' => 'Raw vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'var','name' => 'Set vars. scaled'},'type' => 'e'}],'attrib' => {'name' => 'TypeLogVar','required' => 'T','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => 'none','exclusive' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'step'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'date'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'time'},'type' => 'e'}],'attrib' => {'multiple' => 'T','name' => 'TypeTime','required' => 'F','input' => 'select','type' => 'string'},'type' => 'e'}],'attrib' => {'name' => 'StringLog','max' => '4','min' => '1','type' => 'strings'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DnSaveLogfile','default' => '1','min' => '-1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DtSaveLogfile','default' => '-1','min' => '-1','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameLogVars','if' => '$TypeLogVar =~ /var/i','length' => '100','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [{'name' => 'part','content' => [],'attrib' => {'multiple' => 'T','name' => 'LogRadii','min' => '$rBody','type' => 'real'},'type' => 'e'}],'attrib' => {'name' => 'StringLogRadii','if' => '($TypeLogVar=~/flx/i or $NameLogVars=~/flx/i)','max' => '10','length' => '100','min' => '1','type' => 'strings'},'type' => 'e'}],'attrib' => {'expr' => '$DoSaveLogfile'},'type' => 'e'},{'content' => '
#SAVELOGFILE
...
','type' => 't'}],'attrib' => {'name' => 'SAVELOGFILE'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nSatellite','default' => '0','min' => '0','type' => 'integer'},'type' => 'e'},{'name' => 'for','content' => [{'name' => 'parameter','content' => [{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'MHD','name' => 'MHD vars. dimensional','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'FUL','name' => 'All vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'VAR','name' => 'Set vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'ful','name' => 'All vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'var','name' => 'Set vars. scaled'},'type' => 'e'}],'attrib' => {'name' => 'TypeSatelliteVar','required' => 'T','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => 'file','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'eqn','name' => 'equation'},'type' => 'e'}],'attrib' => {'name' => 'TypeTrajectory','required' => 'F','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => 'none','exclusive' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'step'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'date'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'time'},'type' => 'e'}],'attrib' => {'multiple' => 'T','name' => 'TypeTime','required' => 'F','input' => 'select','type' => 'string'},'type' => 'e'}],'attrib' => {'name' => 'StringSatellite','max' => '5','min' => '1','type' => 'strings'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DnOutput','default' => '1','min' => '-1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DtOutput','default' => '-1','min' => '-1','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameTrajectoryFile','length' => '100','type' => 'string'},'type' => 'e'},{'name' => 'rule','content' => [{'content' => '
			Trajectory file $NameTrajectoryFile must exist
		','type' => 't'}],'attrib' => {'expr' => '-f $NameTrajectoryFile'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameSatelliteVars','if' => '$TypeSatelliteVar =~ /\\bvar\\b/i','length' => '100','type' => 'string'},'type' => 'e'}],'attrib' => {'to' => '$nSatellite','from' => '1'},'type' => 'e'},{'content' => '
#SATELLITE
2                       nSatellite
...
','type' => 't'}],'attrib' => {'name' => 'SATELLITE','if' => '$_IsFirstSession'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nPlotFile','default' => '0','max' => '100','min' => '0','type' => 'integer'},'type' => 'e'},{'name' => 'for','content' => [{'name' => 'parameter','content' => [{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'tec','name' => 'TECPLOT'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'idl','name' => 'IDL'},'type' => 'e'}],'attrib' => {'name' => 'plotform','required' => 'T','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '3d/3d_','name' => '3D'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'x=0'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'y=0','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'z=0'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'sph'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'los'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'lin'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'slc','if' => '$plotform =~ /\\btec\\b/'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'dpl','if' => '$plotform =~ /\\btec\\b/'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'cut','if' => '$plotform =~ /\\bidl\\b/'},'type' => 'e'}],'attrib' => {'name' => 'plotarea','required' => 'T','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'part','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'MHD','name' => 'MHD vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'FUL','name' => 'All vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'RAW','name' => 'Raw vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'RAY','name' => 'Ray tracing vars. dim.'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'FLX','name' => 'Flux vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'SOL','name' => 'Solar vars. dimensional'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'POS','name' => 'Position vars. dimensional','if' => '$plotarea eq \'lin\''},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'VAR','name' => 'Select dimensional vars.'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'ful','name' => 'All vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'raw','name' => 'Raw vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'ray','name' => 'Ray tracing vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'flx','name' => 'Flux vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'sol','name' => 'Solar vars. scaled'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'pos','name' => 'Position vars. scaled','if' => '$plotarea eq \'lin\''},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'var','name' => 'Select scaled vars.'},'type' => 'e'}],'attrib' => {'name' => 'plotvar','required' => 'T','input' => 'select','type' => 'string'},'type' => 'e'}],'attrib' => {'name' => 'StringPlot','max' => '3','min' => '3','type' => 'strings'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DnSavePlot','min' => '-1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DtSavePlot','min' => '-1','type' => 'real'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xMinCut','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xMaxCut','min' => '$xMinCut','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yMinCut','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yMaxCut','min' => '$yMinCut','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zMinCut','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zMaxCut','min' => '$zMinCut','type' => 'real'},'type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\bdpl|cut|slc\\b/'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xPoint','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yPoint','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zPoint','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xNormal','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yNormal','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zNormal','type' => 'real'},'type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\bslc\\b/'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'Radius','default' => '10','if' => '$plotarea =~ /\\bsph\\b/','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'LosVectorX','default' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'LosVectorY','default' => '0.0001','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'LosVectorZ','default' => '1','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xSizeImage','default' => '20','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'ySizeImage','default' => '20','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xOffset','default' => '10','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yOffset','default' => '10','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'rOccult','default' => '2.5','min' => '1','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MuLimbDarkening','default' => '0.5','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nPixX','default' => '200','min' => '2','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nPixY','default' => '200','min' => '2','type' => 'integer'},'type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\blos\\b/'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'A','name' => 'Advected B'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'B','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'U'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'J'},'type' => 'e'}],'attrib' => {'name' => 'NameLine','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'IsSingleLine','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nLine','default' => '1','max' => '20','min' => '1','type' => 'integer'},'type' => 'e'},{'name' => 'for','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xStartLine','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yStartLine','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zStartLine','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'IsParallel','type' => 'logical'},'type' => 'e'}],'attrib' => {'to' => '$nLine','from' => '1'},'type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\blin\\b/'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DxSavePlot','default' => '-1.0','if' => '($plotform=~/\\bidl\\b/ and $plotarea!~/\\b(sph|los|lin)\\b/)','min' => '-1.0','type' => 'real'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameVars','length' => '100','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NamePars','length' => '100','type' => 'string'},'type' => 'e'}],'attrib' => {'expr' => '$plotvar =~ /\\bvar\\b/i'},'type' => 'e'}],'attrib' => {'to' => '$nPlotFile','from' => '1'},'type' => 'e'},{'content' => '
#SAVEPLOT
8			nPlotfile
...
','type' => 't'}],'attrib' => {'multiple' => 'T','alias' => 'GRIDLEVEL','name' => 'GRIDRESOLUTION'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MinBlockLevel','default' => '0','min' => '-1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MaxBlockLevel','default' => '99','min' => '-1','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DoFixBodyLevel','default' => 'F','type' => 'logical'},'type' => 'e'},{'content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => '1','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => '2'},'type' => 'e'}],'attrib' => {'name' => 'nOrder','input' => 'select','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'Roe/roe/1','name' => 'Roe'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'Rusanov/rusanov/2/TVDLF','name' => 'Rusanov','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'Linde/linde/3/HLLEL','name' => 'Linde'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'Sokolov/sokolov/4/AW','name' => 'Sokolov'},'type' => 'e'}],'attrib' => {'name' => 'TypeFlux','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'name' => 'minmod','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'mc'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'name' => 'beta'},'type' => 'e'}],'attrib' => {'name' => 'TypeLimiter','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'LimiterBeta','default' => '1.2','if' => '$TypeLimiter ne \'minmod\'','max' => '2','min' => '1','type' => 'real'},'type' => 'e'}],'attrib' => {'expr' => '$nOrder == 2'},'type' => 'e'},{'content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
! (close to the body).
','type' => 't'}],'attrib' => {'name' => 'NONCONSERVATIVE'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nConservCrit','default' => '1','max' => '3','min' => '0','type' => 'integer'},'type' => 'e'},{'name' => 'for','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'r/R/radius/Radius','name' => 'radius','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'parabola/paraboloid','name' => 'parabola'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'p/P','name' => 'p'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'gradp/GradP','name' => 'grad P'},'type' => 'e'}],'attrib' => {'name' => 'TypeConservCrit','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'rConserv','default' => '6','if' => '$TypeConservCrit =~ /^r|radius$/i','min' => '$rBody','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xParabolaConserv','default' => '6','if' => '$TypeConservCrit =~ /^parabol/i','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yParabolaConserv','default' => '36','if' => '$TypeConservCrit =~ /^parabol/i','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'pCoeffConserv','default' => '0.05','if' => '$TypeConservCrit =~ /^p$/i','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'GradPCoeffConserv','default' => '0.1','if' => '$TypeConservCrit =~ /gradp/i','min' => '0','type' => 'real'},'type' => 'e'}],'attrib' => {'to' => '$nConservCrit','from' => '1'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'CONSERVATIVECRITERIA'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseUpdateCheck','default' => 'T','type' => 'logical'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'RhoMinPercent','default' => '40','max' => '100','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'RhoMaxPercent','default' => '400','min' => '100','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'pMinPercent','default' => '40','max' => '100','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'pMaxPercent','default' => '400','min' => '100','type' => 'real'},'type' => 'e'}],'attrib' => {'expr' => '$UseUpdateCheck'},'type' => 'e'},{'content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
','type' => 't'}],'attrib' => {'alias' => 'OPTIMIZE','name' => 'MESSAGEPASS'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseTvdAtReschange','default' => 'F','type' => 'logical'},'type' => 'e'},{'content' => '
#TVDRESCHANGE
T		UseTvdAtResChange
...
','type' => 't'}],'attrib' => {'name' => 'TVDRESCHANGE'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseBorisCorrection','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'BorisClightFactor','default' => '1','if' => '$UseBorisCorrection','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
#BORIS
...
','type' => 't'}],'attrib' => {'name' => 'BORIS'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseBorisSimple','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'BorisClightFactor','default' => '1','if' => '$UseBorisSimple','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! Default is true.
','type' => 't'}],'attrib' => {'name' => 'DIVBSOURCE'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DivbDiffCoeff','default' => '0.1666667','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'content' => '
#DIVBDIFFUSION
...
','type' => 't'}],'attrib' => {'name' => 'DIVBDIFFUSION'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'cg','name' => 'Conjugate Gradients','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'bicgstab','name' => 'BiCGSTAB'},'type' => 'e'}],'attrib' => {'name' => 'TypeProjectIter','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => 'rel','name' => 'Relative norm','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => 'max','name' => 'Maximum error'},'type' => 'e'}],'attrib' => {'name' => 'TypeProjectStop','input' => 'select','type' => 'string'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'RelativeLimit','default' => '0.1','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'AbsoluteLimit','default' => '0.0','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'MaxMatvec','default' => '50','min' => '1','type' => 'integer'},'type' => 'e'},{'content' => '
#PROJECTION
...
','type' => 't'}],'attrib' => {'name' => 'PROJECTION'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'pRatioLow','default' => '0.01','max' => '1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'pRatioHigh','default' => '0.1','max' => '1','min' => '$pRatioLow','type' => 'real'},'type' => 'e'},{'content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
','type' => 't'}],'attrib' => {'name' => 'CORRECTP'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseAccurateIntegral','default' => 'T','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseAccurateTrace','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DtExchangeRay','default' => '0.1','max' => '60','min' => '0.01','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'DnRaytrace','default' => '1','min' => '1','type' => 'integer'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'MAGNETOSPHERE','name' => 'BODY','if' => '$_IsFirstSession'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseGravity','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'parameter','content' => [{'name' => 'option','content' => [],'attrib' => {'value' => '0','name' => 'central mass','default' => 'T'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '1','name' => 'X direction'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '2','name' => 'Y direction'},'type' => 'e'},{'name' => 'option','content' => [],'attrib' => {'value' => '3','name' => 'Z direction'},'type' => 'e'}],'attrib' => {'name' => 'iDirGravity','if' => '$UseGravity','input' => 'select','type' => 'integer'},'type' => 'e'},{'content' => '
#GRAVITY
...
','type' => 't'}],'attrib' => {'name' => 'TESTDISSMHD','if' => '$_IsFirstSession'},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'UseBody2','default' => 'F','type' => 'logical'},'type' => 'e'},{'name' => 'if','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'rBody2','default' => '0.1','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'xBody2','default' => '-40','max' => '$xMax','min' => '$xMin','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'yBody2','default' => '0','max' => '$yMax','min' => '$yMin','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'zBody2','default' => '0','max' => '$zMax','min' => '$zMin','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'rCurrents2','default' => '1.3*$rBody2','min' => '$rBody2','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'RhoDimBody2','default' => '5','min' => '0','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'tDimBody2','default' => '25000','min' => '0','type' => 'real'},'type' => 'e'}],'attrib' => {'expr' => '$UseBody2'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'HELIOUPDATEB0','if' => '$_NameComp ne \'GM\''},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'HelioDipoleStrength','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'HelioDipoleTilt','default' => '0','max' => '90','min' => '-90','type' => 'real'},'type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'HELIOTEST','if' => '$_NameComp ne \'GM\''},'type' => 'e'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'rBuffMin','default' => '19','min' => '1','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'rBuffMax','default' => '21','min' => '1','type' => 'real'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nThetaBuff','default' => '45','min' => '18','type' => 'integer'},'type' => 'e'},{'name' => 'parameter','content' => [],'attrib' => {'name' => 'nPhiBuff','default' => '90','min' => '36','type' => 'integer'},'type' => 'e'},{'content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'name' => 'command','content' => [{'name' => 'parameter','content' => [],'attrib' => {'name' => 'NameIncludeFile','default' => 'Param/','length' => '100','type' => 'string'},'type' => 'e'},{'content' => '
