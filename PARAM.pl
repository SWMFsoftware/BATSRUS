...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'RESTARTOUTFILE'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeRestartOutFile'},'content' => [{'attrib' => {'default' => 'T','name' => 'block'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'one'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'HALLRESISTIVITY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseHallResist'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseHallResist'},'content' => [{'attrib' => {'min' => '0','default' => '1','type' => 'real','name' => 'HallFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','max' => '1','default' => '1','type' => 'real','name' => 'HallCmaxFactor'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
