...
module ModVarIndexes
  ...
  character(len=*), parameter :: NameConservativeVar = &
       'HpRho HpMx HpMy HpMz Bx By Bz HpE '// &
       'NpRho NpMx NpMy NpMz NpE '// &
       'OpRho OpMx OpMy OpMz OpE'

  ! The space separated list of nVar primitive variables for plotting
  character(len=*), parameter :: NamePrimitiveVar = &
       'HpRho HpUx HpUy HpUz Bx By Bz HpP '// &
       'NpRho NpUx NpUy NpUz NpP '// &
       'OpRho OpUx OpUy OpUz OpP'

  ! The space separated list of nVar primitive variables for TECplot output
  character(len=*), parameter :: NamePrimitiveVarTec = &
       '"`r^H^+", "U_x^H^+", "U_y^H^+", "U_z^H^+", "B_x", "B_y", "B_z", "p^H^+", ' // &
       '"`r^N^+", "U_x^N^+", "U_y^N^+", "U_z^N^+", "P^N^+", ' // &
