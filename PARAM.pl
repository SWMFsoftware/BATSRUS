...
','type' => 't'},{'content' => [{'content' => [{'content' => [],'attrib' => {'if' => '$_NameComp eq \'SC\'','default' => 'T','name' => 'SC'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$_NameComp eq \'IH\'','default' => 'T','name' => 'IH'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$_NameComp eq \'GM\'','default' => 'T','name' => 'GM'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'NameComp','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'COMPONENT'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'length' => '100','name' => 'StringDescription','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','name' => 'DESCRIPTION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'DoEcho','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','name' => 'ECHO'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '10','name' => 'DnProgressShort','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','default' => '100','name' => 'DnProgressLong','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
#PROGRESS
10			DnProgressShort
100			DnProgressLong
...
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','name' => 'PROGRESS'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'DoTimeAccurate','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','multiple' => 'T','name' => 'BEGIN_COMP'},'name' => 'command','type' => 'e'},{'content' => [{'content' => '

This command is allowed in stand alone mode only for the sake of the 
test suite, which contains these commands when the framework is tested.
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','multiple' => 'T','name' => 'END_COMP'},'name' => 'command','type' => 'e'},{'content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','alias' => 'MOON,COMET','name' => 'PLANET'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'IsRotAxisPrimary','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','name' => 'RotAxisTheta','type' => 'real','max' => '180'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','name' => 'RotAxisPhi','type' => 'real','max' => '360'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$IsRotAxisPrimary'},'name' => 'if','type' => 'e'},{'content' => [],'attrib' => {'name' => 'PlanetCommand','type' => 'string','value' => 'ROTATIONAXIS'},'name' => 'set','type' => 'e'},{'content' => '
...
date and time given by #STARTTIME.
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','name' => 'MAGNETICAXIS'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'DipoleStrength','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','name' => 'DIPOLE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '0.0001','name' => 'DtUpdateB0','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
but much shorter.
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','name' => 'IDEALAXES'},'name' => 'command','type' => 'e'}],'attrib' => {'name' => 'PLANET PARAETERS'},'name' => 'commandgroup','type' => 'e'},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!  USER DEFINED INPUT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'length' => '100','name' => 'TestString','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
#TEST
read_inputs
...
','type' => 't'}],'attrib' => {'name' => 'TEST'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-2','name' => 'iTest','type' => 'integer','max' => '$nI+2'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-2','name' => 'jTest','type' => 'integer','max' => '$nJ+2'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-2','name' => 'kTest','type' => 'integer','max' => '$nK+2'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','name' => 'iBlockTest','type' => 'integer','max' => '$MaxBlock'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','name' => 'iProcTest','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
#TESTIJK
...
','type' => 't'}],'attrib' => {'name' => 'TESTIJK'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '$xMin','name' => 'xTest','type' => 'real','max' => '$xMax'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$yMin','name' => 'yTest','type' => 'real','max' => '$yMax'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$zMin','name' => 'zTest','type' => 'real','max' => '$zMax'},'name' => 'parameter','type' => 'e'},{'content' => '
#TESTXYZ
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
','type' => 't'}],'attrib' => {'name' => 'TESTXYZ'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'nIterTest','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','default' => '1e30','name' => 'TimeTest','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'DEBUG'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '7.50','name' => 'CodeVersion','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#CODEVERSION
7.50                    CodeVersion
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'CODEVERSION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'length' => '100','default' => 'EMPTY','name' => 'NameUserModule','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.0','name' => 'VersionUserModule','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'USERMODULE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'length' => '100','default' => 'MHD','name' => 'NameEquation','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '8','name' => 'nVar','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'PRECISION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '$nI','default' => '$nI','name' => 'nI','type' => 'integer','max' => '$nI'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$nJ','default' => '$nJ','name' => 'nJ','type' => 'integer','max' => '$nJ'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$nK','default' => '$nK','name' => 'nK','type' => 'integer','max' => '$nK'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','name' => 'MinBlockALL','type' => 'integer','max' => '$MaxBlockALL'},'name' => 'parameter','type' => 'e'},{'content' => '
...
!\\end{verbatim}
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','required' => 'T','name' => 'PROBLEMTYPE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'length' => '100','default' => 'GM/restartIN','name' => 'NameRestartInDir','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINDIR'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'block'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'one'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeRestartInFile','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINFILE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'DoRestartBFace','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => ' 
...
','type' => 't'}],'attrib' => {'name' => 'EXTRABOUNDARY'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'MaxBoundary','type' => 'integer','max' => '6'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'DoFixOuterBoundary','type' => 'logical'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$MaxBoundary >= 1'},'name' => 'if','type' => 'e'},{'content' => '
#FACEOUTERBC
0              MaxBoundary            
...
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'min' => '1','default' => '2','name' => 'nRootBlockX','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '1','name' => 'nRootBlockY','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '1','name' => 'nRootBlockZ','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '-192.0','name' => 'xMin','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$xMin','default' => '  64.0','name' => 'xMax','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => ' -64.0','name' => 'yMin','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$yMin','default' => '  64.0','name' => 'yMax','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => ' -64.0','name' => 'zMin','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$zMin','default' => '  64.0','name' => 'zMax','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','required' => 'T','name' => 'GRID'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'if' => '$_NameComp eq \'GM\'','default' => 'T','name' => 'GSM'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$_NameComp eq \'IH\'','default' => 'T','name' => 'HGI'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'HGC'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$_NameComp eq \'SC\'','default' => 'T','name' => 'HGR'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'HGI'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeCoordSystem','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'COORDINATESYSTEM','multiple' => 'T','name' => 'COORDSYSTEM'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseVertexBasedGrid','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','name' => 'VERTEXBASEDGRID'},'name' => 'command','type' => 'e'}],'attrib' => {'name' => 'GRID GEOMETRY'},'name' => 'commandgroup','type' => 'e'},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!! INITIAL TIME AND STEP !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'default' => '2000','name' => 'iYear','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '3','name' => 'iMonth','type' => 'integer','max' => '12'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '21','name' => 'iDay','type' => 'integer','max' => '31'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'iHour','type' => 'integer','max' => '23'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'iMinute','type' => 'integer','max' => '59'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'iSecond','type' => 'integer','max' => '59'},'name' => 'parameter','type' => 'e'},{'content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','alias' => 'SETREALTIME','name' => 'STARTTIME'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0.0','name' => 'tSimulation','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'TIMESIMULATION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'nStep','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'NSTEP'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'nPrevious','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [{'content' => [],'attrib' => {'value' => '1'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','value' => '2'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'nStage','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.8','name' => 'CflExpl','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'TIMESTEPPING'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseDtFixed','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$UseDtFixed','min' => '0','default' => '1.0','name' => 'DtFixedDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'attrib' => {'name' => 'PARTSTEADY'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '1','default' => '1','name' => 'MinCheckVar','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$MinCheckVar','default' => '8','name' => 'MaxCheckVar','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0.001','name' => 'RelativeEps','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.0001','name' => 'AbsoluteEps','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'from' => '$MinCheckVar','to' => '$MaxCheckVar'},'name' => 'for','type' => 'e'},{'content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
','type' => 't'}],'attrib' => {'alias' => 'STEADYCRITERIA','name' => 'PARTSTEADYCRITERIA'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UsePointImplicit','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$UsePointImplicit','min' => '0.5','default' => '0.5','name' => 'BetaPointImplicit','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => '
#POINTIMPLICIT
T		UsePointImplicit
...
','type' => 't'}],'attrib' => {'name' => 'POINTIMPLICIT'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UsePartLocal','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
#PARTLOCAL
T               UsePartLocal
...
','type' => 't'}],'attrib' => {'name' => 'PARTLOCAL'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UsePointImplicit','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UsePartImplicit','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseFullImplicit','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$UsePartImplicit or $UseFullImplicit','min' => '0','default' => '100','name' => 'CflImpl','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'Time step','value' => 'dt'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Radial distance','value' => 'r/R'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Test block','value' => 'test'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeImplCrit','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$TypeImplCrit eq \'R\'','min' => '0','name' => 'rImplicit','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'STEPPINGCRITERIA','name' => 'IMPLICITCRITERIA'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UsePartImplicit2','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
backward compatible.
','type' => 't'}],'attrib' => {'alias' => 'PARTIMPLICIT','name' => 'PARTIMPL'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '1','name' => 'ImplCoeff','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'UseBdf2','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseSourceImpl','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'IMPLICITSTEP','name' => 'IMPLSTEP'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => '1'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => '2'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'nOrderImpl','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'Roe','value' => 'Roe/roe/1'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'Rusanov','value' => 'Rusanov/rusanov/2/TVDLF'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Linde','value' => 'Linde/linde/3/HLLEL'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Sokolov','value' => 'Sokolov/sokolov/4/AW'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeFluxImpl','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
#IMPLSCHEME
1               nOrderImpl
...
','type' => 't'}],'attrib' => {'alias' => 'IMPLICITSCHEME','name' => 'IMPLSCHEME'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0.3','name' => 'RejectStepLevel','type' => 'real','max' => '0.9'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.5','name' => 'RejectStepFactor','type' => 'real','max' => '0.9'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.6','name' => 'ReduceStepLevel','type' => 'real','max' => '0.9'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.9','name' => 'ReduceStepFactor','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.8','name' => 'IncreaseStepLevel','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '1.05','name' => 'IncreaseStepFactor','type' => 'real','max' => '2'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'IMPLICITCHECK','name' => 'IMPLCHECK'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseConservativeImplicit','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseNewton','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'UseNewMatrix','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '10','name' => 'MaxIterNewton','type' => 'integer'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$UseNewton'},'name' => 'if','type' => 'e'},{'content' => '
#NEWTON
...
','type' => 't'}],'attrib' => {'name' => 'NEWTON'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'Preconditioned','value' => 'prec'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'No preconditioning','value' => 'free'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeJacobian','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '$doublePrecision ? 1.e-12 : 1.e-6','name' => 'JacobianEps','type' => 'real','max' => '1.e-5'},'name' => 'parameter','type' => 'e'},{'content' => '
#JACOBIAN
...
','type' => 't'}],'attrib' => {'name' => 'JACOBIAN'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'name' => 'left'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'symmetric'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'right'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypePrecondSide','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'MBILU'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypePrecond','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.5','name' => 'GustafssonPar','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => '
#PRECONDITIONER
...
','type' => 't'}],'attrib' => {'name' => 'KRYLOV'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '1','default' => 'MaxMatvecKrylov','name' => 'nKrylovVector','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
#KRYLOVSIZE
10		nKrylovVector
...
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'MaxIteration','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'tSimulationMax','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','required' => '$_IsStandAlone','name' => 'STOP'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'DoCheckStopFile','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsStandAlone','name' => 'CHECKSTOPFILE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'CpuTimeMax','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!  OUTPUT PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'length' => '100','default' => 'GM/restartOUT','name' => 'NameRestartOutDir','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'RESTARTOUTDIR'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'name' => 'block'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'one'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeRestartOutFile','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'RESTARTOUTFILE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'DoSaveRestart','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'DnSaveRestart','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'DtSaveRestart','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$DoSaveRestart'},'name' => 'if','type' => 'e'},{'content' => '
#SAVERESTART
...
','type' => 't'}],'attrib' => {'name' => 'SAVERESTART'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'length' => '100','default' => 'GM/IO2','name' => 'NamePlotDir','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'SATELLITE'},'name' => 'command','type' => 'e'},{'content' => '

!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++


','type' => 't'},{'content' => [{'content' => [],'attrib' => {'default' => '0','name' => 'SatelliteTimeStart','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'SatelliteTimeEnd','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'STEADYSTATESATELLITE'},'name' => 'command','type' => 'e'},{'content' => '

!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

','type' => 't'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'nPlotFile','type' => 'integer','max' => '100'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [{'content' => [{'content' => [],'attrib' => {'name' => 'TECPLOT','value' => 'tec'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'IDL','value' => 'idl'},'name' => 'option','type' => 'e'}],'attrib' => {'required' => 'T','input' => 'select','name' => 'plotform','type' => 'string'},'name' => 'part','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => '3D','value' => '3d/3d_'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'value' => 'x=0'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','value' => 'y=0'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'value' => 'z=0'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'value' => 'sph'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'value' => 'los'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'value' => 'lin'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'value' => 'cut'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'slc'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'dpl'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'blk'},'name' => 'option','type' => 'e'}],'attrib' => {'required' => 'T','input' => 'select','name' => 'plotarea','type' => 'string'},'name' => 'part','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'MHD vars. dimensional','value' => 'MHD'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'All vars. dimensional','value' => 'FUL'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Raw vars. dimensional','value' => 'RAW'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Ray tracing vars. dim.','value' => 'RAY'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Flux vars. dimensional','value' => 'FLX'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Solar vars. dimensional','value' => 'SOL'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$plotarea eq \'lin\'','name' => 'Position vars. dimensional','value' => 'POS'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Select dimensional vars.','value' => 'VAR'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'All vars. scaled','value' => 'ful'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Raw vars. scaled','value' => 'raw'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Ray tracing vars. scaled','value' => 'ray'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Flux vars. scaled','value' => 'flx'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Solar vars. scaled','value' => 'sol'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'if' => '$plotarea eq \'lin\'','name' => 'Position vars. scaled','value' => 'pos'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Select scaled vars.','value' => 'var'},'name' => 'option','type' => 'e'}],'attrib' => {'required' => 'T','input' => 'select','name' => 'plotvar','type' => 'string'},'name' => 'part','type' => 'e'}],'attrib' => {'min' => '3','name' => 'StringPlot','type' => 'strings','max' => '3'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','name' => 'DnSavePlot','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','name' => 'DtSavePlot','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'xMinCut','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$xMinCut','name' => 'xMaxCut','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'yMinCut','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$yMinCut','name' => 'yMaxCut','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'zMinCut','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$zMinCut','name' => 'zMaxCut','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\bdpl|cut|slc\\b/'},'name' => 'if','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'xPoint','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'yPoint','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'zPoint','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'xNormal','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'yNormal','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'zNormal','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\bslc\\b/'},'name' => 'if','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'xPoint','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'yPoint','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'zPoint','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\bblk\\b/'},'name' => 'if','type' => 'e'},{'content' => [],'attrib' => {'if' => '$plotarea =~ /\\bsph\\b/','min' => '0','default' => '10','name' => 'Radius','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => '-215','name' => 'ObsPosX','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'ObsPosY','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'ObsPosZ','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-89','default' => '0','name' => 'OffsetAngle','type' => 'real','max' => '89'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '32','name' => 'rSizeImage','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'xOffset','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'yOffset','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '2','name' => 'rOccult','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.5','name' => 'MuLimbDarkening','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '2','default' => '200','name' => 'nPix','type' => 'integer'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\blos\\b/'},'name' => 'if','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'name' => 'Advected B','value' => 'A'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'B'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'U'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'J'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'NameLine','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'IsSingleLine','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '1','name' => 'nLine','type' => 'integer','max' => '20'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'xStartLine','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'yStartLine','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'zStartLine','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'IsParallel','type' => 'logical'},'name' => 'parameter','type' => 'e'}],'attrib' => {'from' => '1','to' => '$nLine'},'name' => 'for','type' => 'e'}],'attrib' => {'expr' => '$plotarea =~ /\\blin\\b/'},'name' => 'if','type' => 'e'},{'content' => [],'attrib' => {'if' => '($plotform=~/\\bidl\\b/ and $plotarea!~/\\b(sph|los|lin)\\b/)','min' => '-1.0','default' => '-1.0','name' => 'DxSavePlot','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'length' => '100','name' => 'NameVars','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'length' => '100','name' => 'NamePars','type' => 'string'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$plotvar =~ /\\bvar\\b/i'},'name' => 'if','type' => 'e'}],'attrib' => {'from' => '1','to' => '$nPlotFile'},'name' => 'for','type' => 'e'},{'content' => '
#SAVEPLOT
9			nPlotfile
...
!\\end{verbatim}
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'AMRINIT'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'nRefineLevelIC','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
','type' => 't'}],'attrib' => {'alias' => 'GRIDLEVEL','multiple' => 'T','name' => 'GRIDRESOLUTION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '0','name' => 'MinBlockLevel','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','default' => '99','name' => 'MaxBlockLevel','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'DoFixBodyLevel','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
! for AMR.
','type' => 't'}],'attrib' => {'name' => 'AMRLEVELS'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '0','name' => 'DxCellMin','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','default' => '99999','name' => 'DxCellMax','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'DoFixBodyLevel','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
#AMRRESOLUTION
0.			DxCellMin
99999.			DxCellMax
F			DoFixBodyLevel
...
! both.  If both are set, the final one in the session will set the values
! for AMR.
','type' => 't'}],'attrib' => {'name' => 'AMRRESOLUTION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '-1','name' => 'DnRefine','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'DoAutoRefine','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '20','name' => 'PercentCoarsen','type' => 'real','max' => '100'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '20','name' => 'PercentRefine','type' => 'real','max' => '100'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '99999','name' => 'MaxTotalBlocks','type' => 'integer'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$DoAutoRefine'},'name' => 'if','type' => 'e'}],'attrib' => {'expr' => '$DnRefine>0'},'name' => 'if','type' => 'e'},{'content' => '
#AMR
2001			DnRefine
...
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [{'content' => [],'attrib' => {'name' => '1'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => '2'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'nOrder','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'Roe','value' => 'Roe/roe/1'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'Rusanov','value' => 'Rusanov/rusanov/2/TVDLF'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Linde','value' => 'Linde/linde/3/HLLEL'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Sokolov','value' => 'Sokolov/sokolov/4/AW'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeFlux','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'minmod'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'mc'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'mc3'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'beta'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeLimiter','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$TypeLimiter ne \'minmod\'','min' => '1','default' => '1.2','name' => 'LimiterBeta','type' => 'real','max' => '2'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$nOrder == 2'},'name' => 'if','type' => 'e'},{'content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
! (close to the body).
','type' => 't'}],'attrib' => {'name' => 'NONCONSERVATIVE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '1','name' => 'nConservCrit','type' => 'integer','max' => '3'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'radius','value' => 'r/R/radius/Radius'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'parabola','value' => 'parabola/paraboloid'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'p','value' => 'p/P'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'grad P','value' => 'gradp/GradP'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeConservCrit','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$TypeConservCrit =~ /^r|radius$/i','min' => '$rBody','default' => '6','name' => 'rConserv','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','min' => '0','default' => '6','name' => 'xParabolaConserv','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','min' => '0','default' => '36','name' => 'yParabolaConserv','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$TypeConservCrit =~ /^p$/i','min' => '0','default' => '0.05','name' => 'pCoeffConserv','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$TypeConservCrit =~ /gradp/i','min' => '0','default' => '0.1','name' => 'GradPCoeffConserv','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'from' => '1','to' => '$nConservCrit'},'name' => 'for','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'CONSERVATIVECRITERIA'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'UseUpdateCheck','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '40','name' => 'RhoMinPercent','type' => 'real','max' => '100'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '100','default' => '400','name' => 'RhoMaxPercent','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '40','name' => 'pMinPercent','type' => 'real','max' => '100'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '100','default' => '400','name' => 'pMaxPercent','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$UseUpdateCheck'},'name' => 'if','type' => 'e'},{'content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
','type' => 't'}],'attrib' => {'alias' => 'OPTIMIZE','name' => 'MESSAGEPASS'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseAccurateReschange','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
#RESCHANGE
...
','type' => 't'}],'attrib' => {'alias' => 'RESOLUTIONCHANGE','name' => 'RESCHANGE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseTvdReschange','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
#TVDRESCHANGE
T		UseTvdResChange
...
! Default value is false, which results in first order 
! prolongation and restriction operators at the resolution changes.
','type' => 't'}],'attrib' => {'name' => 'TVDRESCHANGE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseBorisCorrection','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$UseBorisCorrection','min' => '0','default' => '1','name' => 'BorisClightFactor','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => '
#BORIS
...
','type' => 't'}],'attrib' => {'name' => 'BORIS'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseBorisSimple','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'if' => '$UseBorisSimple','min' => '0','default' => '1','name' => 'BorisClightFactor','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! You can use either Boris or BorisSimple but not both. 
','type' => 't'}],'attrib' => {'name' => 'BORISSIMPLE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'UseDivbSource','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseDivbDiffusion','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseProjection','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseConstrainB','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => '
...
! Default is true.
','type' => 't'}],'attrib' => {'name' => 'DIVBSOURCE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'Conjugate Gradients','value' => 'cg'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'BiCGSTAB','value' => 'bicgstab'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeProjectIter','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'Relative norm','value' => 'rel'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'Maximum error','value' => 'max'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeProjectStop','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.1','name' => 'RelativeLimit','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.0','name' => 'AbsoluteLimit','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '50','name' => 'MaxMatvec','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
#PROJECTION
...
','type' => 't'}],'attrib' => {'name' => 'PROJECTION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0.01','name' => 'pRatioLow','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$pRatioLow','default' => '0.1','name' => 'pRatioHigh','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
','type' => 't'}],'attrib' => {'name' => 'CORRECTP'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'UseAccurateIntegral','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseAccurateTrace','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0.01','default' => '0.1','name' => 'DtExchangeRay','type' => 'real','max' => '60'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '1','name' => 'DnRaytrace','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'IM'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '1','name' => 'TauCoupleIm','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'DoCoupleImPressure','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'DoCoupleImDensity','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'min' => '1','default' => '1.6666666667','name' => 'Gamma','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#GAMMA
1.6666666667		Gamma
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'GAMMA'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '1','name' => 'AverageIonMass','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1','name' => 'AverageIonCharge','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'ElectronTemperatureRatio','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#PLASMA
...
! on the grid.
','type' => 't'}],'attrib' => {'name' => 'SHOCKTUBE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '5','name' => 'SwRhoDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-1','default' => '181712.175','name' => 'SwTDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '-400','name' => 'SwUxDim','type' => 'real','max' => '0'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'SwUyDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'SwUzDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'SwBxDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0','name' => 'SwByDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '5','name' => 'SwBzDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#SOLARWIND
5.0			SwRhoDim [n/cc]
181712.175		SwTDim [K]
-400.0			SwUxDim [km/s]
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'SOLARWIND'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseSolarWindFile','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'length' => '100','name' => 'NameSolarWindFile','type' => 'string'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$UseSolarWindFile'},'name' => 'if','type' => 'e'},{'content' => [{'content' => '
...
','type' => 't'}],'attrib' => {'alias' => 'UPSTREAM_INPUT_FILE','name' => 'SOLARWINDFILE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseBody','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '3','name' => 'rBody','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '4','name' => 'rCurrents','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1','name' => 'BodyRhoDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '10000','name' => 'BodyTDim','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$_NameComp eq \'GM\''},'name' => 'if','type' => 'e'}],'attrib' => {'expr' => '$UseBody'},'name' => 'if','type' => 'e'},{'content' => '
#BODY
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'GRAVITY'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseHallResist','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '1','name' => 'HallFactor','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1','name' => 'HallCmaxFactor','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'HallHyperFactor','type' => 'real','max' => '1'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$UseHallResist'},'name' => 'if','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'HALLRESISTIVITY'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'all'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'name' => 'shell'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'NameHallRegion','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'R1Hall','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$R1Hall','default' => '0','name' => 'R2Hall','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0','name' => 'HallWidth','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$NameHallRegion eq \'shell\''},'name' => 'if','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'name' => 'HALLREGION'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseMassLoading','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'DoAccelerateMassLoading','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
#MASSLOADING
F			UseMassLoading
F			DoAccelerateMassLoading
','type' => 't'}],'attrib' => {'name' => 'MASSLOADING'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseHeatFlux','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'UseSpitzerForm','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => '1.23E-11','name' => 'Kappa0Heat','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '2.5','name' => 'Kappa0Heat','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => 'not $UseSpitzerForm'},'name' => 'if','type' => 'e'},{'content' => '
#HEATFLUX
T		UseHeatFlux
F		UseSpitzerForm
1.23E-11	Kappa0Heat [W/m/K]	! Only if not UseSpitzerForm
2.50E+00	ExponentHeat [-]	! Only if not UseSpitzerForm
','type' => 't'}],'attrib' => {'name' => 'HEATFLUX'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseResistFlux','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'UseSpitzerForm','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'name' => 'localized','value' => 'Localized/localized'},'name' => 'option','type' => 'e'},{'content' => [],'attrib' => {'default' => 'T','name' => 'constant','value' => 'Constant/constant'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeResist','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '9.69953E+8','name' => 'Eta0Resist','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => '150','name' => 'Alpha0Resist','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0.5','name' => 'yShiftResist','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0.05','name' => 'TimeInitRise','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1','name' => 'TimeConstLev','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$TypeResist =~ /localized/i'},'name' => 'if','type' => 'e'}],'attrib' => {'expr' => 'not $UseSpitzerForm'},'name' => 'if','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'UseAnomResist','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => '1.93991E+09','name' => 'Eta0AnomResist','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.93991E+10','name' => 'EtaAnomMaxResist','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.0E-9','name' => 'jCritResist','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$UseAnomResist'},'name' => 'if','type' => 'e'},{'content' => '
#RESISTIVEFLUX
T		UseResistFlux
F		UseSpitzerForm
...
','type' => 't'}],'attrib' => {'name' => 'RESISTIVEFLUX'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'UseDefaultUnits','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '2.635620E-02','name' => 'Grav0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.640000E-01','name' => 'Beta0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.500000E+06','name' => 'Length0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.159850E+01','name' => 'Time0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '5.019000E-11','name' => 'Rho0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.000000E+05','name' => 'Tem0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '6.000000E-01','name' => 'Theta0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '2.500000E+01','name' => 'Delta0Diss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '7.000000E+00','name' => 'EpsilonDiss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '4.500000E+00','name' => 'RhoDifDiss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '4.000000E-01','name' => 'yShiftDiss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '5.000000E-01','name' => 'ScaleHeightDiss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.159850E+01','name' => 'ScaleFactorDiss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '5.000000E-01','name' => 'BZ0iss','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#TESTDISSMHD
F                       UseDefaultUnits
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'TESTDISSMHD'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'UseBody2','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0.1','name' => 'rBody2','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$xMin','default' => '-40','name' => 'xBody2','type' => 'real','max' => '$xMax'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$yMin','default' => '0','name' => 'yBody2','type' => 'real','max' => '$yMax'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$zMin','default' => '0','name' => 'zBody2','type' => 'real','max' => '$zMax'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '$rBody2','default' => '1.3*$rBody2','name' => 'rCurrents2','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '5','name' => 'RhoDimBody2','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '25000','name' => 'tDimBody2','type' => 'real'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$UseBody2'},'name' => 'if','type' => 'e'},{'content' => '
...
! a second body.
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession','name' => 'SECONDBODY'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'BdpDimBody2x','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'BdpDimBody2y','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'name' => 'BdpDimBody2z','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!!!! SOLAR PROBLEM TYPES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '2.85E06','name' => 'BodyTDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.50E8','name' => 'BodyRhoDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '25.0','name' => 'qSun','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.75','name' => 'tHeat','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.0','name' => 'rHeat','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '4.5','name' => 'SigmaHeat','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => 'F','name' => 'DoInitRope','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '0.7','name' => 'CmeA','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.2','name' => 'CmeR1','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.0','name' => 'CmeR0','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0.23','name' => 'CmeA1','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0.0','name' => 'CmeAlpha','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '2.5E-12','name' => 'CmeRho1','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '2.0E-13','name' => 'CmeRho2','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.0','name' => 'ModulationRho','type' => 'real','max' => '10'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.0','name' => 'ModulationP','type' => 'real','max' => '10'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-360','default' => '0.0','name' => 'OrientationGL98','type' => 'real','max' => '360'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-90','default' => '0.0','name' => 'LatitudeGL98','type' => 'real','max' => '90'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-360','default' => '0.0','name' => 'LongitudeGL98','type' => 'real','max' => '360'},'name' => 'parameter','type' => 'e'}],'attrib' => {'expr' => '$DoInitRope'},'name' => 'if','type' => 'e'},{'content' => '
...
(clock-wise).
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'HELIOSPHERE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '-1','default' => '0.0001','name' => 'DtUpdateB0','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOUPDATEB0'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'name' => 'HelioDipoleStrength','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '-90','default' => '0','name' => 'HelioDipoleTilt','type' => 'real','max' => '90'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIODIPOLE'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'default' => 'F','name' => 'DoSendMHD','type' => 'logical'},'name' => 'parameter','type' => 'e'},{'content' => '
...
','type' => 't'}],'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOTEST'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '1','default' => '19','name' => 'rBuffMin','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '1','default' => '21','name' => 'rBuffMax','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '18','default' => '45','name' => 'nThetaBuff','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '36','default' => '90','name' => 'nPhiBuff','type' => 'integer'},'name' => 'parameter','type' => 'e'},{'content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
Default values are shown above.
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession and $_NameComp eq \'IH\'','name' => 'HELIOBUFFERGRID'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [{'content' => [],'attrib' => {'default' => 'T','name' => 'Low'},'name' => 'option','type' => 'e'}],'attrib' => {'input' => 'select','name' => 'TypeCme','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.7','name' => 'CmeA','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.2','name' => 'CmeR1','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.0','name' => 'CmeR0','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0.23','name' => 'CmeA1','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0.0','name' => 'CmeAlpha','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '2.5E-12','name' => 'CmeRho1','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '2.0E-13','name' => 'CmeRho2','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.0','name' => 'CmeB1Dim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '4.0E5','name' => 'CmeUErupt','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#CME
...
','type' => 't'}],'attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'CME'},'name' => 'command','type' => 'e'},{'content' => [{'content' => [],'attrib' => {'min' => '0','default' => '1.0E6','name' => 'tArcDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '1.0E-12','name' => 'RhoArcDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.718144','name' => 'bArcDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.0E6','name' => 'ByArcDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '5.0E3','name' => 'UzArcDim','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '0.5','name' => 'Phi0Arc','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'default' => '1.3','name' => 'MuArc','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '3','name' => 'ExpArc','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => [],'attrib' => {'min' => '0','default' => '0.5','name' => 'WidthArc','type' => 'real'},'name' => 'parameter','type' => 'e'},{'content' => '
#ARCADE
...
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'attrib' => {'length' => '100','default' => 'Param/','name' => 'NameIncludeFile','type' => 'string'},'name' => 'parameter','type' => 'e'},{'content' => '
