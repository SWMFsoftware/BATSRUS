...
module ModAdvance
  ...
  real, target, allocatable:: LeftState_VXI(:,:,:,:,:), RightState_VXI(:,:,:,:,:)
  real, target, allocatable:: LeftState_VYI(:,:,:,:,:), RightState_VYI(:,:,:,:,:)
  real, target, allocatable:: LeftState_VZI(:,:,:,:,:), RightState_VZI(:,:,:,:,:)
  ...
  real, target, allocatable:: FaceDivU_IXI(:,:,:,:,:)
  real, target, allocatable:: FaceDivU_IYI(:,:,:,:,:)
  real, target, allocatable:: FaceDivU_IZI(:,:,:,:,:)
  !$omp threadprivate( FaceDivU_IXI, FaceDivU_IYI, FaceDivU_IZI )

  ! V/dt for CFL time step limit
  real, target, allocatable:: VdtFace_XI(:,:,:,:), VdtFace_YI(:,:,:,:), VdtFace_ZI(:,:,:,:)
  ...
  real, target, allocatable:: Flux_VXI(:,:,:,:,:), Flux_VYI(:,:,:,:,:), &
       Flux_VZI(:,:,:,:,:)
