...
','type' => 't'},{'attrib' => {'value' => 'T','type' => 'logical','name' => 'IsFirstSession'},'content' => [],'type' => 'e','name' => 'set'},{'attrib' => {'value' => 'F','type' => 'logical','name' => 'IsNewSession'},'content' => [],'type' => 'e','name' => 'set'},{'attrib' => {'value' => 'F','type' => 'logical','name' => 'Done'},'content' => [],'type' => 'e','name' => 'set'},{'attrib' => {'value' => 'F','type' => 'logical','name' => 'DoTimeAccurate'},'content' => [],'type' => 'e','name' => 'set'},{'attrib' => {'name' => 'TESTING AND TIMING'},'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTTIME'},'content' => [{'attrib' => {'min' => '-1','default' => '-1','type' => 'integer','name' => 'nIterTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','if' => '$DoTimeAccurate','default' => '1e30','type' => 'real','name' => 'TimeTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTTIME
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'CODEVERSION'},'content' => [{'attrib' => {'min' => '0','type' => 'real','default' => '7.50','name' => 'CodeVersion'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#CODEVERSION
7.50                    CodeVersion
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'PRECISION'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'nByteReal'},'content' => [{'attrib' => {'value' => '4','default' => 'not $doublePrecision','name' => 'single precision (4)'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '8','default' => '$doublePrecision','name' => 'double precision (8)'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#PRECISION
8                       nByteReal
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'CHECKGRIDSIZE'},'content' => [{'attrib' => {'min' => '$nI','max' => '$nI','default' => '$nI','type' => 'integer','name' => 'nI'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$nJ','max' => '$nJ','default' => '$nJ','type' => 'integer','name' => 'nJ'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$nK','max' => '$nK','default' => '$nK','type' => 'integer','name' => 'nK'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '1','type' => 'integer','name' => 'MinBlockALL'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#CHECKGRIDSIZE
       4                        nI
       4                        nJ
       4                        nK
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'RESTART'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoRestart'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoRestart'},'content' => [{'attrib' => {'name' => 'CODEVERSION'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'CHECKGRIDSIZE'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'PRECISION'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'PROBLEMTYPE'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'NEWRESTART'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'NSTEP'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'STARTTIME'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'GRID'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'SOLARWIND'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'BODY'},'content' => [],'type' => 'e','name' => 'defined'},{'attrib' => {'name' => 'SECONDBODY'},'content' => [],'type' => 'e','name' => 'defined'}],'type' => 'e','name' => 'if'},{'content' => '
#RESTART
T               DoRestart
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'NEWRESTART'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'IsRestartBFace'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'NSTEP'},'content' => [{'attrib' => {'min' => '0','default' => '0','type' => 'integer','name' => 'nStep'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#NSTEP
100                     nStep
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'FIXEDTIMESTEP'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseDtFixed'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '1.0','type' => 'real','name' => 'DtFixedDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'IMPLSTEP'},'content' => [{'attrib' => {'min' => '0','max' => '1','default' => '1','type' => 'real','name' => 'ImplCoeff'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '$DoTimeAccurate','type' => 'logical','name' => 'UseBdf2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseSourceImpl'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!! STOPPING CRITERIA !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'required' => 'T','name' => 'STOP'},'content' => [{'attrib' => {'min' => '-1','default' => '1000','type' => 'integer','name' => 'MaxIter'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','if' => '$DoTimeAccurate','default' => '-1','type' => 'real','name' => 'TimeMax'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#STOP
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'SAVERESTART'},'content' => [{'attrib' => {'default' => 'T','type' => 'logical','name' => 'SaveRestart'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$SaveRestart'},'content' => [{'attrib' => {'min' => '-1','default' => '-1','type' => 'integer','name' => 'DnRestart'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','if' => '$DoTimeAccurate','default' => '-1','type' => 'real','name' => 'DtRestart'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#SAVERESTART
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'AMRINITPHYSICS'},'content' => [{'attrib' => {'min' => '0','default' => '0','type' => 'integer','name' => 'nRefineLevelIC'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
! for AMR.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'AMRRESOLUTION'},'content' => [{'attrib' => {'min' => '-1','default' => '0','type' => 'real','name' => 'minCellDx'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','default' => '99999','type' => 'real','name' => 'maxCellDx'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRRESOLUTION
0.			minCellDx
99999.			maxCellDx
F			fixBodyLevel
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'NONCONSERVATIVE'},'content' => [{'attrib' => {'default' => '2*$rBody','type' => 'real','name' => 'rConservative'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#NONCONSERVATIVE
6.		rConservative
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PROJECTION'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectIter'},'content' => [{'attrib' => {'value' => 'cg','name' => 'Conjugate Gradients'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'bicgstab','default' => 'T','name' => 'BiCGSTAB'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectStop'},'content' => [{'attrib' => {'value' => 'rel','default' => 'T','name' => 'Relative norm'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'abs','name' => 'Maximum error'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','max' => '1','default' => '0.1','type' => 'real','name' => 'RelativeLimit'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '0.0','type' => 'real','name' => 'AbsoluteLimit'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '1','default' => '50','type' => 'integer','name' => 'MaxMatvec'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PROJECTION
...
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$IsFirstSession','name' => 'GAMMA'},'content' => [{'attrib' => {'min' => '1','default' => '1.6666666667','type' => 'real','name' => 'Gamma'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#GAMMA
1.6666666667		g
...
! on the grid.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'SOLARWIND'},'content' => [{'attrib' => {'min' => '0','default' => '5','type' => 'real','name' => 'SwRhoDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '181712.175','type' => 'real','name' => 'SwTDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '0','default' => '-400','type' => 'real','name' => 'SwUxDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'SwUyDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'SwUzDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '0','default' => '-400','type' => 'real','name' => 'SwBxDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'SwByDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '5','type' => 'real','name' => 'SwBzDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#SOLARWIND
5.0			SwRhoDim [n/cc]
181712.175		SwTDim [K]
-400.0			SwUxDim [km/s]
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'MAGNETOSPHERE','if' => '$IsFirstSession','name' => 'BODY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBody'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseBody'},'content' => [{'attrib' => {'min' => '0','default' => '3','type' => 'real','name' => 'rBody'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$rBody','default' => '4','type' => 'real','name' => 'rCurrents'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '1','type' => 'real','name' => 'BodyRhoDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '10000','type' => 'real','name' => 'BodyTDim'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#BODY
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'AXES'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeCoordinateSystem'},'content' => [{'attrib' => {'value' => 'GSM','default' => 'T','name' => 'Geocentric Solar Magnetic'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'ordered' => 'T','min' => '1','duplicate' => 'T','max' => '2','type' => 'strings','name' => 'TypeAxes'},'content' => [{'attrib' => {'input' => 'select','required' => 'T','type' => 'string','name' => 'TypeDipole'},'content' => [{'attrib' => {'value' => 'none','name' => 'Zero dipole strength'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ideal','default' => 'T','name' => 'Default dipole strength, no tilt'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'planet','name' => 'Default strength and tilt'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'user','name' => 'Set strength and tilt'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'input' => 'select','required' => 'F','type' => 'string','name' => 'TypeRotation'},'content' => [{'attrib' => {'value' => 'none','name' => 'No rotation'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ideal','default' => 'T','name' => 'Default rate and aligned with dipole'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'planet','name' => 'Default rate and tilt'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'user','name' => 'Set rate and tilt'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$TypeDipole eq \'user\''},'content' => [{'attrib' => {'default' => '31100.0','type' => 'real','name' => 'BdpDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','max' => '180','default' => '30','type' => 'real','name' => 'ThetaTilt'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$TypeRotation eq \'user\''},'content' => [{'attrib' => {'min' => '0','max' => '180','default' => '30','type' => 'real','name' => 'CorotationTilt'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','max' => '360','default' => '90','type' => 'real','name' => 'CorotationLon'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '86400','type' => 'real','name' => 'RotatioPeriod'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#AXES
...
!
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'DIPOLE'},'content' => [{'attrib' => {'default' => '-31100.0','type' => 'real','name' => 'BdpDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoSetDipoleTilt'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','max' => '180','default' => '30','type' => 'real','name' => 'ThetaTilt'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'real','name' => 'DtUpdateB0'},'content' => [{'attrib' => {'value' => '-1','default' => 'T','name' => 'No update'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '0','name' => 'Default update rate'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'min' => '0','default' => '60','name' => 'Set update rate'},'content' => [],'type' => 'e','name' => 'optioninput'}],'type' => 'e','name' => 'parameter'},{'content' => '
#DIPOLE
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'COROTATION'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseCorotation'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseCorotation'},'content' => [{'attrib' => {'default' => 'T','type' => 'logical','name' => 'DoAlignCorotation'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => 'not $DoAlignCorotation','default' => 'F','type' => 'logical','name' => 'DoSetCorotationTilt'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','max' => '180','if' => '$DoSetCorotationTilt','default' => '30','type' => 'real','name' => 'CorotationTilt'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#COROTATION
...
! a second body.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$IsFirstSession','name' => 'DIPOLEBODY2'},'content' => [{'attrib' => {'default' => '0','type' => 'real','name' => 'BdpDim2'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#DIPOLEBODY2
...
','type' => 't'}],'type' => 'e','name' => 'command'}],'type' => 'e','name' => 'commandgroup'},{'attrib' => {'name' => 'OTHER MODULES'},'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!! OTHER MODULES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!


','type' => 't'},{'attrib' => {'name' => 'IONOSPHERE'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseIonosphere'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseIonosphere'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'ConductanceModel'},'content' => [{'attrib' => {'value' => '0','name' => '(0) constant pedersen and 0 Hall'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '1','name' => '(1) constant pedersen and Hall'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2','name' => '(2) F107 flux and and constant Hall'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '3','name' => '(3) Simple oval'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '5','default' => 'T','name' => '(5) Realistic oval'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseFullCurrent'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseFakeRegion2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '150','type' => 'real','name' => 'F107Flux'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '0.25','type' => 'real','name' => 'StarLightPedConductance'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '0.25','type' => 'real','name' => 'PolarCapPedConductance'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','default' => '100','type' => 'integer','name' => 'DnCoupleIonosphere'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','default' => '-1','if' => '$DoTimeAccurate','type' => 'real','name' => 'DtCoupleIonosphere'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#IONOSPHERE
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'UAM'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUam'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseUam'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoUamToMhd'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoMhdToUam'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#UAM
F			UseUAM
F			UAMtoMHD
F			MHDtoUAM
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'IM'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseIm'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseIm'},'content' => [{'attrib' => {'min' => '-1','type' => 'integer','name' => 'DnCoupleIm'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','type' => 'real','name' => 'DtCoupleIm'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','type' => 'real','name' => 'TauCoupleIm'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#IM
F			UseIM
100			dnCoupleIM
600.			dtCoupleIM
0.01			tauCoupleIM
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'AMIE'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseAmie'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMIE
F			UseAmie
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'RAM'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseRam'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#RAM
F			UseRam
...
!!!!!!!!!!!!!!!!!!! COMET PROBLEM TYPE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$IsFirstSession','name' => 'COMET'},'content' => [{'attrib' => {'min' => '0','type' => 'real','name' => 'ProdRate'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','type' => 'real','name' => 'UrNeutral'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','type' => 'real','name' => 'AverageMass'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','type' => 'real','name' => 'IonizationRate'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','type' => 'real','name' => 'kFriction'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#COMET
...
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'INCLUDE'},'content' => [{'attrib' => {'length' => '100','default' => 'Param/','type' => 'string','name' => 'NameIncludeFile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'containsSession'},'content' => [],'type' => 'e','name' => 'formValue'},{'attrib' => {'value' => 'F','if' => '$containsSession','type' => 'logical','name' => 'IsFirstSession'},'content' => [],'type' => 'e','name' => 'set'},{'attrib' => {'input' => 'select','type' => 'integer','name' => 'setsTimeAccurate'},'content' => [{'attrib' => {'value' => '0','default' => 'T','name' => 'no change'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '-1','name' => 'steady state'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '1','name' => 'time accurate'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'formValue'},{'attrib' => {'value' => '$setsTimeAccurate>0','if' => '$setsTimeAccurate != 0','type' => 'logical','name' => 'DoTimeAccurate'},'content' => [],'type' => 'e','name' => 'set'},{'content' => '
#INCLUDE
Param/SSS_3000		NameIncludeFile

! Include a library file from Param/ or any file from anywhere else
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'RUN'},'content' => [{'attrib' => {'value' => 'F','type' => 'logical','name' => 'IsFirstSession'},'content' => [],'type' => 'e','name' => 'set'},{'attrib' => {'value' => 'T','type' => 'logical','name' => 'IsNewSession'},'content' => [],'type' => 'e','name' => 'set'},{'content' => '
#RUN

! Run BATSRUS with the parameters above and then return for the next session
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'END'},'content' => [{'attrib' => {'value' => 'T','type' => 'logical','name' => 'Done'},'content' => [],'type' => 'e','name' => 'set'},{'content' => '
#END
