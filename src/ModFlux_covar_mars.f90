...
Module ModFlux
  use ModVarIndexes,ONLY:Energy_, MaxSpecies
  implicit none
  ...
  real, dimension(MaxSpecies,Maxstrip) :: v_rhoSp_lf
  ...
  real, dimension(MaxSpecies,Maxstrip) :: v_rhoSp_rf
  ...
  common/multiSpflux/ v_rhoSp_lf, v_rhoSp_rf
end module ModFlux
