...
','type' => 't'},{'attrib' => {'name' => 'NEWPARAM','if' => '$_IsStandAlone'},'name' => 'command','content' => [{'attrib' => {'default' => 'T','name' => 'UseNewParam','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => 'T','name' => 'UseNewAxes','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => 'T','name' => 'DoTimeAccurate','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => 'T','name' => 'UseRotatingBc','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'PROGRESS','if' => '$_IsStandAlone'},'name' => 'command','content' => [{'attrib' => {'default' => '10','name' => 'DnProgressShort','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '100','name' => 'DnProgressLong','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#PROGRESS
10			DnProgressShort
100			DnProgressLong
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'MAGNETICAXIS','if' => '$_IsStandAlone'},'name' => 'command','content' => [{'attrib' => {'default' => 'T','name' => 'IsMagAxisPrimary','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$IsMagAxisPrimary'},'name' => 'if','content' => [{'attrib' => {'name' => 'MagAxisTheta','max' => '180','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'MagAxisPhi','max' => '360','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'PlanetCommand','type' => 'string','value' => 'MAGNETICAXIS'},'name' => 'set','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'UPDATEB0','if' => '$_IsStandAlone'},'name' => 'command','content' => [{'attrib' => {'default' => '0.0001','name' => 'DtUpdateB0','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'TESTIJK'},'name' => 'command','content' => [{'attrib' => {'name' => 'iTest','max' => '$nI+2','type' => 'integer','min' => '-2'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'jTest','max' => '$nJ+2','type' => 'integer','min' => '-2'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'kTest','max' => '$nK+2','type' => 'integer','min' => '-2'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'iBlockTest','max' => '$MaxBlock','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'iProcTest','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#TESTIJK
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'TESTXYZ'},'name' => 'command','content' => [{'attrib' => {'name' => 'xTest','max' => '$xMax','type' => 'real','min' => '$xMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'yTest','max' => '$yMax','type' => 'real','min' => '$yMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'zTest','max' => '$zMax','type' => 'real','min' => '$zMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#TESTXYZ
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'TESTTIME'},'name' => 'command','content' => [{'attrib' => {'default' => '-1','name' => 'nIterTest','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1e30','name' => 'TimeTest','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'PRECISION','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'name' => 'nByteReal','type' => 'integer','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => '$_nByteReal==4','name' => 'single precision (4)','value' => '4'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'default' => '$_nByteReal==8','name' => 'double precision (8)','value' => '8'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'expr' => '$nByteReal==$_nByteReal'},'name' => 'rule','content' => [{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'CHECKGRIDSIZE','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '$nI','name' => 'nI','max' => '$nI','type' => 'integer','min' => '$nI'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '$nJ','name' => 'nJ','max' => '$nJ','type' => 'integer','min' => '$nJ'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '$nK','name' => 'nK','max' => '$nK','type' => 'integer','min' => '$nK'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'MinBlockALL','max' => '$MaxBlockALL','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'GRID','if' => '$_IsFirstSession','required' => 'T'},'name' => 'command','content' => [{'attrib' => {'default' => '2','name' => 'nRootBlockX','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1','name' => 'nRootBlockY','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1','name' => 'nRootBlockZ','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '-192.0','name' => 'xMin','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '  64.0','name' => 'xMax','type' => 'real','min' => '$xMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => ' -64.0','name' => 'yMin','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '  64.0','name' => 'yMax','type' => 'real','min' => '$yMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => ' -64.0','name' => 'zMin','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '  64.0','name' => 'zMax','type' => 'real','min' => '$zMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'EXTRABOUNDARY'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'UseExtraBoundary','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$UseExtraBoundary'},'name' => 'if','content' => [{'attrib' => {'name' => 'TypeBcExtra','type' => 'string'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => 'F','name' => 'DoFixExtraboundary','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'FACEOUTERBC'},'name' => 'command','content' => [{'attrib' => {'default' => '0','name' => 'MaxBoundary','max' => '6','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$MaxBoundary >= 1'},'name' => 'if','content' => [{'attrib' => {'default' => 'F','name' => 'DoFixOuterBoundary','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
#FACEOUTERBC
0              MaxBoundary            
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'alias' => 'SETREALTIME','name' => 'STARTTIME','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '2000','name' => 'iYear','type' => 'integer'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '3','name' => 'iMonth','max' => '12','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '21','name' => 'iDay','max' => '31','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0','name' => 'iHour','max' => '23','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0','name' => 'iMinute','max' => '59','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0','name' => 'iSecond','max' => '59','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'TIMESIMULATION','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '0.0','name' => 'tSimulation','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'NSTEP','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '0','name' => 'nStep','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'NPREVIOUS','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '-1','name' => 'nPrevious','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'FIXEDTIMESTEP'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'UseDtFixed','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.0','name' => 'DtFixedDim','if' => '$UseDtFixed','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'alias' => 'STEADYCRITERIA','name' => 'PARTSTEADYCRITERIA'},'name' => 'command','content' => [{'attrib' => {'default' => '1','name' => 'MinCheckVar','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '8','name' => 'MaxCheckVar','type' => 'integer','min' => '$MinCheckVar'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'to' => '$MaxCheckVar','from' => '$MinCheckVar'},'name' => 'for','content' => [{'attrib' => {'default' => '0.001','name' => 'RelativeEps','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0001','name' => 'AbsoluteEps','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'alias' => 'STEPPINGCRITERIA','name' => 'IMPLICITCRITERIA'},'name' => 'command','content' => [{'attrib' => {'name' => 'TypeImplCrit','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'Time step','value' => 'dt'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Radial distance','value' => 'r/R'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Test block','value' => 'test'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'rImplicit','if' => '$TypeImplCrit eq \'R\'','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'alias' => 'IMPLICITCHECK','name' => 'IMPLCHECK'},'name' => 'command','content' => [{'attrib' => {'default' => '0.3','name' => 'RejectStepLevel','max' => '0.9','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.5','name' => 'RejectStepFactor','max' => '0.9','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.6','name' => 'ReduceStepLevel','max' => '0.9','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.9','name' => 'ReduceStepFactor','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.8','name' => 'IncreaseStepLevel','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.05','name' => 'IncreaseStepFactor','max' => '2','type' => 'real','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'JACOBIAN'},'name' => 'command','content' => [{'attrib' => {'name' => 'TypeJacobian','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'Preconditioned','value' => 'prec'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'No preconditioning','value' => 'free'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '$doublePrecision ? 1.e-12 : 1.e-6','name' => 'JacobianEps','max' => '1.e-5','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#JACOBIAN
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'KRYLOV'},'name' => 'command','content' => [{'attrib' => {'name' => 'TypeKrylov','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'gmres'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'bicgstab'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'TypeInitKrylov','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => '0','value' => 'nul'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'previous','value' => 'old'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'explicit'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'scaled explicit','value' => 'explicit'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '0.001','name' => 'ErrorMaxKrylov','max' => '0.1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '100','name' => 'MaxMatvecKrylov','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#KRYLOV
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'KRYLOVSIZE'},'name' => 'command','content' => [{'attrib' => {'default' => 'MaxMatvecKrylov','name' => 'nKrylovVector','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#KRYLOVSIZE
10		nKrylovVector
...
','type' => 't'},{'attrib' => {'name' => 'STOP','if' => '$_IsStandAlone','required' => '$_IsStandAlone'},'name' => 'command','content' => [{'attrib' => {'default' => '-1','name' => 'MaxIteration','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '-1','name' => 'tSimulationMax','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'CPUTIMEMAX','if' => '$_IsStandAlone'},'name' => 'command','content' => [{'attrib' => {'default' => '-1','name' => 'CpuTimeMax','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'SAVERESTART'},'name' => 'command','content' => [{'attrib' => {'default' => 'T','name' => 'DoSaveRestart','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$DoSaveRestart'},'name' => 'if','content' => [{'attrib' => {'default' => '-1','name' => 'DnSaveRestart','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '-1','name' => 'DtSaveRestart','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
#SAVERESTART
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'SAVELOGFILE'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'DoSaveLogfile','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$DoSaveLogfile'},'name' => 'if','content' => [{'attrib' => {'name' => 'StringLog','max' => '4','type' => 'strings','min' => '1'},'name' => 'parameter','content' => [{'attrib' => {'name' => 'TypeLogVar','required' => 'T','type' => 'string','input' => 'select'},'name' => 'part','content' => [{'attrib' => {'default' => 'T','name' => 'MHD vars. dimensional','value' => 'MHD'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Flux vars. dimensional','value' => 'FLX'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Raw vars. dimensional','value' => 'RAW'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Set vars. dimensional','value' => 'VAR'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'default' => 'T','name' => 'MHD vars. scaled','value' => 'mhd'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Flux vars. scaled','value' => 'flx'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Raw vars. scaled','value' => 'raw'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Set vars. scaled','value' => 'var'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'TypeTime','required' => 'F','type' => 'string','multiple' => 'T','input' => 'select'},'name' => 'part','content' => [{'attrib' => {'name' => 'none','exclusive' => 'T'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'step'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'date'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'time'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '1','name' => 'DnSaveLogfile','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '-1','name' => 'DtSaveLogfile','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'NameLogVars','length' => '100','if' => '$TypeLogVar =~ /var/i','type' => 'string'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'StringLogRadii','length' => '100','if' => '($TypeLogVar=~/flx/i or $NameLogVars=~/flx/i)','max' => '10','type' => 'strings','min' => '1'},'name' => 'parameter','content' => [{'attrib' => {'name' => 'LogRadii','type' => 'real','multiple' => 'T','min' => '$rBody'},'name' => 'part','content' => [],'type' => 'e'}],'type' => 'e'}],'type' => 'e'},{'content' => '
#SAVELOGFILE
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'SATELLITE','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '0','name' => 'nSatellite','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'to' => '$nSatellite','from' => '1'},'name' => 'for','content' => [{'attrib' => {'name' => 'StringSatellite','max' => '5','type' => 'strings','min' => '1'},'name' => 'parameter','content' => [{'attrib' => {'name' => 'TypeSatelliteVar','required' => 'T','type' => 'string','input' => 'select'},'name' => 'part','content' => [{'attrib' => {'default' => 'T','name' => 'MHD vars. dimensional','value' => 'MHD'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'All vars. dimensional','value' => 'FUL'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Set vars. dimensional','value' => 'VAR'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'All vars. scaled','value' => 'ful'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Set vars. scaled','value' => 'var'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'TypeTrajectory','required' => 'F','type' => 'string','input' => 'select'},'name' => 'part','content' => [{'attrib' => {'default' => 'T','name' => 'file'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'equation','value' => 'eqn'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'TypeTime','required' => 'F','type' => 'string','multiple' => 'T','input' => 'select'},'name' => 'part','content' => [{'attrib' => {'name' => 'none','exclusive' => 'T'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'step'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'date'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'time'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '1','name' => 'DnOutput','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '-1','name' => 'DtOutput','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'name' => 'NameTrajectoryFile','length' => '100','type' => 'string'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '-f $NameTrajectoryFile'},'name' => 'rule','content' => [{'content' => '
			Trajectory file $NameTrajectoryFile must exist
		','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'NameSatelliteVars','length' => '100','if' => '$TypeSatelliteVar =~ /\\bvar\\b/i','type' => 'string'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
#SATELLITE
2                       nSatellite
...
!\\end{verbatim}
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'AMRINITPHYSICS','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '0','name' => 'nRefineLevelIC','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'AMRLEVELS'},'name' => 'command','content' => [{'attrib' => {'default' => '0','name' => 'MinBlockLevel','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '99','name' => 'MaxBlockLevel','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => 'F','name' => 'DoFixBodyLevel','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
! for AMR.
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'AMRRESOLUTION'},'name' => 'command','content' => [{'attrib' => {'default' => '0','name' => 'DxCellMin','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '99999','name' => 'DxCellMax','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => 'F','name' => 'DoFixBodyLevel','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#AMRRESOLUTION
0.			DxCellMin
99999.			DxCellMax
F			DoFixBodyLevel
...
! both.  If both are set, the final one in the session will set the values
! for AMR.
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'AMR'},'name' => 'command','content' => [{'attrib' => {'default' => '-1','name' => 'DnRefine','type' => 'integer','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$DnRefine>0'},'name' => 'if','content' => [{'attrib' => {'default' => 'F','name' => 'DoAutoRefine','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$DoAutoRefine'},'name' => 'if','content' => [{'attrib' => {'default' => '20','name' => 'PercentCoarsen','max' => '100','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '20','name' => 'PercentRefine','max' => '100','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '99999','name' => 'MaxTotalBlocks','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'}],'type' => 'e'},{'content' => '
#AMR
2001			DnRefine
...
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'SCHEME'},'name' => 'command','content' => [{'attrib' => {'name' => 'nOrder','type' => 'integer','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => '1'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => '2'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'TypeFlux','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'name' => 'Roe','value' => 'Roe/roe/1'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'default' => 'T','name' => 'Rusanov','value' => 'Rusanov/rusanov/2/TVDLF'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Linde','value' => 'Linde/linde/3/HLLEL'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Sokolov','value' => 'Sokolov/sokolov/4/AW'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'expr' => '$nOrder == 2'},'name' => 'if','content' => [{'attrib' => {'name' => 'TypeLimiter','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'minmod'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'mc'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'beta'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '1.2','name' => 'LimiterBeta','if' => '$TypeLimiter ne \'minmod\'','max' => '2','type' => 'real','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
! (close to the body).
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'CONSERVATIVECRITERIA'},'name' => 'command','content' => [{'attrib' => {'default' => '1','name' => 'nConservCrit','max' => '3','type' => 'integer','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'to' => '$nConservCrit','from' => '1'},'name' => 'for','content' => [{'attrib' => {'name' => 'TypeConservCrit','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'radius','value' => 'r/R/radius/Radius'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'parabola','value' => 'parabola/paraboloid'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'p','value' => 'p/P'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'grad P','value' => 'gradp/GradP'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '6','name' => 'rConserv','if' => '$TypeConservCrit =~ /^r|radius$/i','type' => 'real','min' => '$rBody'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '6','name' => 'xParabolaConserv','if' => '$TypeConservCrit =~ /^parabol/i','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '36','name' => 'yParabolaConserv','if' => '$TypeConservCrit =~ /^parabol/i','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.05','name' => 'pCoeffConserv','if' => '$TypeConservCrit =~ /^p$/i','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.1','name' => 'GradPCoeffConserv','if' => '$TypeConservCrit =~ /gradp/i','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'UPDATECHECK'},'name' => 'command','content' => [{'attrib' => {'default' => 'T','name' => 'UseUpdateCheck','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$UseUpdateCheck'},'name' => 'if','content' => [{'attrib' => {'default' => '40','name' => 'RhoMinPercent','max' => '100','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '400','name' => 'RhoMaxPercent','type' => 'real','min' => '100'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '40','name' => 'pMinPercent','max' => '100','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '400','name' => 'pMaxPercent','type' => 'real','min' => '100'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'TVDRESCHANGE'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'UseTvdAtReschange','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#TVDRESCHANGE
T		UseTvdAtResChange
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'BORIS'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'UseBorisCorrection','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1','name' => 'BorisClightFactor','if' => '$UseBorisCorrection','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#BORIS
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'BORISSIMPLE'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'UseBorisSimple','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1','name' => 'BorisClightFactor','if' => '$UseBorisSimple','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! Default is true.
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'DIVBDIFFUSION'},'name' => 'command','content' => [{'attrib' => {'default' => '0.1666667','name' => 'DivbDiffCoeff','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#DIVBDIFFUSION
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'PROJECTION'},'name' => 'command','content' => [{'attrib' => {'name' => 'TypeProjectIter','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'Conjugate Gradients','value' => 'cg'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'BiCGSTAB','value' => 'bicgstab'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'name' => 'TypeProjectStop','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'Relative norm','value' => 'rel'},'name' => 'option','content' => [],'type' => 'e'},{'attrib' => {'name' => 'Maximum error','value' => 'max'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '0.1','name' => 'RelativeLimit','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'AbsoluteLimit','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '50','name' => 'MaxMatvec','type' => 'integer','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#PROJECTION
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'CORRECTP'},'name' => 'command','content' => [{'attrib' => {'default' => '0.01','name' => 'pRatioLow','max' => '1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.1','name' => 'pRatioHigh','max' => '1','type' => 'real','min' => '$pRatioLow'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'GAMMA','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => '1.6666666667','name' => 'Gamma','type' => 'real','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#GAMMA
1.6666666667		Gamma
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'alias' => 'MAGNETOSPHERE','name' => 'BODY','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'UseBody','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$UseBody'},'name' => 'if','content' => [{'attrib' => {'default' => '3','name' => 'rBody','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$_NameComp eq \'GM\''},'name' => 'if','content' => [{'attrib' => {'default' => '4','name' => 'rCurrents','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1','name' => 'BodyRhoDim','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '10000','name' => 'BodyTDim','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'}],'type' => 'e'},{'content' => '
#BODY
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'SECONDBODY','if' => '$_IsFirstSession'},'name' => 'command','content' => [{'attrib' => {'default' => 'F','name' => 'UseBody2','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$UseBody2'},'name' => 'if','content' => [{'attrib' => {'default' => '0.1','name' => 'rBody2','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '-40','name' => 'xBody2','max' => '$xMax','type' => 'real','min' => '$xMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0','name' => 'yBody2','max' => '$yMax','type' => 'real','min' => '$yMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0','name' => 'zBody2','max' => '$zMax','type' => 'real','min' => '$zMin'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.3*$rBody2','name' => 'rCurrents2','type' => 'real','min' => '$rBody2'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '5','name' => 'RhoDimBody2','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '25000','name' => 'tDimBody2','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
...
!!!!!!!!!!!!!!!!!!! SOLAR PROBLEM TYPES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'HELIOSPHERE','if' => '$_IsFirstSession and $_NameComp ne \'GM\''},'name' => 'command','content' => [{'attrib' => {'default' => '2.85E06','name' => 'BodyTDim','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.50E8','name' => 'BodyRhoDim','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '25.0','name' => 'qSun','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.75','name' => 'tHeat','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.0','name' => 'rHeat','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '4.5','name' => 'SigmaHeat','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => 'F','name' => 'DoInitRope','type' => 'logical'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'expr' => '$DoInitRope'},'name' => 'if','content' => [{'attrib' => {'default' => '0.7','name' => 'CmeA','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.2','name' => 'CmeR1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.0','name' => 'CmeR0','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.23','name' => 'CmeA1','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'CmeAlpha','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '2.5E-12','name' => 'CmeRho1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '2.0E-13','name' => 'CmeRho2','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'ModulationRho','max' => '10','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'ModulationP','max' => '10','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'OrientationGL98','max' => '360','type' => 'real','min' => '-360'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'LatitudeGL98','max' => '90','type' => 'real','min' => '-90'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'LongitudeGL98','max' => '360','type' => 'real','min' => '-360'},'name' => 'parameter','content' => [],'type' => 'e'}],'type' => 'e'},{'content' => '
...
(clock-wise).
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'HELIOUPDATEB0','if' => '$_NameComp ne \'GM\''},'name' => 'command','content' => [{'attrib' => {'default' => '0.0001','name' => 'DtUpdateB0','type' => 'real','min' => '-1'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'HELIODIPOLE','if' => '$_NameComp ne \'GM\''},'name' => 'command','content' => [{'attrib' => {'name' => 'HelioDipoleStrength','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0','name' => 'HelioDipoleTilt','max' => '90','type' => 'real','min' => '-90'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'HELIOBUFFERGRID','if' => '$_IsFirstSession and $_NameComp eq \'IH\''},'name' => 'command','content' => [{'attrib' => {'default' => '19','name' => 'rBuffMin','type' => 'real','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '21','name' => 'rBuffMax','type' => 'real','min' => '1'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '45','name' => 'nThetaBuff','type' => 'integer','min' => '18'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '90','name' => 'nPhiBuff','type' => 'integer','min' => '36'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
Default values are shown above.
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'CME','if' => '$_IsFirstSession and $_NameComp ne \'GM\''},'name' => 'command','content' => [{'attrib' => {'name' => 'TypeCme','type' => 'string','input' => 'select'},'name' => 'parameter','content' => [{'attrib' => {'default' => 'T','name' => 'Low'},'name' => 'option','content' => [],'type' => 'e'}],'type' => 'e'},{'attrib' => {'default' => '0.7','name' => 'CmeA','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.2','name' => 'CmeR1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.0','name' => 'CmeR0','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.23','name' => 'CmeA1','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.0','name' => 'CmeAlpha','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '2.5E-12','name' => 'CmeRho1','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '2.0E-13','name' => 'CmeRho2','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.0','name' => 'CmeB1Dim','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '4.0E5','name' => 'CmeUErupt','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#CME
...
','type' => 't'}],'type' => 'e'},{'attrib' => {'name' => 'ARCADE','if' => '$_IsFirstSession and $_NameComp ne \'GM\''},'name' => 'command','content' => [{'attrib' => {'default' => '1.0E6','name' => 'tArcDim','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.0E-12','name' => 'RhoArcDim','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.718144','name' => 'bArcDim','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.0E6','name' => 'ByArcDim','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '5.0E3','name' => 'UzArcDim','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.5','name' => 'Phi0Arc','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '1.3','name' => 'MuArc','type' => 'real'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '3','name' => 'ExpArc','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'attrib' => {'default' => '0.5','name' => 'WidthArc','type' => 'real','min' => '0'},'name' => 'parameter','content' => [],'type' => 'e'},{'content' => '
#ARCADE
