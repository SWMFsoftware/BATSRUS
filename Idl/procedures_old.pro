...
;===========================================================================
   ...
   if plotdim eq 1 then begin
      ...
      print,'2D plotmodes: contour/contlabel/contfill/contirr/contlabelirr/contfillirr/'
      print,'              shade/shadeirr/surface/tv'
      print,'for vectors:  stream/stream2/vel/velovect/ovelovect'
   ...
   if (gencoord or transform eq 'unpolar') and ndim eq 2 then begin
      ...
      case 1 of
        transform eq 'regular':begin
           ...
           if n_elements(xreglimits) ne 4 then xreglimits=[0.,0.,0.,0.]
           nxreg0=nxreg(0)
           nxreg1=nxreg(1)
...
;===========================================================================
   ...
   for ifunc=0,nfunc-1 do begin
	 ...
	 'contirr'  :contour,f>f_min,xx,yy,$
			LEVELS=levels,XSTYLE=1,YSTYLE=1,/IRR,/NOERASE
	 'contlabelirr':contour,f>f_min,xx,yy,$
			LEVELS=levels,/FOLLOW,XSTYLE=1,YSTYLE=1,/IRR,/NOERASE
	 'contfillirr' :contour,f>f_min,xx,yy, $
			LEVELS=levels,/FILL,XSTYLE=1,YSTYLE=1,/IRR,/NOERASE
...
if s(0) ne 3 then begin
   print,'Error: plotgridpoints works for 2D grids only, like x(nx,ny,2)'
   retall
endif
...
plot,x(*,*,0),x(*,*,1),PSYM=1,XSTYLE=1,YSTYLE=1,/NOERASE
...
if sizew1(0) ne sizew2(0) then begin
   print,'w1 and w2 have different dimensions:',sizew1(0),' and ',sizew2(0)
   retall
endif
...
if max(abs(sizew1(1:ndim)-sizew2(1:ndim))) gt 0 then begin
   print,'w1 and w2 have different sizes:',sizew1(1:ndim),' /= ',sizew2(1:ndim)
   retall
endif
...
for iw=0,nw-1 do begin
   ...
   if keyword_set(wnames) then begin
      ...
      else               print,wnames(iw),wdif/wsum,wdif1/wsum1
   endif else begin
