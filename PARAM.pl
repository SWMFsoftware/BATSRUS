...
','type' => 't'},{'attrib' => {'name' => 'COMPONENT'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'NameComp'},'content' => [{'attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'SC','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'IH','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'GM\'','name' => 'GM','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'ECHO'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoEcho','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'PROGRESS'},'content' => [{'attrib' => {'type' => 'integer','min' => '-1','name' => 'DnProgressShort','default' => '10'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '-1','name' => 'DnProgressLong','default' => '100'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PROGRESS
10			DnProgressShort
100			DnProgressLong
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'TIMEACCURATE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoTimeAccurate','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'}],'type' => 'e','name' => 'commandgroup'},{'attrib' => {'name' => 'PLANET PARAETERS'},'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!! PLANET PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','alias' => 'MOON,COMET','name' => 'PLANET'},'content' => [{'attrib' => {'input' => 'select','case' => 'upper','type' => 'string','name' => 'NamePlanet'},'content' => [{'attrib' => {'name' => 'MERCURY'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'VENUS'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'EARTH','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'MARS'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'JUPITER'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'SATURN'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'URANUS'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'NEPTUNE'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'PLUTO'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'MOON'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'IO'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'EUROPA'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'TITAN'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'NEW'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'HALLEY'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'COMET1P'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'BORRELLY'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'COMET19P'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'CHURYUMOVGERASIMENKO'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'COMET67P'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'HALEBOPP'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$NamePlanet eq \'NEW\''},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'RadiusPlanet'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'MassPlanet'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'OmegaPlanet'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'TiltRotation'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeBField'},'content' => [{'attrib' => {'name' => 'NONE'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'DIPOLE','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$TyepBField eq \'DIPOLE\''},'content' => [{'attrib' => {'max' => '180','type' => 'real','min' => '0','name' => 'MagAxisThetaGeo'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '360','type' => 'real','min' => '0','name' => 'MagAxisPhiGeo'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'DipoleStrength'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => 'not $PlanetCommand'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'ROTATIONAXIS'},'content' => [{'attrib' => {'type' => 'logical','name' => 'IsRotAxisPrimary','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$IsRotAxisPrimary'},'content' => [{'attrib' => {'max' => '180','type' => 'real','min' => '0','name' => 'RotAxisTheta'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '360','type' => 'real','min' => '0','name' => 'RotAxisPhi'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'value' => 'ROTATIONAXIS','type' => 'string','name' => 'PlanetCommand'},'content' => [],'type' => 'e','name' => 'set'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'MAGNETICAXIS'},'content' => [{'attrib' => {'type' => 'logical','name' => 'IsMagAxisPrimary','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$IsMagAxisPrimary'},'content' => [{'attrib' => {'max' => '180','type' => 'real','min' => '0','name' => 'MagAxisTheta'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '360','type' => 'real','min' => '0','name' => 'MagAxisPhi'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'value' => 'MAGNETICAXIS','type' => 'string','name' => 'PlanetCommand'},'content' => [],'type' => 'e','name' => 'set'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'UPDATEB0'},'content' => [{'attrib' => {'type' => 'real','min' => '-1','name' => 'DtUpdateB0','default' => '0.0001'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'},{'attrib' => {'alias' => 'USER_FLAGS','name' => 'USERFLAGS'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseUserInnerBcs','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserSource','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserPerturbation','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserOuterBcs','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserICs','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserSpecifyRefinement','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserLogFiles','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserWritePlot','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserAMR','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserEchoInput','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserB0','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserInitSession','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseUserUpdateStates','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTIJK'},'content' => [{'attrib' => {'max' => '$nI+2','type' => 'integer','min' => '-2','name' => 'iTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$nJ+2','type' => 'integer','min' => '-2','name' => 'jTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$nK+2','type' => 'integer','min' => '-2','name' => 'kTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$MaxBlock','type' => 'integer','min' => '1','name' => 'iBlockTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '0','name' => 'iProcTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTIJK
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTXYZ'},'content' => [{'attrib' => {'max' => '$xMax','type' => 'real','min' => '$xMin','name' => 'xTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$yMax','type' => 'real','min' => '$yMin','name' => 'yTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$zMax','type' => 'real','min' => '$zMin','name' => 'zTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTXYZ
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTTIME'},'content' => [{'attrib' => {'type' => 'integer','min' => '-1','name' => 'nIterTest','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'TimeTest','default' => '1e30'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTVAR'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'iVarTest'},'content' => [{'attrib' => {'value' => '1','name' => 'Rho','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2','name' => 'RhoUx'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '3','name' => 'RhoUy'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '4','name' => 'RhoUz'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '5','name' => 'Bx'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '6','name' => 'By'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '7','name' => 'Bz'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '8','name' => 'e'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '9','name' => 'p'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTVAR
1                       iVarTest

! Index of variable to be tested. Default is rho_="1", i.e. density.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTDIM'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'iVarTest'},'content' => [{'attrib' => {'value' => '0','name' => 'all'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '1','name' => 'x','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2','name' => 'y'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '3','name' => 'z'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTDIM
1                       iDimTest

! Index of dimension/direction to be tested. Default is X dimension.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'multiple' => 'T','name' => 'STRICT'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseStrict','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#STRICT
T                       UseStrict
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'DEBUG'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoDebug','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoDebugGhost','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#DEBUG
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'CODEVERSION'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'CodeVersion','default' => '7.50'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#CODEVERSION
7.50                    CodeVersion
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'USERMODULE'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameUserModule','default' => 'EMPTY'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'VersionUserModule','default' => '1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'EQUATION'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameEquation','default' => 'MHD'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','name' => 'nVar','default' => '8'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'PRECISION'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'nByteReal'},'content' => [{'attrib' => {'value' => '4','name' => 'single precision (4)','default' => '$_nByteReal==4'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '8','name' => 'double precision (8)','default' => '$_nByteReal==8'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$nByteReal==$_nByteReal or not $UseStrict'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'CHECKGRIDSIZE'},'content' => [{'attrib' => {'max' => '$nI','type' => 'integer','min' => '$nI','name' => 'nI','default' => '$nI'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$nJ','type' => 'integer','min' => '$nJ','name' => 'nJ','default' => '$nJ'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$nK','type' => 'integer','min' => '$nK','name' => 'nK','default' => '$nK'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$MaxBlockALL','type' => 'integer','min' => '1','name' => 'MinBlockALL'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'TIMING'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseTiming','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseTiming'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'Frequency'},'content' => [{'attrib' => {'value' => '-3','name' => 'none'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '-2','name' => 'final only','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '-1','name' => 'end of sessions'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'min' => '1','name' => 'every X steps','default' => '100'},'content' => [],'type' => 'e','name' => 'optioninput'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '-1','name' => 'nDepthTiming','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeTimingReport'},'content' => [{'attrib' => {'value' => 'cumu','name' => 'cumulative','default' => '1'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'list'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'tree'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#TIMING
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'NORMALIZATION'},'content' => [{'attrib' => {'input' => 'select','case' => 'upper','type' => 'string','name' => 'TypeNormalization'},'content' => [{'attrib' => {'name' => 'SI'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'PLANETARY','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'SOLARWIND'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'NONE'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'READ'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$TypeNormalization =~ /READ/'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'No2SiUnitX','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'No2SiUnitU','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'No2SiUnitRho','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#NORMALIZATION
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'IOUNITS'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeIoUnit'},'content' => [{'attrib' => {'name' => 'SI'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'PLANETARY','default' => '$_NameComp eq \'GM\''},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'HELIOSPHERIC','default' => '$_NameComp ne \'GM\''},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'NONE'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'USER'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#IOUNITS
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINDIR'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameRestartInDir','default' => 'GM/restartIN'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-d $NameRestartInDir'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINFILE'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeRestartInFile'},'content' => [{'attrib' => {'name' => 'block','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'one'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'NEWRESTART'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoRestartBFace','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => ' 
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'OUTERBOUNDARY'},'content' => [{'attrib' => {'values' => 'TypeBcEast,TypeBcWest,TypeBcSouth,TypeBcNorth,TypeBcBot,TypeBcTop','name' => 'Side'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => '$Side'},'content' => [{'attrib' => {'name' => 'coupled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'vary/inflow','default' => '$Side eq \'TypeBcWest\''},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'float/outflow','default' => '$Side ne \'TypeBcWest\''},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'heliofloat'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'reflect'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'periodic'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'fixed'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'shear'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'linetied'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'raeder'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'arcadetop'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'arcadebot'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'arcadebotcont'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'user'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'foreach'},{'attrib' => {'expr' => 'not($TypeBcEast eq \'periodic\' xor $TypeBcWest eq \'periodic\')'},'content' => [{'content' => '
...
! user          - user defined
!\\end{verbatim}
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'INNERBOUNDARY'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeBcInner'},'content' => [{'attrib' => {'name' => 'reflect'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'float'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'fixed'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ionosphere','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ionosphereB0/ionosphereb0','name' => 'ionosphereB0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ionospherefloat'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'coronatoih'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'user'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseBody2'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeBcBody2'},'content' => [{'attrib' => {'name' => 'reflect','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'float'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'fixed'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ionosphere'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ionosphereB0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ionospherefloat'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => 'not($TypeBcBody2 =~ /ionosphere/)'},'content' => [{'content' => ' 
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'EXTRABOUNDARY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseExtraBoundary','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseExtraBoundary'},'content' => [{'attrib' => {'type' => 'string','name' => 'TypeExtraBoundary'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoFixExtraBoundary','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'FACEOUTERBC'},'content' => [{'attrib' => {'max' => '6','type' => 'integer','min' => '0','name' => 'MaxBoundary','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$MaxBoundary >= 1'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoFixOuterBoundary','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#FACEOUTERBC
0              MaxBoundary            
...
','type' => 't'}],'type' => 'e','name' => 'command'}],'type' => 'e','name' => 'commandgroup'},{'attrib' => {'name' => 'GRID GEOMETRY'},'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!! GRID GEOMETRY !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','required' => 'T','name' => 'GRID'},'content' => [{'attrib' => {'type' => 'integer','min' => '1','name' => 'nRootBlockX','default' => '2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '1','name' => 'nRootBlockY','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '1','name' => 'nRootBlockZ','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'xMin','default' => '-192.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$xMin','name' => 'xMax','default' => '  64.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yMin','default' => ' -64.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$yMin','name' => 'yMax','default' => '  64.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zMin','default' => ' -64.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$zMin','name' => 'zMax','default' => '  64.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'multiple' => 'T','alias' => 'COORDINATESYSTEM','name' => 'COORDSYSTEM'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeCoordSystem'},'content' => [{'attrib' => {'if' => '$_NameComp eq \'GM\'','name' => 'GSM','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'HGI','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'HGC'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'HGR','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'HGI'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','alias' => 'COVARIANTGEOMETRY','name' => 'GRIDGEOMETRY'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeGeometry'},'content' => [{'attrib' => {'name' => 'cartesian','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'cylindrical'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'spherical'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'spherical_lnr'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'axial_torus'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#GRIDGEOMETRY
...
identical though.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','alias' => 'LIMITGENCOORD1','name' => 'LIMITRADIUS'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'rMin','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$rMin','name' => 'rMax','default' => '1000'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#LIMITRADIUS
 10.0			rMin
100.0			rMax
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TORUSSIZE'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'rTorusLarge','default' => '6.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'rTorusSmall','default' => '0.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TORUSSIZE
6.0		rTorusLarge
0.5		rTorusSmall
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','name' => 'VERTEXBASEDGRID'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseVertexBasedGrid','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','alias' => 'SETREALTIME','name' => 'STARTTIME'},'content' => [{'attrib' => {'type' => 'integer','name' => 'iYear','default' => '2000'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '12','type' => 'integer','min' => '1','name' => 'iMonth','default' => '3'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '31','type' => 'integer','min' => '1','name' => 'iDay','default' => '21'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '23','type' => 'integer','min' => '0','name' => 'iHour','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '59','type' => 'integer','min' => '0','name' => 'iMinute','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '59','type' => 'integer','min' => '0','name' => 'iSecond','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'TIMESIMULATION'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'tSimulation','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'NSTEP'},'content' => [{'attrib' => {'type' => 'integer','min' => '0','name' => 'nStep','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'NPREVIOUS'},'content' => [{'attrib' => {'type' => 'integer','min' => '-1','name' => 'nPrevious','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'TIMESTEPPING'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'nStage'},'content' => [{'attrib' => {'value' => '1'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'CflExpl','default' => '0.8'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'FIXEDTIMESTEP'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseDtFixed','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseDtFixed','type' => 'real','min' => '0','name' => 'DtFixedDim','default' => '1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PARTSTEADY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UsePartSteady','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'STEADYCRITERIA','name' => 'PARTSTEADYCRITERIA'},'content' => [{'attrib' => {'type' => 'integer','min' => '1','name' => 'MinCheckVar','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '$MinCheckVar','name' => 'MaxCheckVar','default' => '8'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'to' => '$MaxCheckVar','from' => '$MinCheckVar'},'content' => [{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'RelativeEps','default' => '0.001'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'AbsoluteEps','default' => '0.0001'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'},{'content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'POINTIMPLICIT'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UsePointImplicit','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UsePointImplicit','max' => '1','type' => 'real','min' => '0.5','name' => 'BetaPointImplicit','default' => '0.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#POINTIMPLICIT
T		UsePointImplicit
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PARTLOCAL'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UsePartLocal','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PARTLOCAL
T               UsePartLocal
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'IMPLICIT'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UsePointImplicit','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UsePartImplicit','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseFullImplicit','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UsePartImplicit or $UseFullImplicit','type' => 'real','min' => '0','name' => 'CflImpl','default' => '100'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UsePointImplicit + $UsePartImplicit + $UseFullImplicit <= 1'},'content' => [{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'alias' => 'STEPPINGCRITERIA','name' => 'IMPLICITCRITERIA'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeImplCrit'},'content' => [{'attrib' => {'value' => 'dt','name' => 'Time step','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'r/R','name' => 'Radial distance'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'test','name' => 'Test block'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeImplCrit eq \'R\'','type' => 'real','min' => '0','name' => 'rImplicit'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'PARTIMPLICIT','name' => 'PARTIMPL'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UsePartImplicit2','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
backward compatible.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'IMPLICITSTEP','name' => 'IMPLSTEP'},'content' => [{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'ImplCoeff','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseBdf2','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseSourceImpl','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'IMPLICITSCHEME','name' => 'IMPLSCHEME'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'nOrderImpl'},'content' => [{'attrib' => {'name' => '1','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => '2'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeFluxImpl'},'content' => [{'attrib' => {'value' => 'Roe/roe/1','name' => 'Roe'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Rusanov/rusanov/2/TVDLF','name' => 'Rusanov','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Linde/linde/3/HLLEL','name' => 'Linde'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Sokolov/sokolov/4/AW','name' => 'Sokolov'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#IMPLSCHEME
1               nOrderImpl
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'IMPLICITCHECK','name' => 'IMPLCHECK'},'content' => [{'attrib' => {'max' => '0.9','type' => 'real','min' => '0','name' => 'RejectStepLevel','default' => '0.3'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '0.9','type' => 'real','min' => '0','name' => 'RejectStepFactor','default' => '0.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '0.9','type' => 'real','min' => '0','name' => 'ReduceStepLevel','default' => '0.6'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'ReduceStepFactor','default' => '0.9'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'IncreaseStepLevel','default' => '0.8'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '2','type' => 'real','min' => '1','name' => 'IncreaseStepFactor','default' => '1.05'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'NEWTON'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseConservativeImplicit','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseNewton','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseNewton'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseNewMatrix','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '1','name' => 'MaxIterNewton','default' => '10'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#NEWTON
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'JACOBIAN'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeJacobian'},'content' => [{'attrib' => {'value' => 'prec','name' => 'Preconditioned','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'free','name' => 'No preconditioning'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1.e-5','type' => 'real','min' => '0','name' => 'JacobianEps','default' => '$doublePrecision ? 1.e-12 : 1.e-6'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#JACOBIAN
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PRECONDITIONER'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypePrecondSide'},'content' => [{'attrib' => {'name' => 'left'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'symmetric','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'right'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypePrecond'},'content' => [{'attrib' => {'name' => 'MBILU','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'GustafssonPar','default' => '0.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PRECONDITIONER
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'KRYLOV'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeKrylov'},'content' => [{'attrib' => {'name' => 'gmres','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'bicgstab'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeInitKrylov'},'content' => [{'attrib' => {'value' => 'nul','name' => '0','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'old','name' => 'previous'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'explicit'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'explicit','name' => 'scaled explicit'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '0.1','type' => 'real','min' => '0','name' => 'ErrorMaxKrylov','default' => '0.001'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '1','name' => 'MaxMatvecKrylov','default' => '100'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#KRYLOV
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'KRYLOVSIZE'},'content' => [{'attrib' => {'type' => 'integer','min' => '1','name' => 'nKrylovVector','default' => 'MaxMatvecKrylov'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#KRYLOVSIZE
10		nKrylovVector
...
','type' => 't'},{'attrib' => {'if' => '$_IsStandAlone','required' => '$_IsStandAlone','name' => 'STOP'},'content' => [{'attrib' => {'type' => 'integer','min' => '-1','name' => 'MaxIteration','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'tSimulationMax','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'CHECKSTOPFILE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoCheckStopFile','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'CPUTIMEMAX'},'content' => [{'attrib' => {'type' => 'real','min' => '-1','name' => 'CpuTimeMax','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!  OUTPUT PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'RESTARTOUTDIR'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameRestartOutDir','default' => 'GM/restartOUT'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-d $NameRestartOutDir'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'RESTARTOUTFILE'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeRestartOutFile'},'content' => [{'attrib' => {'name' => 'block'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'one','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'SAVERESTART'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoSaveRestart','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoSaveRestart'},'content' => [{'attrib' => {'type' => 'integer','min' => '-1','name' => 'DnSaveRestart','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'DtSaveRestart','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#SAVERESTART
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PLOTDIR'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NamePlotDir','default' => 'GM/IO2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-d $NamePlotDir'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'SAVELOGFILE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoSaveLogfile','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoSaveLogfile'},'content' => [{'attrib' => {'max' => '4','type' => 'strings','min' => '1','name' => 'StringLog'},'content' => [{'attrib' => {'input' => 'select','required' => 'T','type' => 'string','name' => 'TypeLogVar'},'content' => [{'attrib' => {'value' => 'MHD','name' => 'MHD vars. dimensional','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FLX','name' => 'Flux vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'RAW','name' => 'Raw vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'VAR','name' => 'Set vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'flx','name' => 'Flux vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'raw','name' => 'Raw vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'var','name' => 'Set vars. scaled'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'multiple' => 'T','input' => 'select','required' => 'F','type' => 'string','name' => 'TypeTime'},'content' => [{'attrib' => {'exclusive' => 'T','name' => 'none'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'step'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'date'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'time'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '-1','name' => 'DnSaveLogfile','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'DtSaveLogfile','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeLogVar =~ /var/i','length' => '100','type' => 'string','name' => 'NameLogVars'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '($TypeLogVar=~/flx/i or $NameLogVars=~/flx/i)','length' => '100','max' => '10','type' => 'strings','min' => '1','name' => 'StringLogRadii'},'content' => [{'attrib' => {'multiple' => 'T','type' => 'real','min' => '$rBody','name' => 'LogRadii'},'content' => [],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#SAVELOGFILE
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'SATELLITE'},'content' => [{'attrib' => {'type' => 'integer','min' => '0','name' => 'nSatellite','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'to' => '$nSatellite','from' => '1'},'content' => [{'attrib' => {'max' => '5','type' => 'strings','min' => '1','name' => 'StringSatellite'},'content' => [{'attrib' => {'input' => 'select','required' => 'T','type' => 'string','name' => 'TypeSatelliteVar'},'content' => [{'attrib' => {'value' => 'MHD','name' => 'MHD vars. dimensional','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FUL','name' => 'All vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'VAR','name' => 'Set vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ful','name' => 'All vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'var','name' => 'Set vars. scaled'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'input' => 'select','required' => 'F','type' => 'string','name' => 'TypeTrajectory'},'content' => [{'attrib' => {'name' => 'file','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'eqn','name' => 'equation'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'multiple' => 'T','input' => 'select','required' => 'F','type' => 'string','name' => 'TypeTime'},'content' => [{'attrib' => {'exclusive' => 'T','name' => 'none'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'step'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'date'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'time'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '-1','name' => 'DnOutput','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'DtOutput','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'length' => '100','type' => 'string','name' => 'NameTrajectoryFile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-f $NameTrajectoryFile'},'content' => [{'content' => '
			Trajectory file $NameTrajectoryFile must exist
		','type' => 't'}],'type' => 'e','name' => 'rule'},{'attrib' => {'if' => '$TypeSatelliteVar =~ /\\bvar\\b/i','length' => '100','type' => 'string','name' => 'NameSatelliteVars'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'},{'content' => '
#SATELLITE
2                       nSatellite
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'content' => '

!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++


','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'STEADYSTATESATELLITE'},'content' => [{'attrib' => {'type' => 'real','name' => 'SatelliteTimeStart','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'SatelliteTimeEnd','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'},{'attrib' => {'name' => 'SAVEPLOT'},'content' => [{'attrib' => {'max' => '100','type' => 'integer','min' => '0','name' => 'nPlotFile','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'to' => '$nPlotFile','from' => '1'},'content' => [{'attrib' => {'max' => '3','type' => 'strings','min' => '3','name' => 'StringPlot'},'content' => [{'attrib' => {'input' => 'select','required' => 'T','type' => 'string','name' => 'plotform'},'content' => [{'attrib' => {'value' => 'tec','name' => 'TECPLOT'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'idl','name' => 'IDL'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'input' => 'select','required' => 'T','type' => 'string','name' => 'plotarea'},'content' => [{'attrib' => {'value' => '3d/3d_','name' => '3D'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'x=0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'y=0','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'z=0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'sph'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'los'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'lin'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'cut'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'slc'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'dpl'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'blk'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => '1d/1d_','name' => '1D'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'input' => 'select','required' => 'T','type' => 'string','name' => 'plotvar'},'content' => [{'attrib' => {'value' => 'MHD','name' => 'MHD vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FUL','name' => 'All vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'RAW','name' => 'Raw vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'RAY','name' => 'Ray tracing vars. dim.'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FLX','name' => 'Flux vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'SOL','name' => 'Solar vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$plotarea eq \'lin\'','value' => 'POS','name' => 'Position vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'VAR','name' => 'Select dimensional vars.'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'BBK','name' => 'Basic Block vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ful','name' => 'All vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'raw','name' => 'Raw vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ray','name' => 'Ray tracing vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'flx','name' => 'Flux vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'sol','name' => 'Solar vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$plotarea eq \'lin\'','value' => 'pos','name' => 'Position vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'var','name' => 'Select scaled vars.'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'bbk','name' => 'Basic Block vars. scaled'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '-1','name' => 'DnSavePlot'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'DtSavePlot'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$plotarea =~ /\\bdpl|cut|slc\\b/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xMinCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$xMinCut','name' => 'xMaxCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yMinCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$yMinCut','name' => 'yMaxCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zMinCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$zMinCut','name' => 'zMaxCut'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$plotarea =~ /\\bslc\\b/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'xNormal'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yNormal'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zNormal'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$plotarea =~ /\\bblk\\b/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zPoint'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'if' => '$plotarea =~ /\\bsph\\b/','type' => 'real','min' => '0','name' => 'Radius','default' => '10'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$plotarea =~ /\\blos\\b/'},'content' => [{'attrib' => {'type' => 'real','name' => 'ObsPosX','default' => '-215'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'ObsPosY','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'ObsPosZ','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '89','type' => 'real','min' => '-89','name' => 'OffsetAngle','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'rSizeImage','default' => '32'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'xOffset','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yOffset','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'rOccult','default' => '2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'MuLimbDarkening','default' => '0.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '2','name' => 'nPix','default' => '200'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$plotarea =~ /\\blin\\b/'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'NameLine'},'content' => [{'attrib' => {'value' => 'A','name' => 'Advected B'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'B','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'U'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'J'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'IsSingleLine','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '20','type' => 'integer','min' => '1','name' => 'nLine','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'to' => '$nLine','from' => '1'},'content' => [{'attrib' => {'type' => 'real','name' => 'xStartLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yStartLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zStartLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'IsParallel'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'}],'type' => 'e','name' => 'if'},{'attrib' => {'if' => '($plotform=~/\\bidl\\b/ and $plotarea!~/\\b(sph|los|lin)\\b/)','type' => 'real','min' => '-1.0','name' => 'DxSavePlot','default' => '-1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$plotvar =~ /\\bvar\\b/i'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameVars'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'length' => '100','type' => 'string','name' => 'NamePars'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'}],'type' => 'e','name' => 'for'},{'content' => '
#SAVEPLOT
10			nPlotfile
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'SAVEBINARY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoSaveBinary','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#SAVEBINARY
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'SAVEPLOTSAMR'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoSavePlotsAmr','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#SAVEPLOTSAMR
F			DoSavePlotsAmr

! Save plots before each AMR. Default is DoSavePlotsAMR=.false.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'FLUSH'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoFlush','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!  AMR PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'AMRINIT'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'InitialRefineType','default' => 'none'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '0','name' => 'InitialRefineLevel','default' => '4'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRINIT
...
of the base grid.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'AMRINITPHYSICS'},'content' => [{'attrib' => {'type' => 'integer','min' => '0','name' => 'nRefineLevelIC','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'multiple' => 'T','alias' => 'GRIDLEVEL','name' => 'GRIDRESOLUTION'},'content' => [{'attrib' => {'value' => '0','name' => 'RotateArea'},'content' => [],'type' => 'e','name' => 'set'},{'attrib' => {'if' => '$_command =~ /RESOLUTION/','type' => 'real','min' => '0','name' => 'Resolution'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$_command =~ /LEVEL/','type' => 'integer','min' => '0','name' => 'nLevel'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '2','type' => 'strings','min' => '1','name' => 'StringArea'},'content' => [{'attrib' => {'input' => 'select','required' => 'T','type' => 'string','name' => 'NameArea'},'content' => [{'attrib' => {'value' => 'init/initial','name' => 'initial','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'all'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'box'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'brick'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'brick0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'sphere'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'sphere0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'shell'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'shell0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'cylinderx'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'cylinderx0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'cylindery'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'cylindery0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'cylinderz'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'cylinderz0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ringx'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ringx0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ringy'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ringy0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ringz'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'ringz0'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'input' => 'select','required' => 'F','type' => 'string','name' => 'RotateArea'},'content' => [{'attrib' => {'name' => 'rotated'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$NameArea !~ /box|all|init|0/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xCenter','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yCenter','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zCenter','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameArea =~ /box/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xMinBox'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yMinBox'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zMinBox'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'xMaxBox'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yMaxBox'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zMaxBox'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameArea =~ /brick/i'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'xSizeBrick'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'ySizeBrick'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'zSizeBrick'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameArea =~ /sphere/i'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'Radius'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameArea =~ /shell/i'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'Radius1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'Radius2'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameArea =~ /cylinder/i'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'LengthCylinder'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'Radius'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameArea =~ /ring/i'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'HeightRing'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'Radius1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'Radius2'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$RotateArea =~ /rotated/i'},'content' => [{'attrib' => {'max' => '360','type' => 'real','min' => '-360','name' => 'xRotate','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '360','type' => 'real','min' => '-360','name' => 'yRotate','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '360','type' => 'real','min' => '-360','name' => 'zRotate','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'AMRLEVELS'},'content' => [{'attrib' => {'type' => 'integer','min' => '-1','name' => 'MinBlockLevel','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '-1','name' => 'MaxBlockLevel','default' => '99'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoFixBodyLevel','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
! for AMR.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'AMRRESOLUTION'},'content' => [{'attrib' => {'type' => 'real','min' => '-1','name' => 'DxCellMin','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'DxCellMax','default' => '99999'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoFixBodyLevel','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRRESOLUTION
0.			DxCellMin
99999.			DxCellMax
F			DoFixBodyLevel
...
! both.  If both are set, the final one in the session will set the values
! for AMR.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'AMR'},'content' => [{'attrib' => {'type' => 'integer','min' => '-1','name' => 'DnRefine','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DnRefine>0'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoAutoRefine','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoAutoRefine'},'content' => [{'attrib' => {'max' => '100','type' => 'real','min' => '0','name' => 'PercentCoarsen','default' => '20'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '100','type' => 'real','min' => '0','name' => 'PercentRefine','default' => '20'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '1','name' => 'MaxTotalBlocks','default' => '99999'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'}],'type' => 'e','name' => 'if'},{'content' => '
#AMR
2001			DnRefine
...
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'SCHEME'},'content' => [{'attrib' => {'input' => 'select','type' => 'integer','name' => 'nOrder'},'content' => [{'attrib' => {'name' => '1'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => '2','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeFlux'},'content' => [{'attrib' => {'value' => 'Roe/roe/1','name' => 'Roe'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Rusanov/rusanov/2/TVDLF','name' => 'Rusanov','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Linde/linde/3/HLLEL','name' => 'Linde'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Sokolov/sokolov/4/AW','name' => 'Sokolov'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$nOrder == 2'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeLimiter'},'content' => [{'attrib' => {'name' => 'minmod','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'mc'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'mc3'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'beta'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeLimiter ne \'minmod\'','max' => '2','type' => 'real','min' => '1','name' => 'LimiterBeta','default' => '1.2'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'NONCONSERVATIVE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseNonConservative','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#NONCONSERVATIVE
T		UseNonConservative

For Earth the default is using non-conservative equations 
(close to the body).
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'CONSERVATIVECRITERIA'},'content' => [{'attrib' => {'max' => '3','type' => 'integer','min' => '0','name' => 'nConservCrit','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'to' => '$nConservCrit','from' => '1'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeConservCrit'},'content' => [{'attrib' => {'value' => 'r/R/radius/Radius','name' => 'radius','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'parabola/paraboloid','name' => 'parabola'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'p/P','name' => 'p'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'gradp/GradP','name' => 'grad P'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^r|radius$/i','type' => 'real','min' => '$rBody','name' => 'rConserv','default' => '6'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','type' => 'real','min' => '0','name' => 'xParabolaConserv','default' => '6'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','type' => 'real','min' => '0','name' => 'yParabolaConserv','default' => '36'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^p$/i','type' => 'real','min' => '0','name' => 'pCoeffConserv','default' => '0.05'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /gradp/i','type' => 'real','min' => '0','name' => 'GradPCoeffConserv','default' => '0.1'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'UPDATECHECK'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseUpdateCheck','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseUpdateCheck'},'content' => [{'attrib' => {'max' => '100','type' => 'real','min' => '0','name' => 'RhoMinPercent','default' => '40'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '100','name' => 'RhoMaxPercent','default' => '400'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '100','type' => 'real','min' => '0','name' => 'pMinPercent','default' => '40'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '100','name' => 'pMaxPercent','default' => '400'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'MULTISPECIES'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoReplaceDensity','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '100','type' => 'real','min' => '0','name' => 'SpeciesPercentCheck','default' => '1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#MULTISPECIES
T			DoReplaceDensity
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'RESOLUTIONCHANGE','name' => 'RESCHANGE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseAccurateReschange','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#RESCHANGE
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TVDRESCHANGE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseTvdReschange','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TVDRESCHANGE
T		UseTvdResChange
...
! Default value is false, which results in first order 
! prolongation and restriction operators at the resolution changes.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'BORIS'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseBorisCorrection','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseBorisCorrection','max' => '1','type' => 'real','min' => '0','name' => 'BorisClightFactor','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#BORIS
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'BORISSIMPLE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseBorisSimple','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseBorisSimple','max' => '1','type' => 'real','min' => '0','name' => 'BorisClightFactor','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! You can use either Boris or BorisSimple but not both. 
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'DIVB'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseDivbSource','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseDivbDiffusion','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseProjection','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseConstrainB','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseDivbSource or $UseDivbDiffusion or $UseProjection or $UseConstrainB'},'content' => [{'content' => '
...
! If UseConstrainB is true, all others should be false.
! At least one of the options should be true.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'DIVBSOURCE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseB0Source','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#DIVBSOURCE
T			UseB0Source

! Add extra source terms related to the non-zero divergence and curl of B0.
! Default is true.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PROJECTION'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectIter'},'content' => [{'attrib' => {'value' => 'cg','name' => 'Conjugate Gradients','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'bicgstab','name' => 'BiCGSTAB'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectStop'},'content' => [{'attrib' => {'value' => 'rel','name' => 'Relative norm','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'max','name' => 'Maximum error'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'RelativeLimit','default' => '0.1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'AbsoluteLimit','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '1','name' => 'MaxMatvec','default' => '50'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PROJECTION
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'CORRECTP'},'content' => [{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'pRatioLow','default' => '0.01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '$pRatioLow','name' => 'pRatioHigh','default' => '0.1'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'RAYTRACE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseAccurateIntegral','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseAccurateTrace','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '60','type' => 'real','min' => '0.01','name' => 'DtExchangeRay','default' => '0.1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '1','name' => 'DnRaytrace','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'IM'},'content' => [{'attrib' => {'type' => 'real','min' => '1','name' => 'TauCoupleIm'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'IMCOUPLING'},'content' => [{'attrib' => {'type' => 'real','min' => '1','name' => 'TauCoupleIm'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoCoupleImPressure','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoCoupleImDensity','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'GAMMA'},'content' => [{'attrib' => {'type' => 'real','min' => '1','name' => 'Gamma','default' => '1.6666666667'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#GAMMA
1.6666666667		Gamma
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PLASMA'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'AverageIonMass','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'AverageIonCharge','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'ElectronTemperatureRatio','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PLASMA
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'SHOCKTUBE'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'RhoLeft','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'UnLeft','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Ut1Left','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Ut2Left','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'BnLeft','default' => '0.75'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Bt1Left','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Bt2Left','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'pRight','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'RhoRight','default' => '0.125'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'UnRight','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Ut1Right','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Ut2Right','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'BnRight','default' => '0.75'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Bt1Right','default' => '-1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Bt2Right','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'pRight','default' => '0.1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'input' => 'select','type' => 'real','name' => 'ShockSlope'},'content' => [{'attrib' => {'value' => '0','name' => 'no rotation','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '0.25'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '0.3333333333333'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '0.5'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '1'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '3'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '4'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#SHOCKTUBE
1.		rho (left state)
0.		Ux (Un)
0.		Uy (Ut1)
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'SOLARWIND'},'content' => [{'attrib' => {'type' => 'real','min' => '-1','name' => 'SwRhoDim','default' => '5'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '-1','name' => 'SwTDim','default' => '181712.175'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'SwUxDim','default' => '-400'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'SwUyDim','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'SwUzDim','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'SwBxDim','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'SwByDim','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'SwBzDim','default' => '5'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#SOLARWIND
5.0			SwRhoDim [n/cc]
181712.175		SwTDim [K]
-400.0			SwUxDim [km/s]
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'UPSTREAM_INPUT_FILE','name' => 'SOLARWINDFILE'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseSolarWindFile','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseSolarWindFile'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameSolarWindFile'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '-f $NameSolarWindFile'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','alias' => 'MAGNETOSPHERE','name' => 'BODY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseBody','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseBody'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'rBody','default' => '3'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$_NameComp eq \'GM\'','type' => 'real','min' => '-1','name' => 'rCurrents','default' => '4'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'BodyNDim','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'BodyTDim','default' => '1000'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#BODY
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'GRAVITY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseGravity','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseGravity','input' => 'select','type' => 'integer','name' => 'iDirGravity'},'content' => [{'attrib' => {'value' => '0','name' => 'central mass','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '1','name' => 'X direction'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2','name' => 'Y direction'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '3','name' => 'Z direction'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#GRAVITY
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'HALLRESISTIVITY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseHallResist','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseHallResist'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'HallFactor','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'HallCmaxFactor','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '1','type' => 'real','min' => '0','name' => 'HallHyperFactor','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'HALLREGION'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'NameHallRegion'},'content' => [{'attrib' => {'name' => 'all','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'sphere0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'box0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'sphere'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'box'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$NameHallRegion ne \'all\' and $NameHallRegion !~ /0/'},'content' => [{'attrib' => {'type' => 'real','name' => 'x0Hall','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'y0Hall','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'z0Hall','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameHallRegion =~ /sphere/'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'rSphereHall','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'DrSphereHall','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$NameHallRegion =~ /box/'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'xSizeBoxHall','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'DxSizeBoxHall','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'ySizeBoxHall','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'DySizeBoxHall','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'zSizeBoxHall','default' => '1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'DzSizeBoxHall','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'MASSLOADING'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseMassLoading','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoAccelerateMassLoading','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#MASSLOADING
F			UseMassLoading
F			DoAccelerateMassLoading
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'HEATFLUX'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseHeatFlux','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'UseSpitzerForm','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => 'not $UseSpitzerForm'},'content' => [{'attrib' => {'type' => 'real','name' => 'Kappa0Heat','default' => '1.23E-11'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Kappa0Heat','default' => '2.5'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#HEATFLUX
T		UseHeatFlux
F		UseSpitzerForm
1.23E-11	Kappa0Heat [W/m/K]	! Only if not UseSpitzerForm
2.50E+00	ExponentHeat [-]	! Only if not UseSpitzerForm
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'RESISTIVITY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseResistivity','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseResistivity'},'content' => [{'attrib' => {'input' => 'select','case' => 'lower','type' => 'string','name' => 'TypeResistivity'},'content' => [{'attrib' => {'name' => 'constant','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'spitzer'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'anomalous'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'user'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$TypeResistivity =~ /constant/'},'content' => [{'attrib' => {'type' => 'real','min' => '0.0','name' => 'Eta0Si','default' => '1.0E+11'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$TypeResistivity =~ /spitzer/'},'content' => [{'attrib' => {'type' => 'real','name' => 'CoulombLogarithm','default' => '20'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$TypeResistivity =~ /anomalous/'},'content' => [{'attrib' => {'type' => 'real','min' => '0.0','name' => 'Eta0Si','default' => '1.0E+9'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Eta0AnomSi','default' => '2E+09'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'EtaMaxAnomSi','default' => '2E+10'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'jCritAnomSi','default' => '1.0E-9'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'}],'type' => 'e','name' => 'if'},{'content' => '
#RESISTIVITY
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'TESTDISSMHD'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseDefaultUnits','default' => 'T'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Grav0Diss','default' => '2.635620E-02'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Beta0Diss','default' => '1.640000E-01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Length0Diss','default' => '1.500000E+06'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Time0Diss','default' => '1.159850E+01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Rho0Diss','default' => '5.019000E-11'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Tem0Diss','default' => '1.000000E+05'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Theta0Diss','default' => '6.000000E-01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Delta0Diss','default' => '2.500000E+01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'EpsilonDiss','default' => '7.000000E+00'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'RhoDifDiss','default' => '4.500000E+00'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yShiftDiss','default' => '4.000000E-01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'ScaleHeightDiss','default' => '5.000000E-01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'ScaleFactorDiss','default' => '1.159850E+01'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'BZ0iss','default' => '5.000000E-01'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTDISSMHD
F                       UseDefaultUnits
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'SECONDBODY'},'content' => [{'attrib' => {'type' => 'logical','name' => 'UseBody2','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseBody2'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'rBody2','default' => '0.1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$xMax','type' => 'real','min' => '$xMin','name' => 'xBody2','default' => '-40'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$yMax','type' => 'real','min' => '$yMin','name' => 'yBody2','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '$zMax','type' => 'real','min' => '$zMin','name' => 'zBody2','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '$rBody2','name' => 'rCurrents2','default' => '1.3*$rBody2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'RhoDimBody2','default' => '5'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'tDimBody2','default' => '25000'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
!!!!!!!!!!!!!!!!!!! SOLAR PROBLEM TYPES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'HELIOSPHERE'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'BodyTDim','default' => '2.85E06'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'BodyRhoDim','default' => '1.50E8'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'qSun','default' => '25.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'tHeat','default' => '1.75'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'rHeat','default' => '1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'SigmaHeat','default' => '4.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'DoInitRope','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoInitRope'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeA','default' => '0.7'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeR1','default' => '1.2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeR0','default' => '1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'CmeA1','default' => '0.23'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'CmeAlpha','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeRho1','default' => '2.5E-12'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeRho2','default' => '2.0E-13'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '10','type' => 'real','min' => '0','name' => 'ModulationRho','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '10','type' => 'real','min' => '0','name' => 'ModulationP','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '360','type' => 'real','min' => '-360','name' => 'OrientationGL98','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '90','type' => 'real','min' => '-90','name' => 'LatitudeGL98','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '360','type' => 'real','min' => '-360','name' => 'LongitudeGL98','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
(clock-wise).
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOUPDATEB0'},'content' => [{'attrib' => {'type' => 'real','min' => '-1','name' => 'DtUpdateB0','default' => '0.0001'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIODIPOLE'},'content' => [{'attrib' => {'type' => 'real','name' => 'HelioDipoleStrength'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'max' => '90','type' => 'real','min' => '-90','name' => 'HelioDipoleTilt','default' => '0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOTEST'},'content' => [{'attrib' => {'type' => 'logical','name' => 'DoSendMHD','default' => 'F'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession and $_NameComp eq \'IH\'','name' => 'HELIOBUFFERGRID'},'content' => [{'attrib' => {'type' => 'real','min' => '1','name' => 'rBuffMin','default' => '19'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '1','name' => 'rBuffMax','default' => '21'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '18','name' => 'nThetaBuff','default' => '45'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'integer','min' => '36','name' => 'nPhiBuff','default' => '90'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
Default values are shown above.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'CME'},'content' => [{'attrib' => {'input' => 'select','type' => 'string','name' => 'TypeCme'},'content' => [{'attrib' => {'name' => 'Low','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeA','default' => '0.7'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeR1','default' => '1.2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeR0','default' => '1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'CmeA1','default' => '0.23'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'CmeAlpha','default' => '0.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeRho1','default' => '2.5E-12'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeRho2','default' => '2.0E-13'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'CmeB1Dim','default' => '1.0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'CmeUErupt','default' => '4.0E5'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#CME
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'ARCADE'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'tArcDim','default' => '1.0E6'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'RhoArcDim','default' => '1.0E-12'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'bArcDim','default' => '0.718144'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'ByArcDim','default' => '1.0E6'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'UzArcDim','default' => '5.0E3'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'Phi0Arc','default' => '0.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'MuArc','default' => '1.3'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'ExpArc','default' => '3'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'WidthArc','default' => '0.5'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#ARCADE
...
!!!!!!!!!!!!!!!!!!! COMET PROBLEM TYPE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'COMET'},'content' => [{'attrib' => {'type' => 'real','min' => '0','name' => 'ProdRate'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'UrNeutral'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'AverageMass'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'IonizationRate'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','min' => '0','name' => 'kFriction'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#COMET
...
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'INCLUDE'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameIncludeFile','default' => 'Param/'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '

#INCLUDE
Param/SSS_3000		NameIncludeFile

! Include a library file from Param/ or any file from anywhere else.
','type' => 't'}],'type' => 'e','name' => 'command'}],'type' => 'e','name' => 'commandgroup'},{'attrib' => {'expr' => '($SwRhoDim > 0) or $UseSolarWindFile or $_NameComp ne \'GM\''},'content' => [{'content' => '
