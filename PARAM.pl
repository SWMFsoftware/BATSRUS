...
','type' => 't'},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_GridSize[0]','type' => 'integer','name' => 'nI'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_GridSize[1]','type' => 'integer','name' => 'nJ'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_GridSize[2]','type' => 'integer','name' => 'nK'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_GridSize[3]','type' => 'integer','name' => 'MaxBlock'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_GridSize[4]','type' => 'integer','name' => 'MaxImplBlock'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_nProc and $MaxBlock and $_nProc*$MaxBlock','type' => 'integer','name' => 'MaxBlockALL'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_NameComp/restartOUT','type' => 'string','name' => 'NameRestartOutDir'}},{'content' => [],'name' => 'set','type' => 'e','attrib' => {'value' => '$_NameComp/IO2','type' => 'string','name' => 'NamePlotDir'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!! STAND ALONE PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

','type' => 't'},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'if' => '$_NameComp eq \'SC\'','default' => 'T','name' => 'SC'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'if' => '$_NameComp eq \'IH\'','default' => 'T','name' => 'IH'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'if' => '$_NameComp eq \'GM\'','default' => 'T','name' => 'GM'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'NameComp'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'COMPONENT'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','type' => 'string','name' => 'StringDescription'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','name' => 'DESCRIPTION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoEcho'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','name' => 'ECHO'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '10','min' => '-1','type' => 'integer','name' => 'DnProgressShort'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '100','min' => '-1','type' => 'integer','name' => 'DnProgressLong'}},{'content' => '
#PROGRESS
10			DnProgressShort
100			DnProgressLong
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','name' => 'PROGRESS'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'DoTimeAccurate'}},{'content' => '
...
date and time given by #STARTTIME.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','name' => 'MAGNETICAXIS'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'type' => 'real','name' => 'DipoleStrength'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','name' => 'DIPOLE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.0001','min' => '-1','type' => 'real','name' => 'DtUpdateB0'}},{'content' => '
...
but much shorter.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','name' => 'IDEALAXES'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'PLANET PARAETERS'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!  USER DEFINED INPUT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserInnerBcs'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserSource'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserPerturbation'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserOuterBcs'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserICs'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserSpecifyRefinement'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserLogFiles'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserWritePlot'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserAMR'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserEchoInput'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserB0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserInitSession'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseUserUpdateStates'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'alias' => 'USER_FLAGS','name' => 'USERFLAGS'}},{'content' => [{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','type' => 'string','name' => 'TestString'}},{'content' => '
#TEST
read_inputs
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TESTIJK'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$xMax','min' => '$xMin','type' => 'real','name' => 'xTest'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$yMax','min' => '$yMin','type' => 'real','name' => 'yTest'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$zMax','min' => '$zMin','type' => 'real','name' => 'zTest'}},{'content' => '
#TESTXYZ
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TESTXYZ'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'nIterTest'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1e30','min' => '-1','type' => 'real','name' => 'TimeTest'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'VERBOSE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoDebug'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoDebugGhost'}},{'content' => '
#DEBUG
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DEBUG'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '7.50','type' => 'real','min' => '0','name' => 'CodeVersion'}},{'content' => '
#CODEVERSION
7.50                    CodeVersion
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'CODEVERSION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','default' => 'EMPTY','type' => 'string','name' => 'NameUserModule'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0','min' => '0','type' => 'real','name' => 'VersionUserModule'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'USERMODULE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','default' => 'MHD','type' => 'string','name' => 'NameEquation'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '8','type' => 'integer','name' => 'nVar'}},{'content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'PRECISION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$nI','default' => '$nI','min' => '$nI','type' => 'integer','name' => 'nI'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$nJ','default' => '$nJ','min' => '$nJ','type' => 'integer','name' => 'nJ'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$nK','default' => '$nK','min' => '$nK','type' => 'integer','name' => 'nK'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$MaxBlockALL','min' => '1','type' => 'integer','name' => 'MinBlockALL'}},{'content' => '
...
!\\end{verbatim}
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','required' => 'T','name' => 'PROBLEMTYPE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','default' => 'GM/restartIN','type' => 'string','name' => 'NameRestartInDir'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINDIR'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoRestartBFace'}},{'content' => ' 
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'EXTRABOUNDARY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '6','default' => '0','min' => '0','type' => 'integer','name' => 'MaxBoundary'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoFixOuterBoundary'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$MaxBoundary >= 1'}},{'content' => '
#FACEOUTERBC
0              MaxBoundary            
...
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2','min' => '1','type' => 'integer','name' => 'nRootBlockX'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '1','type' => 'integer','name' => 'nRootBlockY'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '1','type' => 'integer','name' => 'nRootBlockZ'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-192.0','type' => 'real','name' => 'xMin'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '  64.0','min' => '$xMin','type' => 'real','name' => 'xMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => ' -64.0','type' => 'real','name' => 'yMin'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '  64.0','min' => '$yMin','type' => 'real','name' => 'yMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => ' -64.0','type' => 'real','name' => 'zMin'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '  64.0','min' => '$zMin','type' => 'real','name' => 'zMax'}},{'content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'multiple' => 'T','alias' => 'COORDINATESYSTEM','name' => 'COORDSYSTEM'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseVertexBasedGrid'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','name' => 'VERTEXBASEDGRID'}}],'name' => 'commandgroup','type' => 'e','attrib' => {'name' => 'GRID GEOMETRY'}},{'content' => [{'content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!! INITIAL TIME AND STEP !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2000','type' => 'integer','name' => 'iYear'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '12','default' => '3','min' => '1','type' => 'integer','name' => 'iMonth'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '31','default' => '21','min' => '1','type' => 'integer','name' => 'iDay'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '23','default' => '0','min' => '0','type' => 'integer','name' => 'iHour'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '59','default' => '0','min' => '0','type' => 'integer','name' => 'iMinute'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '59','default' => '0','min' => '0','type' => 'integer','name' => 'iSecond'}},{'content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','alias' => 'SETREALTIME','name' => 'STARTTIME'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.0','min' => '0','type' => 'real','name' => 'tSimulation'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'TIMESIMULATION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','min' => '0','type' => 'integer','name' => 'nStep'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'NSTEP'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'nPrevious'}},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '1','default' => 'T'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '2'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'integer','name' => 'nStage'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.8','min' => '0','type' => 'real','name' => 'CflExpl'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TIMESTEPPING'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseDtFixed'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$UseDtFixed','default' => '1.0','min' => '0','type' => 'real','name' => 'DtFixedDim'}},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'FIXEDTIMESTEP'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UsePartSteady'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PARTSTEADY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '1','type' => 'integer','name' => 'MinCheckVar'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '8','min' => '$MinCheckVar','type' => 'integer','name' => 'MaxCheckVar'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.001','min' => '0','type' => 'real','name' => 'RelativeEps'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.0001','min' => '0','type' => 'real','name' => 'AbsoluteEps'}}],'name' => 'for','type' => 'e','attrib' => {'to' => '$MaxCheckVar','from' => '$MinCheckVar'}},{'content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'alias' => 'STEADYCRITERIA','name' => 'PARTSTEADYCRITERIA'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UsePartLocal'}},{'content' => '
#PARTLOCAL
T               UsePartLocal
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PARTLOCAL'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UsePointImplicit'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UsePartImplicit'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseFullImplicit'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$UsePartImplicit or $UseFullImplicit','default' => '100','min' => '0','type' => 'real','name' => 'CflImpl'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'alias' => 'STEPPINGCRITERIA','name' => 'IMPLICITCRITERIA'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '1','min' => '0','type' => 'real','name' => 'ImplCoeff'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseBdf2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseSourceImpl'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'alias' => 'IMPLICITSCHEME','name' => 'IMPLSCHEME'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '0.9','default' => '0.3','min' => '0','type' => 'real','name' => 'RejectStepLevel'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '0.9','default' => '0.5','min' => '0','type' => 'real','name' => 'RejectStepFactor'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '0.9','default' => '0.6','min' => '0','type' => 'real','name' => 'ReduceStepLevel'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.9','min' => '0','type' => 'real','name' => 'ReduceStepFactor'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.8','min' => '0','type' => 'real','name' => 'IncreaseStepLevel'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '2','default' => '1.05','min' => '1','type' => 'real','name' => 'IncreaseStepFactor'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'alias' => 'IMPLICITCHECK','name' => 'IMPLCHECK'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseConservativeImplicit'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseNewton'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseNewMatrix'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '10','min' => '1','type' => 'integer','name' => 'MaxIterNewton'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseNewton'}},{'content' => '
#NEWTON
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'NEWTON'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'prec','default' => 'T','name' => 'Preconditioned'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'free','name' => 'No preconditioning'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeJacobian'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1.e-5','default' => '$doublePrecision ? 1.e-12 : 1.e-6','min' => '0','type' => 'real','name' => 'JacobianEps'}},{'content' => '
#JACOBIAN
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'JACOBIAN'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'left'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','name' => 'symmetric'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'right'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypePrecondSide'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','name' => 'MBILU'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypePrecond'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.5','min' => '0','type' => 'real','name' => 'GustafssonPar'}},{'content' => '
#PRECONDITIONER
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PRECONDITIONER'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','name' => 'gmres'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'bicgstab'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeKrylov'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'nul','default' => 'T','name' => '0'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'old','name' => 'previous'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'explicit'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'explicit','name' => 'scaled explicit'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeInitKrylov'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '0.1','default' => '0.001','min' => '0','type' => 'real','name' => 'ErrorMaxKrylov'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '100','min' => '1','type' => 'integer','name' => 'MaxMatvecKrylov'}},{'content' => '
#KRYLOV
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'KRYLOV'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'MaxMatvecKrylov','min' => '1','type' => 'integer','name' => 'nKrylovVector'}},{'content' => '
#KRYLOVSIZE
10		nKrylovVector
...
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'MaxIteration'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'tSimulationMax'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','required' => '$_IsStandAlone','name' => 'STOP'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'DoCheckStopFile'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsStandAlone','name' => 'CHECKSTOPFILE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'CpuTimeMax'}},{'content' => '
...
!!!!!!!!!!!!!!!!  OUTPUT PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','default' => 'GM/restartOUT','type' => 'string','name' => 'NameRestartOutDir'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVERESTART'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','default' => 'GM/IO2','type' => 'string','name' => 'NamePlotDir'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVELOGFILE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','min' => '0','type' => 'integer','name' => 'nSatellite'}},{'content' => [{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'MHD','default' => 'T','name' => 'MHD vars. dimensional'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'FUL','name' => 'All vars. dimensional'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'VAR','name' => 'Set vars. dimensional'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'ful','name' => 'All vars. scaled'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'var','name' => 'Set vars. scaled'}}],'name' => 'part','type' => 'e','attrib' => {'required' => 'T','input' => 'select','type' => 'string','name' => 'TypeSatelliteVar'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','name' => 'file'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'eqn','name' => 'equation'}}],'name' => 'part','type' => 'e','attrib' => {'required' => 'F','input' => 'select','type' => 'string','name' => 'TypeTrajectory'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'exclusive' => 'T','name' => 'none'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'step'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'date'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'time'}}],'name' => 'part','type' => 'e','attrib' => {'multiple' => 'T','required' => 'F','input' => 'select','type' => 'string','name' => 'TypeTime'}}],'name' => 'parameter','type' => 'e','attrib' => {'max' => '5','min' => '1','type' => 'strings','name' => 'StringSatellite'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '-1','type' => 'integer','name' => 'DnOutput'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'DtOutput'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','type' => 'string','name' => 'NameTrajectoryFile'}},{'content' => [{'content' => '
			Trajectory file $NameTrajectoryFile must exist
		','type' => 't'}],'name' => 'rule','type' => 'e','attrib' => {'expr' => '-f $NameTrajectoryFile'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$TypeSatelliteVar =~ /\\bvar\\b/i','length' => '100','type' => 'string','name' => 'NameSatelliteVars'}}],'name' => 'for','type' => 'e','attrib' => {'to' => '$nSatellite','from' => '1'}},{'content' => '
#SATELLITE
2                       nSatellite
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVEPLOT'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'DoSaveBinary'}},{'content' => '
#SAVEBINARY
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVEBINARY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoSavePlotsAmr'}},{'content' => '
#SAVEPLOTSAMR
F			DoSavePlotsAmr

! Save plots before each AMR. Default is DoSavePlotsAMR=.false.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SAVEPLOTSAMR'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'DoFlush'}},{'content' => '
...
!\\end{verbatim}
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'AMRINIT'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','min' => '0','type' => 'integer','name' => 'nRefineLevelIC'}},{'content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'multiple' => 'T','alias' => 'GRIDLEVEL','name' => 'GRIDRESOLUTION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','min' => '-1','type' => 'integer','name' => 'MinBlockLevel'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '99','min' => '-1','type' => 'integer','name' => 'MaxBlockLevel'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoFixBodyLevel'}},{'content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
! both.  If both are set, the final one in the session will set the values
! for AMR.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'AMRRESOLUTION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'DnRefine'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoAutoRefine'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '100','default' => '20','min' => '0','type' => 'real','name' => 'PercentCoarsen'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '100','default' => '20','min' => '0','type' => 'real','name' => 'PercentRefine'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '99999','min' => '1','type' => 'integer','name' => 'MaxTotalBlocks'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$DoAutoRefine'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$DnRefine>0'}},{'content' => '
#AMR
2001			DnRefine
...
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','name' => '1'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => '2'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'integer','name' => 'nOrder'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'Roe/roe/1','name' => 'Roe'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'Rusanov/rusanov/2/TVDLF','default' => 'T','name' => 'Rusanov'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'Linde/linde/3/HLLEL','name' => 'Linde'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'Sokolov/sokolov/4/AW','name' => 'Sokolov'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeFlux'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','name' => 'minmod'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'mc'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'name' => 'beta'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeLimiter'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$TypeLimiter ne \'minmod\'','max' => '2','default' => '1.2','min' => '1','type' => 'real','name' => 'LimiterBeta'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$nOrder == 2'}},{'content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
!\\end{verbatim}
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SCHEME'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseNonConservative'}},{'content' => '
#NONCONSERVATIVE
T		UseNonConservative

! For Earth the default is using non-conservative equations 
! (close to the body).
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'NONCONSERVATIVE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '3','default' => '1','min' => '0','type' => 'integer','name' => 'nConservCrit'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'r/R/radius/Radius','default' => 'T','name' => 'radius'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'parabola/paraboloid','name' => 'parabola'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'p/P','name' => 'p'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'gradp/GradP','name' => 'grad P'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeConservCrit'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$TypeConservCrit =~ /^r|radius$/i','default' => '6','min' => '$rBody','type' => 'real','name' => 'rConserv'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','default' => '6','min' => '0','type' => 'real','name' => 'xParabolaConserv'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','default' => '36','min' => '0','type' => 'real','name' => 'yParabolaConserv'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$TypeConservCrit =~ /^p$/i','default' => '0.05','min' => '0','type' => 'real','name' => 'pCoeffConserv'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$TypeConservCrit =~ /gradp/i','default' => '0.1','min' => '0','type' => 'real','name' => 'GradPCoeffConserv'}}],'name' => 'for','type' => 'e','attrib' => {'to' => '$nConservCrit','from' => '1'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CONSERVATIVECRITERIA'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseUpdateCheck'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '100','default' => '40','min' => '0','type' => 'real','name' => 'RhoMinPercent'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '400','min' => '100','type' => 'real','name' => 'RhoMaxPercent'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '100','default' => '40','min' => '0','type' => 'real','name' => 'pMinPercent'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '400','min' => '100','type' => 'real','name' => 'pMaxPercent'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseUpdateCheck'}},{'content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'alias' => 'OPTIMIZE','name' => 'MESSAGEPASS'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseTvdAtReschange'}},{'content' => '
#TVDRESCHANGE
T		UseTvdAtResChange
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'TVDRESCHANGE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBorisCorrection'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$UseBorisCorrection','max' => '1','default' => '1','min' => '0','type' => 'real','name' => 'BorisClightFactor'}},{'content' => '
#BORIS
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'BORIS'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBorisSimple'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$UseBorisSimple','max' => '1','default' => '1','min' => '0','type' => 'real','name' => 'BorisClightFactor'}},{'content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! You can use either Boris or BorisSimple but not both. 
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'BORISSIMPLE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseDivbSource'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseDivbDiffusion'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseProjection'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseConstrainB'}},{'content' => [{'content' => '
...
! If UseConstrainB is true, all others should be false.
! At least one of the options should be true.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DIVB'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseB0Source'}},{'content' => '
#DIVBSOURCE
T			UseB0Source

! Add extra source terms related to the non-zero divergence and curl of B0.
! Default is true.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DIVBSOURCE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.1666667','min' => '0','type' => 'real','name' => 'DivbDiffCoeff'}},{'content' => '
#DIVBDIFFUSION
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'DIVBDIFFUSION'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'cg','default' => 'T','name' => 'Conjugate Gradients'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'bicgstab','name' => 'BiCGSTAB'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectIter'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'rel','default' => 'T','name' => 'Relative norm'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'max','name' => 'Maximum error'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectStop'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.1','min' => '0','type' => 'real','name' => 'RelativeLimit'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.0','min' => '0','type' => 'real','name' => 'AbsoluteLimit'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '50','min' => '1','type' => 'integer','name' => 'MaxMatvec'}},{'content' => '
#PROJECTION
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'PROJECTION'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.01','min' => '0','type' => 'real','name' => 'pRatioLow'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '1','default' => '0.1','min' => '$pRatioLow','type' => 'real','name' => 'pRatioHigh'}},{'content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'CORRECTP'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseAccurateIntegral'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseAccurateTrace'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '60','default' => '0.1','min' => '0.01','type' => 'real','name' => 'DtExchangeRay'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '1','type' => 'integer','name' => 'DnRaytrace'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RAYTRACE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'min' => '1','type' => 'real','name' => 'TauCoupleIm'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'IM'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'min' => '1','type' => 'real','name' => 'TauCoupleIm'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'DoCoupleImPressure'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoCoupleImDensity'}},{'content' => '
...
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.6666666667','min' => '1','type' => 'real','name' => 'Gamma'}},{'content' => '
#GAMMA
1.6666666667		Gamma
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'GAMMA'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '0','type' => 'real','name' => 'RhoLeft'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'UnLeft'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'Ut1Left'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'Ut2Left'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.75','type' => 'real','name' => 'BnLeft'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','type' => 'real','name' => 'Bt1Left'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'Bt2Left'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '0','type' => 'real','name' => 'pRight'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.125','min' => '0','type' => 'real','name' => 'RhoRight'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'UnRight'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'Ut1Right'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'Ut2Right'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.75','type' => 'real','name' => 'BnRight'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '-1','type' => 'real','name' => 'Bt1Right'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'Bt2Right'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.1','min' => '0','type' => 'real','name' => 'pRight'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '0','default' => 'T','name' => 'no rotation'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '0.25'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '0.3333333333333'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '0.5'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '1'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '2'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '3'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '4'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'real','name' => 'ShockSlope'}},{'content' => '
#SHOCKTUBE
1.		rho (left state)
0.		Ux (Un)
0.		Uy (Ut1)
...
! on the grid.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'SHOCKTUBE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '5','min' => '-1','type' => 'real','name' => 'SwRhoDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '181712.175','min' => '-1','type' => 'real','name' => 'SwTDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '0','default' => '-400','type' => 'real','name' => 'SwUxDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'SwUyDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'SwUzDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'SwBxDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0','type' => 'real','name' => 'SwByDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '5','type' => 'real','name' => 'SwBzDim'}},{'content' => '
#SOLARWIND
5.0			SwRhoDim [n/cc]
181712.175		SwTDim [K]
-400.0			SwUxDim [km/s]
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'SOLARWIND'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseSolarWindFile'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','type' => 'string','name' => 'NameSolarWindFile'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseSolarWindFile'}},{'content' => [{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'alias' => 'UPSTREAM_INPUT_FILE','name' => 'SOLARWINDFILE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBody'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '3','min' => '0','type' => 'real','name' => 'rBody'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '4','min' => '-1','type' => 'real','name' => 'rCurrents'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','min' => '0','type' => 'real','name' => 'BodyRhoDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '10000','min' => '0','type' => 'real','name' => 'BodyTDim'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$_NameComp eq \'GM\''}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseBody'}},{'content' => '
#BODY
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','alias' => 'MAGNETOSPHERE','name' => 'BODY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseGravity'}},{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '0','default' => 'T','name' => 'central mass'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '1','name' => 'X direction'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '2','name' => 'Y direction'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => '3','name' => 'Z direction'}}],'name' => 'parameter','type' => 'e','attrib' => {'if' => '$UseGravity','input' => 'select','type' => 'integer','name' => 'iDirGravity'}},{'content' => '
#GRAVITY
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'GRAVITY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseMassLoading'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoAccelerateMassLoading'}},{'content' => '
#MASSLOADING
F			UseMassLoading
F			DoAccelerateMassLoading
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'MASSLOADING'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseHeatFlux'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseSpitzerForm'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.23E-11','type' => 'real','name' => 'Kappa0Heat'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.5','type' => 'real','name' => 'Kappa0Heat'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => 'not $UseSpitzerForm'}},{'content' => '
#HEATFLUX
T		UseHeatFlux
F		UseSpitzerForm
1.23E-11	Kappa0Heat [W/m/K]	! Only if not UseSpitzerForm
2.50E+00	ExponentHeat [-]	! Only if not UseSpitzerForm
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'HEATFLUX'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseResistFlux'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseSpitzerForm'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'Localized/localized','name' => 'localized'}},{'content' => [],'name' => 'option','type' => 'e','attrib' => {'value' => 'Constant/constant','default' => 'T','name' => 'constant'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeResist'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '9.69953E+8','type' => 'real','name' => 'Eta0Resist'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '150','type' => 'real','name' => 'Alpha0Resist'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.5','type' => 'real','name' => 'yShiftResist'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.05','type' => 'real','name' => 'TimeInitRise'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','type' => 'real','name' => 'TimeConstLev'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$TypeResist =~ /localized/i'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => 'not $UseSpitzerForm'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseAnomResist'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.93991E+09','type' => 'real','name' => 'Eta0AnomResist'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.93991E+10','type' => 'real','name' => 'EtaAnomMaxResist'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1','type' => 'real','name' => 'ThresholdFactorResist'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseAnomResist'}},{'content' => '
#RESISTIVEFLUX
T		UseResistFlux
F		UseSpitzerForm
...
! -yShistResist*y2.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'name' => 'RESISTIVEFLUX'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'T','type' => 'logical','name' => 'UseDefaultUnits'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.635620E-02','type' => 'real','name' => 'Grav0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.640000E-01','type' => 'real','name' => 'Beta0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.500000E+06','type' => 'real','name' => 'Length0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.159850E+01','type' => 'real','name' => 'Time0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '5.019000E-11','type' => 'real','name' => 'Rho0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.000000E+05','type' => 'real','name' => 'Tem0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '6.000000E-01','type' => 'real','name' => 'Theta0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.500000E+01','type' => 'real','name' => 'Delta0Diss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '7.000000E+00','type' => 'real','name' => 'EpsilonDiss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '4.500000E+00','type' => 'real','name' => 'RhoDifDiss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '4.000000E-01','type' => 'real','name' => 'yShiftDiss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '5.000000E-01','type' => 'real','name' => 'ScaleHeightDiss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.159850E+01','type' => 'real','name' => 'ScaleFactorDiss'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '5.000000E-01','type' => 'real','name' => 'BZ0iss'}},{'content' => '
#TESTDISSMHD
F                       UseDefaultUnits
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'TESTDISSMHD'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBody2'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.1','min' => '0','type' => 'real','name' => 'rBody2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$xMax','default' => '-40','min' => '$xMin','type' => 'real','name' => 'xBody2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$yMax','default' => '0','min' => '$yMin','type' => 'real','name' => 'yBody2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '$zMax','default' => '0','min' => '$zMin','type' => 'real','name' => 'zBody2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.3*$rBody2','min' => '$rBody2','type' => 'real','name' => 'rCurrents2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '5','min' => '0','type' => 'real','name' => 'RhoDimBody2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '25000','min' => '0','type' => 'real','name' => 'tDimBody2'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$UseBody2'}},{'content' => '
...
! a second body.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession','name' => 'SECONDBODY'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'type' => 'real','name' => 'BdpDimBody2x'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'type' => 'real','name' => 'BdpDimBody2y'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'type' => 'real','name' => 'BdpDimBody2z'}},{'content' => '
...
!!!!!!!!!!!!!!!!!!! SOLAR PROBLEM TYPES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.85E06','min' => '0','type' => 'real','name' => 'BodyTDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.50E8','min' => '0','type' => 'real','name' => 'BodyRhoDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '25.0','min' => '0','type' => 'real','name' => 'qSun'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.75','min' => '0','type' => 'real','name' => 'tHeat'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0','min' => '0','type' => 'real','name' => 'rHeat'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '4.5','min' => '0','type' => 'real','name' => 'SigmaHeat'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoInitRope'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.7','min' => '0','type' => 'real','name' => 'CmeA'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.2','min' => '0','type' => 'real','name' => 'CmeR1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0','min' => '0','type' => 'real','name' => 'CmeR0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.23','type' => 'real','name' => 'CmeA1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.0','type' => 'real','name' => 'CmeAlpha'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.5E-12','min' => '0','type' => 'real','name' => 'CmeRho1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.0E-13','min' => '0','type' => 'real','name' => 'CmeRho2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '10','default' => '0.0','min' => '0','type' => 'real','name' => 'ModulationRho'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '10','default' => '0.0','min' => '0','type' => 'real','name' => 'ModulationP'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '360','default' => '0.0','min' => '-360','type' => 'real','name' => 'OrientationGL98'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '90','default' => '0.0','min' => '-90','type' => 'real','name' => 'LatitudeGL98'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '360','default' => '0.0','min' => '-360','type' => 'real','name' => 'LongitudeGL98'}}],'name' => 'if','type' => 'e','attrib' => {'expr' => '$DoInitRope'}},{'content' => '
...
(clock-wise).
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'HELIOSPHERE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.0001','min' => '-1','type' => 'real','name' => 'DtUpdateB0'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOUPDATEB0'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'type' => 'real','name' => 'HelioDipoleStrength'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'max' => '90','default' => '0','min' => '-90','type' => 'real','name' => 'HelioDipoleTilt'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIODIPOLE'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => 'F','type' => 'logical','name' => 'DoSendMHD'}},{'content' => '
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOTEST'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '19','min' => '1','type' => 'real','name' => 'rBuffMin'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '21','min' => '1','type' => 'real','name' => 'rBuffMax'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '45','min' => '18','type' => 'integer','name' => 'nThetaBuff'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '90','min' => '36','type' => 'integer','name' => 'nPhiBuff'}},{'content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
Default values are shown above.
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession and $_NameComp eq \'IH\'','name' => 'HELIOBUFFERGRID'}},{'content' => [{'content' => [{'content' => [],'name' => 'option','type' => 'e','attrib' => {'default' => 'T','name' => 'Low'}}],'name' => 'parameter','type' => 'e','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeCme'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.7','min' => '0','type' => 'real','name' => 'CmeA'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.2','min' => '0','type' => 'real','name' => 'CmeR1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0','min' => '0','type' => 'real','name' => 'CmeR0'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.23','type' => 'real','name' => 'CmeA1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.0','type' => 'real','name' => 'CmeAlpha'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.5E-12','min' => '0','type' => 'real','name' => 'CmeRho1'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '2.0E-13','min' => '0','type' => 'real','name' => 'CmeRho2'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0','type' => 'real','name' => 'CmeB1Dim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '4.0E5','min' => '0','type' => 'real','name' => 'CmeUErupt'}},{'content' => '
#CME
...
','type' => 't'}],'name' => 'command','type' => 'e','attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'CME'}},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0E6','min' => '0','type' => 'real','name' => 'tArcDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0E-12','min' => '0','type' => 'real','name' => 'RhoArcDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.718144','min' => '0','type' => 'real','name' => 'bArcDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.0E6','type' => 'real','name' => 'ByArcDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '5.0E3','type' => 'real','name' => 'UzArcDim'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.5','type' => 'real','name' => 'Phi0Arc'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '1.3','type' => 'real','name' => 'MuArc'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '3','min' => '0','type' => 'real','name' => 'ExpArc'}},{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'default' => '0.5','min' => '0','type' => 'real','name' => 'WidthArc'}},{'content' => '
#ARCADE
...
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'content' => [{'content' => [],'name' => 'parameter','type' => 'e','attrib' => {'length' => '100','default' => 'Param/','type' => 'string','name' => 'NameIncludeFile'}},{'content' => '
