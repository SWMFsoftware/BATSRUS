...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'HALLRESISTIVITY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseHallResist'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseHallResist'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseHallCmax'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '0','type' => 'real','name' => 'ResistDiag'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','default' => '1','type' => 'real','name' => 'HallFactor'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
