...
','type' => 't'},{'attrib' => {'name' => 'COMPONENT'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'NameComp'},'content' => [{'attrib' => {'if' => '$_NameComp eq \'SC\'','default' => 'T','name' => 'SC'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','default' => 'T','name' => 'IH'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'GM\'','default' => 'T','name' => 'GM'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'PROGRESS'},'content' => [{'attrib' => {'default' => '10','min' => '-1','type' => 'integer','name' => 'DnProgressShort'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '100','min' => '-1','type' => 'integer','name' => 'DnProgressLong'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PROGRESS
10			DnProgressShort
100			DnProgressLong
...
Another planet (moon, commet) can be selected with the #PLANET
(#MOON, #COMMET) command. The real planet parameters can be modified 
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'UPDATEB0'},'content' => [{'attrib' => {'default' => '0.0001','min' => '-1','type' => 'real','name' => 'DtUpdateB0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTIJK'},'content' => [{'attrib' => {'min' => '-2','type' => 'integer','max' => '$nI+2','name' => 'iTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-2','type' => 'integer','max' => '$nJ+2','name' => 'jTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-2','type' => 'integer','max' => '$nK+2','name' => 'kTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '1','type' => 'integer','max' => '$MaxBlock','name' => 'iBlockTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '0','type' => 'integer','name' => 'iProcTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTIJK
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTXYZ'},'content' => [{'attrib' => {'min' => '$xMin','type' => 'real','max' => '$xMax','name' => 'xTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$yMin','type' => 'real','max' => '$yMax','name' => 'yTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$zMin','type' => 'real','max' => '$zMax','name' => 'zTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TESTXYZ
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TESTTIME'},'content' => [{'attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'nIterTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1e30','min' => '-1','type' => 'real','name' => 'TimeTest'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'CODEVERSION'},'content' => [{'attrib' => {'default' => '7.50','min' => '0','type' => 'real','name' => 'CodeVersion'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#CODEVERSION
7.50                    CodeVersion
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'USERMODULE'},'content' => [{'attrib' => {'default' => 'EMPTY','length' => '100','type' => 'string','name' => 'NameUserModule'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.0','min' => '0','type' => 'real','name' => 'VersionUserModule'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'EQUATION'},'content' => [{'attrib' => {'default' => 'MHD','length' => '100','type' => 'string','name' => 'NameEquation'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '8','type' => 'integer','name' => 'nVar'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'PRECISION'},'content' => [{'attrib' => {'type' => 'integer','input' => 'select','name' => 'nByteReal'},'content' => [{'attrib' => {'value' => '4','default' => '$_nByteReal==4','name' => 'single precision (4)'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '8','default' => '$_nByteReal==8','name' => 'double precision (8)'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$nByteReal==$_nByteReal or not $UseStrict'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'CHECKGRIDSIZE'},'content' => [{'attrib' => {'default' => '$nI','min' => '$nI','type' => 'integer','max' => '$nI','name' => 'nI'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '$nJ','min' => '$nJ','type' => 'integer','max' => '$nJ','name' => 'nJ'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '$nK','min' => '$nK','type' => 'integer','max' => '$nK','name' => 'nK'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '1','type' => 'integer','max' => '$MaxBlockALL','name' => 'MinBlockALL'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!\\end{verbatim}
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINDIR'},'content' => [{'attrib' => {'default' => 'GM/restartIN','length' => '100','type' => 'string','name' => 'NameRestartInDir'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-d $NameRestartInDir'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINFILE'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeRestartInFile'},'content' => [{'attrib' => {'default' => 'T','name' => 'block'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'one'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'OUTERBOUNDARY'},'content' => [{'attrib' => {'values' => 'TypeBcEast,TypeBcWest,TypeBcSouth,TypeBcNorth,TypeBcBot,TypeBcTop','name' => 'Side'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => '$Side'},'content' => [{'attrib' => {'name' => 'coupled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'default' => '$Side eq \'TypeBcEast\'','name' => 'vary/inflow'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'default' => '$Side ne \'TypeBcEast\'','name' => 'float/outflow'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'heliofloat'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'reflect'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'periodic'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'fixed'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'shear'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'linetied'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'raeder'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'arcadetop'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'arcadebot'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'arcadebotcont'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'user'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'foreach'},{'attrib' => {'expr' => 'not($TypeBcEast eq \'periodic\' xor $TypeBcWest eq \'periodic\')'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'EXTRABOUNDARY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseExtraBoundary'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseExtraBoundary'},'content' => [{'attrib' => {'type' => 'string','name' => 'TypeExtraBoundary'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoFixExtraBoundary'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'FACEOUTERBC'},'content' => [{'attrib' => {'default' => '0','min' => '0','type' => 'integer','max' => '6','name' => 'MaxBoundary'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$MaxBoundary >= 1'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoFixOuterBoundary'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#FACEOUTERBC
0              MaxBoundary            
...
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','required' => 'T','name' => 'GRID'},'content' => [{'attrib' => {'default' => '2','min' => '1','type' => 'integer','name' => 'nRootBlockX'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '1','type' => 'integer','name' => 'nRootBlockY'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '1','type' => 'integer','name' => 'nRootBlockZ'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '-192.0','type' => 'real','name' => 'xMin'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '  64.0','min' => '$xMin','type' => 'real','name' => 'xMax'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => ' -64.0','type' => 'real','name' => 'yMin'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '  64.0','min' => '$yMin','type' => 'real','name' => 'yMax'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => ' -64.0','type' => 'real','name' => 'zMin'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '  64.0','min' => '$zMin','type' => 'real','name' => 'zMax'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'multiple' => 'T','alias' => 'COORDINATESYSTEM','name' => 'COORDSYSTEM'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeCoordSystem'},'content' => [{'attrib' => {'if' => '$_NameComp eq \'GM\'','default' => 'T','name' => 'GSM'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','default' => 'T','name' => 'HGI'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'HGC'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'SC\'','default' => 'T','name' => 'HGR'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'HGI'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','name' => 'VERTEXBASEDGRID'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseVertexBasedGrid'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','alias' => 'SETREALTIME','name' => 'STARTTIME'},'content' => [{'attrib' => {'default' => '2000','type' => 'integer','name' => 'iYear'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '3','min' => '1','type' => 'integer','max' => '12','name' => 'iMonth'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '21','min' => '1','type' => 'integer','max' => '31','name' => 'iDay'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '0','type' => 'integer','max' => '23','name' => 'iHour'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '0','type' => 'integer','max' => '59','name' => 'iMinute'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '0','type' => 'integer','max' => '59','name' => 'iSecond'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'TIMESIMULATION'},'content' => [{'attrib' => {'default' => '0.0','min' => '0','type' => 'real','name' => 'tSimulation'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'NSTEP'},'content' => [{'attrib' => {'default' => '0','min' => '0','type' => 'integer','name' => 'nStep'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'NPREVIOUS'},'content' => [{'attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'nPrevious'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'TIMESTEPPING'},'content' => [{'attrib' => {'type' => 'integer','input' => 'select','name' => 'nStage'},'content' => [{'attrib' => {'value' => '1','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.8','min' => '0','type' => 'real','max' => '1','name' => 'CflExpl'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'FIXEDTIMESTEP'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseDtFixed'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseDtFixed','default' => '1.0','min' => '0','type' => 'real','name' => 'DtFixedDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'STEADYCRITERIA','name' => 'PARTSTEADYCRITERIA'},'content' => [{'attrib' => {'default' => '1','min' => '1','type' => 'integer','name' => 'MinCheckVar'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '8','min' => '$MinCheckVar','type' => 'integer','name' => 'MaxCheckVar'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'from' => '$MinCheckVar','to' => '$MaxCheckVar'},'content' => [{'attrib' => {'default' => '0.001','min' => '0','type' => 'real','max' => '1','name' => 'RelativeEps'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0001','min' => '0','type' => 'real','name' => 'AbsoluteEps'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'},{'content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'POINTIMPLICIT'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UsePointImplicit'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UsePointImplicit','default' => '0.5','min' => '0.5','type' => 'real','max' => '1','name' => 'BetaPointImplicit'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#POINTIMPLICIT
T		UsePointImplicit
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'alias' => 'STEPPINGCRITERIA','name' => 'IMPLICITCRITERIA'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeImplCrit'},'content' => [{'attrib' => {'value' => 'dt','default' => 'T','name' => 'Time step'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'r/R','name' => 'Radial distance'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'test','name' => 'Test block'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeImplCrit eq \'R\'','min' => '0','type' => 'real','name' => 'rImplicit'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'PARTIMPLICIT','name' => 'PARTIMPL'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UsePartImplicit2'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'IMPLICITSCHEME','name' => 'IMPLSCHEME'},'content' => [{'attrib' => {'type' => 'integer','input' => 'select','name' => 'nOrderImpl'},'content' => [{'attrib' => {'default' => 'T','name' => '1'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => '2'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeFluxImpl'},'content' => [{'attrib' => {'value' => 'Roe/roe/1','name' => 'Roe'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Rusanov/rusanov/2/TVDLF','default' => 'T','name' => 'Rusanov'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Linde/linde/3/HLLEL','name' => 'Linde'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Sokolov/sokolov/4/AW','name' => 'Sokolov'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#IMPLSCHEME
1               nOrderImpl
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'IMPLICITCHECK','name' => 'IMPLCHECK'},'content' => [{'attrib' => {'default' => '0.3','min' => '0','type' => 'real','max' => '0.9','name' => 'RejectStepLevel'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.5','min' => '0','type' => 'real','max' => '0.9','name' => 'RejectStepFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.6','min' => '0','type' => 'real','max' => '0.9','name' => 'ReduceStepLevel'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.9','min' => '0','type' => 'real','max' => '1','name' => 'ReduceStepFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.8','min' => '0','type' => 'real','max' => '1','name' => 'IncreaseStepLevel'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.05','min' => '1','type' => 'real','max' => '2','name' => 'IncreaseStepFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'JACOBIAN'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeJacobian'},'content' => [{'attrib' => {'value' => 'prec','default' => 'T','name' => 'Preconditioned'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'free','name' => 'No preconditioning'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '$doublePrecision ? 1.e-12 : 1.e-6','min' => '0','type' => 'real','max' => '1.e-5','name' => 'JacobianEps'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#JACOBIAN
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PRECONDITIONER'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypePrecondSide'},'content' => [{'attrib' => {'name' => 'left'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'default' => 'T','name' => 'symmetric'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'right'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypePrecond'},'content' => [{'attrib' => {'default' => 'T','name' => 'MBILU'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.5','min' => '0','type' => 'real','max' => '1','name' => 'GustafssonPar'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PRECONDITIONER
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'KRYLOV'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeKrylov'},'content' => [{'attrib' => {'default' => 'T','name' => 'gmres'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'bicgstab'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeInitKrylov'},'content' => [{'attrib' => {'value' => 'nul','default' => 'T','name' => '0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'old','name' => 'previous'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'explicit'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'explicit','name' => 'scaled explicit'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.001','min' => '0','type' => 'real','max' => '0.1','name' => 'ErrorMaxKrylov'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '100','min' => '1','type' => 'integer','name' => 'MaxMatvecKrylov'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#KRYLOV
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'KRYLOVSIZE'},'content' => [{'attrib' => {'default' => 'MaxMatvecKrylov','min' => '1','type' => 'integer','name' => 'nKrylovVector'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#KRYLOVSIZE
10		nKrylovVector
...
','type' => 't'},{'attrib' => {'if' => '$_IsStandAlone','required' => '$_IsStandAlone','name' => 'STOP'},'content' => [{'attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'MaxIteration'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'tSimulationMax'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsStandAlone','name' => 'CPUTIMEMAX'},'content' => [{'attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'CpuTimeMax'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
!!!!!!!!!!!!!!!!  OUTPUT PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'RESTARTOUTDIR'},'content' => [{'attrib' => {'default' => 'GM/restartOUT','length' => '100','type' => 'string','name' => 'NameRestartOutDir'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-d $NameRestartOutDir'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'RESTARTOUTFILE'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeRestartOutFile'},'content' => [{'attrib' => {'name' => 'block'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'default' => 'T','name' => 'one'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'SAVERESTART'},'content' => [{'attrib' => {'default' => 'T','type' => 'logical','name' => 'DoSaveRestart'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoSaveRestart'},'content' => [{'attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'DnSaveRestart'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'DtSaveRestart'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#SAVERESTART
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PLOTDIR'},'content' => [{'attrib' => {'default' => 'GM/IO2','length' => '100','type' => 'string','name' => 'NamePlotDir'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-d $NamePlotDir'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'SAVELOGFILE'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoSaveLogfile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoSaveLogfile'},'content' => [{'attrib' => {'min' => '1','type' => 'strings','max' => '4','name' => 'StringLog'},'content' => [{'attrib' => {'required' => 'T','type' => 'string','input' => 'select','name' => 'TypeLogVar'},'content' => [{'attrib' => {'value' => 'MHD','default' => 'T','name' => 'MHD vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FLX','name' => 'Flux vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'RAW','name' => 'Raw vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'VAR','name' => 'Set vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'mhd','default' => 'T','name' => 'MHD vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'flx','name' => 'Flux vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'raw','name' => 'Raw vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'var','name' => 'Set vars. scaled'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'required' => 'F','type' => 'string','multiple' => 'T','input' => 'select','name' => 'TypeTime'},'content' => [{'attrib' => {'exclusive' => 'T','name' => 'none'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'step'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'date'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'time'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '-1','type' => 'integer','name' => 'DnSaveLogfile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'DtSaveLogfile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeLogVar =~ /var/i','length' => '100','type' => 'string','name' => 'NameLogVars'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '($TypeLogVar=~/flx/i or $NameLogVars=~/flx/i)','min' => '1','length' => '100','type' => 'strings','max' => '10','name' => 'StringLogRadii'},'content' => [{'attrib' => {'min' => '$rBody','type' => 'real','multiple' => 'T','name' => 'LogRadii'},'content' => [],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#SAVELOGFILE
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'SATELLITE'},'content' => [{'attrib' => {'default' => '0','min' => '0','type' => 'integer','name' => 'nSatellite'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'from' => '1','to' => '$nSatellite'},'content' => [{'attrib' => {'min' => '1','type' => 'strings','max' => '5','name' => 'StringSatellite'},'content' => [{'attrib' => {'required' => 'T','type' => 'string','input' => 'select','name' => 'TypeSatelliteVar'},'content' => [{'attrib' => {'value' => 'MHD','default' => 'T','name' => 'MHD vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FUL','name' => 'All vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'VAR','name' => 'Set vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ful','name' => 'All vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'var','name' => 'Set vars. scaled'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'required' => 'F','type' => 'string','input' => 'select','name' => 'TypeTrajectory'},'content' => [{'attrib' => {'default' => 'T','name' => 'file'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'eqn','name' => 'equation'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'required' => 'F','type' => 'string','multiple' => 'T','input' => 'select','name' => 'TypeTime'},'content' => [{'attrib' => {'exclusive' => 'T','name' => 'none'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'step'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'date'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'time'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '-1','type' => 'integer','name' => 'DnOutput'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '-1','min' => '-1','type' => 'real','name' => 'DtOutput'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'length' => '100','type' => 'string','name' => 'NameTrajectoryFile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '-f $NameTrajectoryFile'},'content' => [{'content' => '
...
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'STEADYSTATESATELLITE'},'content' => [{'attrib' => {'default' => '0','type' => 'real','name' => 'SatelliteTimeStart'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'SatelliteTimeEnd'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'},{'attrib' => {'name' => 'SAVEPLOT'},'content' => [{'attrib' => {'default' => '0','min' => '0','type' => 'integer','max' => '100','name' => 'nPlotFile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'from' => '1','to' => '$nPlotFile'},'content' => [{'attrib' => {'min' => '3','type' => 'strings','max' => '3','name' => 'StringPlot'},'content' => [{'attrib' => {'required' => 'T','type' => 'string','input' => 'select','name' => 'plotform'},'content' => [{'attrib' => {'value' => 'tec','name' => 'TECPLOT'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'idl','name' => 'IDL'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'required' => 'T','type' => 'string','input' => 'select','name' => 'plotarea'},'content' => [{'attrib' => {'value' => '3d/3d_','name' => '3D'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'x=0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'y=0','default' => 'T'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'z=0'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'sph'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'los'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'lin'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'cut'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'slc','if' => '$plotform =~ /\\btec\\b/'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'dpl','if' => '$plotform =~ /\\btec\\b/'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'blk','if' => '$plotform =~ /\\btec\\b/'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'},{'attrib' => {'required' => 'T','type' => 'string','input' => 'select','name' => 'plotvar'},'content' => [{'attrib' => {'value' => 'MHD','name' => 'MHD vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FUL','name' => 'All vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'RAW','name' => 'Raw vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'RAY','name' => 'Ray tracing vars. dim.'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'FLX','name' => 'Flux vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'SOL','name' => 'Solar vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'POS','if' => '$plotarea eq \'lin\'','name' => 'Position vars. dimensional'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'VAR','name' => 'Select dimensional vars.'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'mhd','name' => 'MHD vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ful','name' => 'All vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'raw','name' => 'Raw vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'ray','name' => 'Ray tracing vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'flx','name' => 'Flux vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'sol','name' => 'Solar vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'pos','if' => '$plotarea eq \'lin\'','name' => 'Position vars. scaled'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'var','name' => 'Select scaled vars.'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'part'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','type' => 'integer','name' => 'DnSavePlot'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '-1','type' => 'real','name' => 'DtSavePlot'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$plotarea =~ /\\bdpl|cut|slc\\b/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xMinCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$xMinCut','type' => 'real','name' => 'xMaxCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yMinCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$yMinCut','type' => 'real','name' => 'yMaxCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zMinCut'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'min' => '$zMinCut','type' => 'real','name' => 'zMaxCut'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$plotarea =~ /\\bslc\\b/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'xNormal'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yNormal'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zNormal'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$plotarea =~ /\\bblk\\b/'},'content' => [{'attrib' => {'type' => 'real','name' => 'xPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yPoint'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zPoint'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'if' => '$plotarea =~ /\\bsph\\b/','default' => '10','min' => '0','type' => 'real','name' => 'Radius'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$plotarea =~ /\\blos\\b/'},'content' => [{'attrib' => {'default' => '-215','type' => 'real','name' => 'ObsPosX'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'ObsPosY'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'ObsPosZ'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '-89','type' => 'real','max' => '89','name' => 'OffsetAngle'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '32','min' => '0','type' => 'real','name' => 'rSizeImage'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'xOffset'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','type' => 'real','name' => 'yOffset'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '2','min' => '0','type' => 'real','name' => 'rOccult'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.5','min' => '0','type' => 'real','max' => '1','name' => 'MuLimbDarkening'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '200','min' => '2','type' => 'integer','name' => 'nPix'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '$plotarea =~ /\\blin\\b/'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'NameLine'},'content' => [{'attrib' => {'value' => 'A','name' => 'Advected B'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'default' => 'T','name' => 'B'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'U'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'J'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'IsSingleLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '1','type' => 'integer','max' => '20','name' => 'nLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'from' => '1','to' => '$nLine'},'content' => [{'attrib' => {'type' => 'real','name' => 'xStartLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'yStartLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'real','name' => 'zStartLine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'logical','name' => 'IsParallel'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'}],'type' => 'e','name' => 'if'},{'attrib' => {'if' => '($plotform=~/\\bidl\\b/ and $plotarea!~/\\b(sph|los|lin)\\b/)','default' => '-1.0','min' => '-1.0','type' => 'real','name' => 'DxSavePlot'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$plotvar =~ /\\bvar\\b/i'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameVars'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'length' => '100','type' => 'string','name' => 'NamePars'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'}],'type' => 'e','name' => 'for'},{'content' => '
#SAVEPLOT
9			nPlotfile
...
!\\end{verbatim}
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'AMRINITPHYSICS'},'content' => [{'attrib' => {'default' => '0','min' => '0','type' => 'integer','name' => 'nRefineLevelIC'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'AMRLEVELS'},'content' => [{'attrib' => {'default' => '0','min' => '-1','type' => 'integer','name' => 'MinBlockLevel'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '99','min' => '-1','type' => 'integer','name' => 'MaxBlockLevel'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoFixBodyLevel'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
! both.  If both are set, the final one in the session will set the values
! for AMR.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'AMR'},'content' => [{'attrib' => {'default' => '-1','min' => '-1','type' => 'integer','name' => 'DnRefine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DnRefine>0'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoAutoRefine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoAutoRefine'},'content' => [{'attrib' => {'default' => '20','min' => '0','type' => 'real','max' => '100','name' => 'PercentCoarsen'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '20','min' => '0','type' => 'real','max' => '100','name' => 'PercentRefine'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '99999','min' => '1','type' => 'integer','name' => 'MaxTotalBlocks'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'}],'type' => 'e','name' => 'if'},{'content' => '
#AMR
2001			DnRefine
...
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'SCHEME'},'content' => [{'attrib' => {'type' => 'integer','input' => 'select','name' => 'nOrder'},'content' => [{'attrib' => {'default' => 'T','name' => '1'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => '2'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeFlux'},'content' => [{'attrib' => {'value' => 'Roe/roe/1','name' => 'Roe'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Rusanov/rusanov/2/TVDLF','default' => 'T','name' => 'Rusanov'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Linde/linde/3/HLLEL','name' => 'Linde'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'Sokolov/sokolov/4/AW','name' => 'Sokolov'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$nOrder == 2'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeLimiter'},'content' => [{'attrib' => {'default' => 'T','name' => 'minmod'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'mc'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'mc3'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'beta'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeLimiter ne \'minmod\'','default' => '1.2','min' => '1','type' => 'real','max' => '2','name' => 'LimiterBeta'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
! (close to the body).
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'CONSERVATIVECRITERIA'},'content' => [{'attrib' => {'default' => '1','min' => '0','type' => 'integer','max' => '3','name' => 'nConservCrit'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'from' => '1','to' => '$nConservCrit'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeConservCrit'},'content' => [{'attrib' => {'value' => 'r/R/radius/Radius','default' => 'T','name' => 'radius'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'parabola/paraboloid','name' => 'parabola'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'p/P','name' => 'p'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'gradp/GradP','name' => 'grad P'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^r|radius$/i','default' => '6','min' => '$rBody','type' => 'real','name' => 'rConserv'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','default' => '6','min' => '0','type' => 'real','name' => 'xParabolaConserv'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^parabol/i','default' => '36','min' => '0','type' => 'real','name' => 'yParabolaConserv'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /^p$/i','default' => '0.05','min' => '0','type' => 'real','name' => 'pCoeffConserv'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$TypeConservCrit =~ /gradp/i','default' => '0.1','min' => '0','type' => 'real','name' => 'GradPCoeffConserv'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'for'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'UPDATECHECK'},'content' => [{'attrib' => {'default' => 'T','type' => 'logical','name' => 'UseUpdateCheck'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseUpdateCheck'},'content' => [{'attrib' => {'default' => '40','min' => '0','type' => 'real','max' => '100','name' => 'RhoMinPercent'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '400','min' => '100','type' => 'real','name' => 'RhoMaxPercent'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '40','min' => '0','type' => 'real','max' => '100','name' => 'pMinPercent'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '400','min' => '100','type' => 'real','name' => 'pMaxPercent'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PROLONGATION'},'content' => [{'attrib' => {'type' => 'integer','input' => 'select','name' => 'nOrderProlong'},'content' => [{'attrib' => {'default' => 'T','name' => '1'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => '2'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$nOrderProlong==2','type' => 'string','input' => 'select','name' => 'TypeProlong'},'content' => [{'attrib' => {'value' => 'lr','default' => 'T','name' => 'left-right'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'central'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'minmod'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'lr2','name' => 'left-right extrapolate'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'central2','name' => 'central    extrapolate'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'minmod2','name' => 'minmod     extrapolate'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#PROLONGATION
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'RESOLUTIONCHANGE','name' => 'RESCHANGE'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseAccurateReschange'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#RESCHANGE
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'TVDRESCHANGE'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseTvdReschange'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#TVDRESCHANGE
T		UseTvdResChange
...
! Default value is false, which results in first order 
! prolongation and restriction operators at the resolution changes.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'BORIS'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBorisCorrection'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseBorisCorrection','default' => '1','min' => '0','type' => 'real','max' => '1','name' => 'BorisClightFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#BORIS
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'BORISSIMPLE'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBorisSimple'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseBorisSimple','default' => '1','min' => '0','type' => 'real','max' => '1','name' => 'BorisClightFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! Default is true.
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PROJECTION'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeProjectIter'},'content' => [{'attrib' => {'value' => 'cg','default' => 'T','name' => 'Conjugate Gradients'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'bicgstab','name' => 'BiCGSTAB'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'type' => 'string','input' => 'select','name' => 'TypeProjectStop'},'content' => [{'attrib' => {'value' => 'rel','default' => 'T','name' => 'Relative norm'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => 'max','name' => 'Maximum error'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.1','min' => '0','type' => 'real','max' => '1','name' => 'RelativeLimit'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0','min' => '0','type' => 'real','name' => 'AbsoluteLimit'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '50','min' => '1','type' => 'integer','name' => 'MaxMatvec'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PROJECTION
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'CORRECTP'},'content' => [{'attrib' => {'default' => '0.01','min' => '0','type' => 'real','max' => '1','name' => 'pRatioLow'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.1','min' => '$pRatioLow','type' => 'real','max' => '1','name' => 'pRatioHigh'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'GAMMA'},'content' => [{'attrib' => {'default' => '1.6666666667','min' => '1','type' => 'real','name' => 'Gamma'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#GAMMA
1.6666666667		Gamma
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'PLASMA'},'content' => [{'attrib' => {'default' => '1','min' => '0','type' => 'real','name' => 'AverageIonMass'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '0','type' => 'real','name' => 'AverageIonCharge'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '0','type' => 'real','name' => 'ElectronTemperatureRatio'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#PLASMA
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'alias' => 'UPSTREAM_INPUT_FILE','name' => 'SOLARWINDFILE'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseSolarWindFile'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseSolarWindFile'},'content' => [{'attrib' => {'length' => '100','type' => 'string','name' => 'NameSolarWindFile'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'attrib' => {'expr' => '-f $NameSolarWindFile'},'content' => [{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','alias' => 'MAGNETOSPHERE','name' => 'BODY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBody'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseBody'},'content' => [{'attrib' => {'default' => '3','min' => '0','type' => 'real','name' => 'rBody'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$_NameComp eq \'GM\''},'content' => [{'attrib' => {'default' => '4','min' => '-1','type' => 'real','name' => 'rCurrents'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '0','type' => 'real','name' => 'BodyRhoDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '10000','min' => '0','type' => 'real','name' => 'BodyTDim'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'}],'type' => 'e','name' => 'if'},{'content' => '
#BODY
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'GRAVITY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseGravity'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'if' => '$UseGravity','type' => 'integer','input' => 'select','name' => 'iDirGravity'},'content' => [{'attrib' => {'value' => '0','default' => 'T','name' => 'central mass'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '1','name' => 'X direction'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '2','name' => 'Y direction'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'value' => '3','name' => 'Z direction'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'content' => '
#GRAVITY
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'HALLRESISTIVITY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseHallResist'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseHallResist'},'content' => [{'attrib' => {'default' => '1','min' => '0','type' => 'real','name' => 'HallFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1','min' => '0','type' => 'real','max' => '1','name' => 'HallCmaxFactor'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '0','type' => 'real','max' => '1','name' => 'HallHyperFactor'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'HALLREGION'},'content' => [{'attrib' => {'type' => 'string','input' => 'select','name' => 'NameHallRegion'},'content' => [{'attrib' => {'default' => 'T','name' => 'all'},'content' => [],'type' => 'e','name' => 'option'},{'attrib' => {'name' => 'shell'},'content' => [],'type' => 'e','name' => 'option'}],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$NameHallRegion eq \'shell\''},'content' => [{'attrib' => {'default' => '0','min' => '0','type' => 'real','name' => 'R1Hall'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '$R1Hall','type' => 'real','name' => 'R2Hall'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '0','type' => 'real','name' => 'HallWidth'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession','name' => 'SECONDBODY'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseBody2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$UseBody2'},'content' => [{'attrib' => {'default' => '0.1','min' => '0','type' => 'real','name' => 'rBody2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '-40','min' => '$xMin','type' => 'real','max' => '$xMax','name' => 'xBody2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '$yMin','type' => 'real','max' => '$yMax','name' => 'yBody2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '$zMin','type' => 'real','max' => '$zMax','name' => 'zBody2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.3*$rBody2','min' => '$rBody2','type' => 'real','name' => 'rCurrents2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '5','min' => '0','type' => 'real','name' => 'RhoDimBody2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '25000','min' => '0','type' => 'real','name' => 'tDimBody2'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
!!!!!!!!!!!!!!!!!!! SOLAR PROBLEM TYPES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'HELIOSPHERE'},'content' => [{'attrib' => {'default' => '2.85E06','min' => '0','type' => 'real','name' => 'BodyTDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.50E8','min' => '0','type' => 'real','name' => 'BodyRhoDim'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '25.0','min' => '0','type' => 'real','name' => 'qSun'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.75','min' => '0','type' => 'real','name' => 'tHeat'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.0','min' => '0','type' => 'real','name' => 'rHeat'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '4.5','min' => '0','type' => 'real','name' => 'SigmaHeat'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => 'F','type' => 'logical','name' => 'DoInitRope'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'expr' => '$DoInitRope'},'content' => [{'attrib' => {'default' => '0.7','min' => '0','type' => 'real','name' => 'CmeA'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.2','min' => '0','type' => 'real','name' => 'CmeR1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '1.0','min' => '0','type' => 'real','name' => 'CmeR0'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.23','type' => 'real','name' => 'CmeA1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0','type' => 'real','name' => 'CmeAlpha'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '2.5E-12','min' => '0','type' => 'real','name' => 'CmeRho1'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '2.0E-13','min' => '0','type' => 'real','name' => 'CmeRho2'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0','min' => '0','type' => 'real','max' => '10','name' => 'ModulationRho'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0','min' => '0','type' => 'real','max' => '10','name' => 'ModulationP'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0','min' => '-360','type' => 'real','max' => '360','name' => 'OrientationGL98'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0','min' => '-90','type' => 'real','max' => '90','name' => 'LatitudeGL98'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0.0','min' => '-360','type' => 'real','max' => '360','name' => 'LongitudeGL98'},'content' => [],'type' => 'e','name' => 'parameter'}],'type' => 'e','name' => 'if'},{'content' => '
...
(clock-wise).
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOUPDATEB0'},'content' => [{'attrib' => {'default' => '0.0001','min' => '-1','type' => 'real','name' => 'DtUpdateB0'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIODIPOLE'},'content' => [{'attrib' => {'type' => 'real','name' => 'HelioDipoleStrength'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '0','min' => '-90','type' => 'real','max' => '90','name' => 'HelioDipoleTilt'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'if' => '$_IsFirstSession and $_NameComp eq \'IH\'','name' => 'HELIOBUFFERGRID'},'content' => [{'attrib' => {'default' => '19','min' => '1','type' => 'real','name' => 'rBuffMin'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '21','min' => '1','type' => 'real','name' => 'rBuffMax'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '45','min' => '18','type' => 'integer','name' => 'nThetaBuff'},'content' => [],'type' => 'e','name' => 'parameter'},{'attrib' => {'default' => '90','min' => '36','type' => 'integer','name' => 'nPhiBuff'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
','type' => 't'},{'attrib' => {'name' => 'INCLUDE'},'content' => [{'attrib' => {'default' => 'Param/','length' => '100','type' => 'string','name' => 'NameIncludeFile'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '
