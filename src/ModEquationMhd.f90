...
! CellCenteredVars... can result in an error
  ...
  !/
  !(or smth less then cTiny).Otherwise the code  will interprete the 
  !physically reasonable negative or zero
  ...
  ! Scalars to be advected. If none, ScalarLast_ should be less than ScalarFirst_
