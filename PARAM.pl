...
'},{'name' => 'command','attrib' => {'name' => 'COMPONENT'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'NameComp','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'SC','if' => '$_NameComp eq \'SC\'','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'IH','if' => '$_NameComp eq \'IH\'','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'GM','if' => '$_NameComp eq \'GM\'','default' => 'T'},'type' => 'e','content' => []}]},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'DESCRIPTION','if' => '$_IsStandAlone'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'StringDescription','length' => '100','type' => 'string'},'type' => 'e','content' => []},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'MAGNETICAXIS','if' => '$_IsStandAlone'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'IsMagAxisPrimary','type' => 'logical','default' => 'T'},'type' => 'e','content' => []},{'name' => 'if','attrib' => {'expr' => '$IsMagAxisPrimary'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'MagAxisTheta','type' => 'real','min' => '0','max' => '180'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'MagAxisPhi','type' => 'real','min' => '0','max' => '360'},'type' => 'e','content' => []}]},{'name' => 'set','attrib' => {'name' => 'PlanetCommand','value' => 'MAGNETICAXIS','type' => 'string'},'type' => 'e','content' => []},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'USERMODULE','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'NameUserModule','length' => '100','type' => 'string','default' => 'EMPTY'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'VersionUserModule','type' => 'real','default' => '1.0','min' => '0'},'type' => 'e','content' => []},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'EQUATION','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'NameEquation','length' => '100','type' => 'string','default' => 'MHD'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'nVar','type' => 'integer','default' => '8'},'type' => 'e','content' => []},{'type' => 't','content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
'}]},{'name' => 'command','attrib' => {'name' => 'PRECISION','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nByteReal','type' => 'integer','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'single precision (4)','value' => '4','default' => '$_nByteReal==4'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'double precision (8)','value' => '8','default' => '$_nByteReal==8'},'type' => 'e','content' => []}]},{'name' => 'rule','attrib' => {'expr' => '$nByteReal==$_nByteReal or not $UseStrict'},'type' => 'e','content' => [{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'CHECKGRIDSIZE','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nI','type' => 'integer','default' => '$nI','min' => '$nI','max' => '$nI'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'nJ','type' => 'integer','default' => '$nJ','min' => '$nJ','max' => '$nJ'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'nK','type' => 'integer','default' => '$nK','min' => '$nK','max' => '$nK'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'MinBlockALL','type' => 'integer','min' => '1','max' => '$MaxBlockALL'},'type' => 'e','content' => []},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'TIMING','if' => '$_IsStandAlone'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'UseTiming','type' => 'logical','default' => 'T'},'type' => 'e','content' => []},{'name' => 'if','attrib' => {'expr' => '$UseTiming'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'Frequency','type' => 'integer','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'none','value' => '-3'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'final only','value' => '-2','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'end of sessions','value' => '-1'},'type' => 'e','content' => []},{'name' => 'optioninput','attrib' => {'name' => 'every X steps','default' => '100','min' => '1'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'nDepthTiming','type' => 'integer','default' => '-1','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'TypeTimingReport','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'cumulative','value' => 'cumu','default' => '1'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'list'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'tree'},'type' => 'e','content' => []}]}]},{'type' => 't','content' => '
#TIMING
...
!\\end{verbatim}
'}]},{'name' => 'command','attrib' => {'name' => 'RESTARTINDIR','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'NameRestartInDir','length' => '100','type' => 'string','default' => 'GM/restartIN'},'type' => 'e','content' => []},{'name' => 'rule','attrib' => {'expr' => '-d $NameRestartInDir'},'type' => 'e','content' => [{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'RESTARTINFILE','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'TypeRestartInFile','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'block','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'one'},'type' => 'e','content' => []}]},{'type' => 't','content' => '
...
'},{'name' => 'command','attrib' => {'name' => 'GRID','required' => 'T','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nRootBlockX','type' => 'integer','default' => '2','min' => '1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'nRootBlockY','type' => 'integer','default' => '1','min' => '1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'nRootBlockZ','type' => 'integer','default' => '1','min' => '1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'xMin','type' => 'real','default' => '-192.0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'xMax','type' => 'real','default' => '  64.0','min' => '$xMin'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yMin','type' => 'real','default' => ' -64.0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yMax','type' => 'real','default' => '  64.0','min' => '$yMin'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zMin','type' => 'real','default' => ' -64.0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zMax','type' => 'real','default' => '  64.0','min' => '$zMin'},'type' => 'e','content' => []},{'type' => 't','content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
'}]},{'name' => 'command','attrib' => {'name' => 'COORDSYSTEM','alias' => 'COORDINATESYSTEM','multiple' => 'T'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'TypeCoordSystem','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'GSM','if' => '$_NameComp eq \'GM\'','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'HGI','if' => '$_NameComp eq \'IH\'','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'HGC','if' => '$_NameComp eq \'IH\''},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'HGR','if' => '$_NameComp eq \'SC\'','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'HGI','if' => '$_NameComp eq \'SC\''},'type' => 'e','content' => []}]},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'FIXEDTIMESTEP'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'UseDtFixed','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'DtFixedDim','if' => '$UseDtFixed','type' => 'real','default' => '1.0','min' => '0'},'type' => 'e','content' => []},{'type' => 't','content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
'}]},{'name' => 'command','attrib' => {'name' => 'POINTIMPLICIT'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'UsePointImplicit','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'BetaPointImplicit','if' => '$UsePointImplicit','type' => 'real','default' => '0.5','min' => '0.5','max' => '1'},'type' => 'e','content' => []},{'type' => 't','content' => '
#POINTIMPLICIT
T		UsePointImplicit
...
'}]},{'name' => 'command','attrib' => {'name' => 'IMPLICIT'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'UsePointImplicit','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'UsePartImplicit','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'UseFullImplicit','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'CflImpl','if' => '$UsePartImplicit or $UseFullImplicit','type' => 'real','default' => '100','min' => '0'},'type' => 'e','content' => []},{'name' => 'rule','attrib' => {'expr' => '$UsePointImplicit + $UsePartImplicit + $UseFullImplicit <= 1'},'type' => 'e','content' => [{'type' => 't','content' => '
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'name' => 'command','attrib' => {'name' => 'IMPLICITCRITERIA','alias' => 'STEPPINGCRITERIA'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'TypeImplCrit','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'Time step','value' => 'dt','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Radial distance','value' => 'r/R'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Test block','value' => 'test'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'rImplicit','if' => '$TypeImplCrit eq \'R\'','type' => 'real','min' => '0'},'type' => 'e','content' => []},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'IMPLSCHEME','alias' => 'IMPLICITSCHEME'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nOrderImpl','type' => 'integer','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => '1','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => '2'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'TypeFluxImpl','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'Roe','value' => 'Roe/roe/1'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Rusanov','value' => 'Rusanov/rusanov/2/TVDLF','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Linde','value' => 'Linde/linde/3/HLLEL'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Sokolov','value' => 'Sokolov/sokolov/4/AW'},'type' => 'e','content' => []}]},{'type' => 't','content' => '
#IMPLSCHEME
1               nOrderImpl
...
'}]},{'name' => 'command','attrib' => {'name' => 'JACOBIAN'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'TypeJacobian','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'Preconditioned','value' => 'prec','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'No preconditioning','value' => 'free'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'JacobianEps','type' => 'real','default' => '$doublePrecision ? 1.e-12 : 1.e-6','min' => '0','max' => '1.e-5'},'type' => 'e','content' => []},{'type' => 't','content' => '
#JACOBIAN
...
'},{'name' => 'command','attrib' => {'name' => 'STOP','required' => '$_IsStandAlone','if' => '$_IsStandAlone'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'MaxIteration','type' => 'integer','default' => '-1','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'tSimulationMax','type' => 'real','default' => '-1','min' => '-1'},'type' => 'e','content' => []},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'SAVELOGFILE'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'DoSaveLogfile','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'if','attrib' => {'expr' => '$DoSaveLogfile'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'StringLog','type' => 'strings','min' => '1','max' => '4'},'type' => 'e','content' => [{'name' => 'part','attrib' => {'name' => 'TypeLogVar','required' => 'T','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'MHD vars. dimensional','value' => 'MHD','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Flux vars. dimensional','value' => 'FLX'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Raw vars. dimensional','value' => 'RAW'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Set vars. dimensional','value' => 'VAR'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Flux vars. scaled','value' => 'flx'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Raw vars. scaled','value' => 'raw'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Set vars. scaled','value' => 'var'},'type' => 'e','content' => []}]},{'name' => 'part','attrib' => {'name' => 'TypeTime','required' => 'F','multiple' => 'T','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'none','exclusive' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'step'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'date'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'time'},'type' => 'e','content' => []}]}]},{'name' => 'parameter','attrib' => {'name' => 'DnSaveLogfile','type' => 'integer','default' => '1','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'DtSaveLogfile','type' => 'real','default' => '-1','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'NameLogVars','if' => '$TypeLogVar =~ /var/i','length' => '100','type' => 'string'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'StringLogRadii','if' => '($TypeLogVar=~/flx/i or $NameLogVars=~/flx/i)','length' => '100','type' => 'strings','min' => '1','max' => '10'},'type' => 'e','content' => [{'name' => 'part','attrib' => {'name' => 'LogRadii','multiple' => 'T','type' => 'real','min' => '$rBody'},'type' => 'e','content' => []}]}]},{'type' => 't','content' => '
#SAVELOGFILE
...
'}]},{'name' => 'command','attrib' => {'name' => 'SATELLITE','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nSatellite','type' => 'integer','default' => '0','min' => '0'},'type' => 'e','content' => []},{'name' => 'for','attrib' => {'to' => '$nSatellite','from' => '1'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'StringSatellite','type' => 'strings','min' => '1','max' => '5'},'type' => 'e','content' => [{'name' => 'part','attrib' => {'name' => 'TypeSatelliteVar','required' => 'T','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'MHD vars. dimensional','value' => 'MHD','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'All vars. dimensional','value' => 'FUL'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Set vars. dimensional','value' => 'VAR'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'All vars. scaled','value' => 'ful'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Set vars. scaled','value' => 'var'},'type' => 'e','content' => []}]},{'name' => 'part','attrib' => {'name' => 'TypeTrajectory','required' => 'F','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'file','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'equation','value' => 'eqn'},'type' => 'e','content' => []}]},{'name' => 'part','attrib' => {'name' => 'TypeTime','required' => 'F','multiple' => 'T','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'none','exclusive' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'step'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'date'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'time'},'type' => 'e','content' => []}]}]},{'name' => 'parameter','attrib' => {'name' => 'DnOutput','type' => 'integer','default' => '1','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'DtOutput','type' => 'real','default' => '-1','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'NameTrajectoryFile','length' => '100','type' => 'string'},'type' => 'e','content' => []},{'name' => 'rule','attrib' => {'expr' => '-f $NameTrajectoryFile'},'type' => 'e','content' => [{'type' => 't','content' => '
			Trajectory file $NameTrajectoryFile must exist
		'}]},{'name' => 'parameter','attrib' => {'name' => 'NameSatelliteVars','if' => '$TypeSatelliteVar =~ /\\bvar\\b/i','length' => '100','type' => 'string'},'type' => 'e','content' => []}]},{'type' => 't','content' => '
#SATELLITE
2                       nSatellite
...
'}]},{'name' => 'command','attrib' => {'name' => 'SAVEPLOT'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nPlotFile','type' => 'integer','default' => '0','min' => '0','max' => '100'},'type' => 'e','content' => []},{'name' => 'for','attrib' => {'to' => '$nPlotFile','from' => '1'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'StringPlot','type' => 'strings','min' => '3','max' => '3'},'type' => 'e','content' => [{'name' => 'part','attrib' => {'name' => 'plotform','required' => 'T','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'TECPLOT','value' => 'tec'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'IDL','value' => 'idl'},'type' => 'e','content' => []}]},{'name' => 'part','attrib' => {'name' => 'plotarea','required' => 'T','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => '3D','value' => '3d/3d_'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'x=0'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'y=0','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'z=0'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'sph'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'los'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'lin'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'cut'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'slc','if' => '$plotform =~ /\\btec\\b/'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'dpl','if' => '$plotform =~ /\\btec\\b/'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'value' => 'blk','if' => '$plotform =~ /\\btec\\b/'},'type' => 'e','content' => []}]},{'name' => 'part','attrib' => {'name' => 'plotvar','required' => 'T','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'MHD vars. dimensional','value' => 'MHD'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'All vars. dimensional','value' => 'FUL'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Raw vars. dimensional','value' => 'RAW'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Ray tracing vars. dim.','value' => 'RAY'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Flux vars. dimensional','value' => 'FLX'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Solar vars. dimensional','value' => 'SOL'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Position vars. dimensional','value' => 'POS','if' => '$plotarea eq \'lin\''},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Select dimensional vars.','value' => 'VAR'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'All vars. scaled','value' => 'ful'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Raw vars. scaled','value' => 'raw'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Ray tracing vars. scaled','value' => 'ray'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Flux vars. scaled','value' => 'flx'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Solar vars. scaled','value' => 'sol'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Position vars. scaled','value' => 'pos','if' => '$plotarea eq \'lin\''},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Select scaled vars.','value' => 'var'},'type' => 'e','content' => []}]}]},{'name' => 'parameter','attrib' => {'name' => 'DnSavePlot','type' => 'integer','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'DtSavePlot','type' => 'real','min' => '-1'},'type' => 'e','content' => []},{'name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\bdpl|cut|slc\\b/'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'xMinCut','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'xMaxCut','type' => 'real','min' => '$xMinCut'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yMinCut','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yMaxCut','type' => 'real','min' => '$yMinCut'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zMinCut','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zMaxCut','type' => 'real','min' => '$zMinCut'},'type' => 'e','content' => []}]},{'name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\bslc\\b/'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'xPoint','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yPoint','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zPoint','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'xNormal','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yNormal','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zNormal','type' => 'real'},'type' => 'e','content' => []}]},{'name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\bblk\\b/'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'xPoint','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yPoint','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zPoint','type' => 'real'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'Radius','if' => '$plotarea =~ /\\bsph\\b/','type' => 'real','default' => '10','min' => '0'},'type' => 'e','content' => []},{'name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\blos\\b/'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'ObsPosX','type' => 'real','default' => '-215'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'ObsPosY','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'ObsPosZ','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'OffsetAngle','type' => 'real','default' => '0','min' => '-89','max' => '89'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'rSizeImage','type' => 'real','default' => '32','min' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'xOffset','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yOffset','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'rOccult','type' => 'real','default' => '2','min' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'MuLimbDarkening','type' => 'real','default' => '0.5','min' => '0','max' => '1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'nPix','type' => 'integer','default' => '200','min' => '2'},'type' => 'e','content' => []}]},{'name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\blin\\b/'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'NameLine','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'Advected B','value' => 'A'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'B','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'U'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'J'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'IsSingleLine','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'nLine','type' => 'integer','default' => '1','min' => '1','max' => '20'},'type' => 'e','content' => []},{'name' => 'for','attrib' => {'to' => '$nLine','from' => '1'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'xStartLine','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yStartLine','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'zStartLine','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'IsParallel','type' => 'logical'},'type' => 'e','content' => []}]}]},{'name' => 'parameter','attrib' => {'name' => 'DxSavePlot','if' => '($plotform=~/\\bidl\\b/ and $plotarea!~/\\b(sph|los|lin)\\b/)','type' => 'real','default' => '-1.0','min' => '-1.0'},'type' => 'e','content' => []},{'name' => 'if','attrib' => {'expr' => '$plotvar =~ /\\bvar\\b/i'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'NameVars','length' => '100','type' => 'string'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'NamePars','length' => '100','type' => 'string'},'type' => 'e','content' => []}]}]},{'type' => 't','content' => '
#SAVEPLOT
9			nPlotfile
...
! (close to the body).
'}]},{'name' => 'command','attrib' => {'name' => 'CONSERVATIVECRITERIA'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nConservCrit','type' => 'integer','default' => '1','min' => '0','max' => '3'},'type' => 'e','content' => []},{'name' => 'for','attrib' => {'to' => '$nConservCrit','from' => '1'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'TypeConservCrit','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'radius','value' => 'r/R/radius/Radius','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'parabola','value' => 'parabola/paraboloid'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'p','value' => 'p/P'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'grad P','value' => 'gradp/GradP'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'rConserv','if' => '$TypeConservCrit =~ /^r|radius$/i','type' => 'real','default' => '6','min' => '$rBody'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'xParabolaConserv','if' => '$TypeConservCrit =~ /^parabol/i','type' => 'real','default' => '6','min' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'yParabolaConserv','if' => '$TypeConservCrit =~ /^parabol/i','type' => 'real','default' => '36','min' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'pCoeffConserv','if' => '$TypeConservCrit =~ /^p$/i','type' => 'real','default' => '0.05','min' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'GradPCoeffConserv','if' => '$TypeConservCrit =~ /gradp/i','type' => 'real','default' => '0.1','min' => '0'},'type' => 'e','content' => []}]},{'type' => 't','content' => '
...
'}]},{'name' => 'command','attrib' => {'name' => 'PROLONGATION'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'nOrderProlong','type' => 'integer','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => '1','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => '2'},'type' => 'e','content' => []}]},{'name' => 'parameter','attrib' => {'name' => 'TypeProlong','if' => '$nOrderProlong==2','type' => 'string','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'left-right','value' => 'lr','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'central'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'minmod'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'left-right extrapolate','value' => 'lr2'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'central    extrapolate','value' => 'central2'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'minmod     extrapolate','value' => 'minmod2'},'type' => 'e','content' => []}]},{'type' => 't','content' => '
#PROLONGATION
...
'}]},{'name' => 'command','attrib' => {'name' => 'BORIS'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'UseBorisCorrection','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'BorisClightFactor','if' => '$UseBorisCorrection','type' => 'real','default' => '1','min' => '0','max' => '1'},'type' => 'e','content' => []},{'type' => 't','content' => '
#BORIS
...
'}]},{'name' => 'command','attrib' => {'name' => 'BORISSIMPLE'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'UseBorisSimple','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'BorisClightFactor','if' => '$UseBorisSimple','type' => 'real','default' => '1','min' => '0','max' => '1'},'type' => 'e','content' => []},{'type' => 't','content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! on the grid.
'}]},{'name' => 'command','attrib' => {'name' => 'SOLARWIND','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'SwRhoDim','type' => 'real','default' => '5','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'SwTDim','type' => 'real','default' => '181712.175','min' => '-1'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'SwUxDim','type' => 'real','default' => '-400','max' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'SwUyDim','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'SwUzDim','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'SwBxDim','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'SwByDim','type' => 'real','default' => '0'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'SwBzDim','type' => 'real','default' => '5'},'type' => 'e','content' => []},{'type' => 't','content' => '
#SOLARWIND
5.0			SwRhoDim [n/cc]
181712.175		SwTDim [K]
-400.0			SwUxDim [km/s]
...
'}]},{'name' => 'command','attrib' => {'name' => 'GRAVITY','if' => '$_IsFirstSession'},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'UseGravity','type' => 'logical','default' => 'F'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'iDirGravity','if' => '$UseGravity','type' => 'integer','input' => 'select'},'type' => 'e','content' => [{'name' => 'option','attrib' => {'name' => 'central mass','value' => '0','default' => 'T'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'X direction','value' => '1'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Y direction','value' => '2'},'type' => 'e','content' => []},{'name' => 'option','attrib' => {'name' => 'Z direction','value' => '3'},'type' => 'e','content' => []}]},{'type' => 't','content' => '
#GRAVITY
...
'}]},{'name' => 'command','attrib' => {'name' => 'HELIODIPOLE','if' => '$_NameComp ne \'GM\''},'type' => 'e','content' => [{'name' => 'parameter','attrib' => {'name' => 'HelioDipoleStrength','type' => 'real'},'type' => 'e','content' => []},{'name' => 'parameter','attrib' => {'name' => 'HelioDipoleTilt','type' => 'real','default' => '0','min' => '-90','max' => '90'},'type' => 'e','content' => []},{'type' => 't','content' => '
