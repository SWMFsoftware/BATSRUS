...
timetitle='("t=",f8.1,"s")'
\end{verbatim}
   will show the time as {\bf t=240000.0s}. Set timetitle to an empty string 
   to return to the default behaviour.
   If {\bf npict*nfile*nfunc} is greater than the number 
...
\subsection{Plotting the logfile with plotlog \label{s-getlog}}
...
{\bf mpeg\_encode} or ImageMagick's {\bf convert}. 
