...
','type' => 't'}],'type' => 'e','name' => 'command'},{'attrib' => {'name' => 'USEROTATINGBUFFER'},'content' => [{'attrib' => {'default' => 'F','type' => 'logical','name' => 'UseRotatingBufferGrid'},'content' => [],'type' => 'e','name' => 'parameter'},{'content' => '

#USEROTATINGBUFER
T		UseRotatingBufferGrid

! For UseRotatingBufferGrid=.true., the buffer grid and all vectors at it
! rotate with respect to the grid of model (for example, the buffer grid in IH
! can co-rotate with SC. 
!
! Default value is false which results in the buffer grid oriented 
! exactly as the buffer grid
