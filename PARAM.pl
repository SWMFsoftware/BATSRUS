#^CFG FILE _FALSE_
$tree = [{'type' => 'e','name' => 'commandList','attrib' => {'name' => 'BATSRUS: GM, SC and IH Components'},'content' => [{'type' => 't','content' => '

List of MH (GM, IH and SC) commands used in the PARAM.in file


'},{'type' => 'e','name' => 'set','attrib' => {'type' => 'integer','name' => 'nI','value' => '$_GridSize[0]'},'content' => []},{'type' => 'e','name' => 'set','attrib' => {'type' => 'integer','name' => 'nJ','value' => '$_GridSize[1]'},'content' => []},{'type' => 'e','name' => 'set','attrib' => {'type' => 'integer','name' => 'nK','value' => '$_GridSize[2]'},'content' => []},{'type' => 'e','name' => 'set','attrib' => {'type' => 'integer','name' => 'MaxBlock','value' => '$_GridSize[3]'},'content' => []},{'type' => 'e','name' => 'set','attrib' => {'type' => 'integer','name' => 'MaxImplBlock','value' => '$_GridSize[4]'},'content' => []},{'type' => 'e','name' => 'set','attrib' => {'type' => 'integer','name' => 'MaxBlockALL','value' => '$_nProc and $MaxBlock and $_nProc*$MaxBlock'},'content' => []},{'type' => 'e','name' => 'set','attrib' => {'type' => 'string','name' => 'NameRestartOutDir','value' => '$_NameComp/restartOUT'},'content' => []},{'type' => 'e','name' => 'set','attrib' => {'type' => 'string','name' => 'NamePlotDir','value' => '$_NameComp/IO2'},'content' => []},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'STAND ALONE MODE'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!! STAND ALONE PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

'},{'type' => 'e','name' => 'command','attrib' => {'name' => 'COMPONENT'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'NameComp'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'SC','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'IH','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'GM\'','name' => 'GM','default' => 'T'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'DESCRIPTION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'StringDescription'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'ECHO'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoEcho','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'PROGRESS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnProgressShort','min' => '-1','default' => '10'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnProgressLong','min' => '-1','default' => '100'},'content' => []},{'type' => 't','content' => '
#PROGRESS
10			DnProgressShort
100			DnProgressLong
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'TIMEACCURATE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoTimeAccurate','default' => 'T'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'BEGIN_COMP','multiple' => 'T'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'END_COMP','multiple' => 'T'},'content' => [{'type' => 't','content' => '

This command is allowed in stand alone mode only for the sake of the 
test suite, which contains these commands when the framework is tested.
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'RUN'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'END'},'content' => [{'type' => 't','content' => '
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'PLANET PARAETERS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!! PLANET PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','name' => 'PLANET'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'NamePlanet'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Earth','value' => 'EARTH/Earth/earth','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Saturn','value' => 'SATURN/Saturn/saturn'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'New'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NamePlanet eq \'New\''},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RadiusPlanet','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'MassPlanet','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'OmegaPlanet','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'TiltRotation','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeBField'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'NONE'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'DIPOLE','default' => 'T'},'content' => []}]}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$TyepBField eq \'DIPOLE\''},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '180','type' => 'real','name' => 'MagAxisThetaGeo','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'MagAxisPhiGeo','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DipoleStrength'},'content' => []}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => 'not $PlanetCommand'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'ROTATIONAXIS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'IsRotAxisPrimary','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$IsRotAxisPrimary'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '180','type' => 'real','name' => 'RotAxisTheta','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'RotAxisPhi','min' => '0'},'content' => []}]},{'type' => 'e','name' => 'set','attrib' => {'type' => 'string','name' => 'PlanetCommand','value' => 'ROTATIONAXIS'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'ROTATION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseRotation','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseRotation'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RotationPeriod'},'content' => []}]},{'type' => 'e','name' => 'set','attrib' => {'type' => 'string','name' => 'PlanetCommand','value' => 'MAGNETICAXIS'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'MAGNETICAXIS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'IsMagAxisPrimary','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$IsMagAxisPrimary'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '180','type' => 'real','name' => 'MagAxisTheta','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'MagAxisPhi','min' => '0'},'content' => []}]},{'type' => 'e','name' => 'set','attrib' => {'type' => 'string','name' => 'PlanetCommand','value' => 'MAGNETICAXIS'},'content' => []},{'type' => 't','content' => '
...
date and time given by #STARTTIME.
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'DIPOLE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DipoleStrength'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'UPDATEB0'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DtUpdateB0','min' => '-1','default' => '0.0001'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'IDEALAXES'},'content' => [{'type' => 't','content' => '
...
but much shorter.
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'USER DEFINED INPUT'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!  USER DEFINED INPUT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

'},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'USER_FLAGS','name' => 'USERFLAGS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserInnerBcs','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserSource','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserPerturbation','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserOuterBcs','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserICs','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserSpecifyRefinement','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserLogFiles','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserWritePlot','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserAMR','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserEchoInput','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserB0','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserInitSession','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUserUpdateStates','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'USERINPUTBEGIN'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'USERINPUTEND'},'content' => [{'type' => 't','content' => '
...
There is no XML based parameter checking in the user section.
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'TESTING AND TIMING'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  TESTING AND TIMING PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TEST'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'TestString'},'content' => []},{'type' => 't','content' => '
#TEST
read_inputs
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TESTIJK'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$nI+2','type' => 'integer','name' => 'iTest','min' => '-2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$nJ+2','type' => 'integer','name' => 'jTest','min' => '-2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$nK+2','type' => 'integer','name' => 'kTest','min' => '-2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$MaxBlock','type' => 'integer','name' => 'iBlockTest','min' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'iProcTest','min' => '0'},'content' => []},{'type' => 't','content' => '
#TESTIJK
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TESTXYZ'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$xMax','type' => 'real','name' => 'xTest','min' => '$xMin'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$yMax','type' => 'real','name' => 'yTest','min' => '$yMin'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$zMax','type' => 'real','name' => 'zTest','min' => '$zMin'},'content' => []},{'type' => 't','content' => '
#TESTXYZ
...
! Note that the user should set #TESTIJK or #TESTXYZ, not both.  If both
! are set, the final one in the session will set the test point.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TESTTIME'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nIterTest','min' => '-1','default' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'TimeTest','min' => '-1','default' => '1e30'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TESTVAR'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'iVarTest'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Rho','value' => '1','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'RhoUx','value' => '2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'RhoUy','value' => '3'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'RhoUz','value' => '4'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Bx','value' => '5'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'By','value' => '6'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Bz','value' => '7'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'e','value' => '8'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'p','value' => '9'},'content' => []}]},{'type' => 't','content' => '
#TESTVAR
1                       iVarTest

! Index of variable to be tested. Default is rho_="1", i.e. density.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TESTDIM'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'iVarTest'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'all','value' => '0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'x','value' => '1','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'y','value' => '2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'z','value' => '3'},'content' => []}]},{'type' => 't','content' => '
#TESTDIM
1                       iDimTest

! Index of dimension/direction to be tested. Default is X dimension.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'STRICT','multiple' => 'T'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseStrict','default' => 'T'},'content' => []},{'type' => 't','content' => '
#STRICT
T                       UseStrict

! If true then stop when parameters are incompatible. If false, try to
! correct parameters and continue. Default is true, i.e. strict mode
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'VERBOSE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'lVerbose'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'errors and warnings only','value' => '-1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'start and end of sessions','value' => '0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'normal','value' => '1','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'calls on test processor','value' => '10'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'calls on all processors','value' => '100'},'content' => []}]},{'type' => 't','content' => '
#VERBOSE
-1                      lVerbose
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'DEBUG'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoDebug','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoDebugGhost','default' => 'F'},'content' => []},{'type' => 't','content' => '
#DEBUG
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'CODEVERSION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CodeVersion','min' => '0','default' => '7.50'},'content' => []},{'type' => 't','content' => '
#CODEVERSION
7.50                    CodeVersion
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'USERMODULE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameUserModule','default' => 'EMPTY'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'VersionUserModule','min' => '0','default' => '1.0'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'EQUATION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameEquation','default' => 'MHD'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nVar','default' => '8'},'content' => []},{'type' => 't','content' => '
#EQUATION
MHD			NameEquation
8			nVar
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'PRECISION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'nByteReal'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'single precision (4)','value' => '4','default' => '$_nByteReal==4'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'double precision (8)','value' => '8','default' => '$_nByteReal==8'},'content' => []}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '$nByteReal==$_nByteReal or not $UseStrict'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'CHECKGRIDSIZE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$nI','type' => 'integer','name' => 'nI','min' => '$nI','default' => '$nI'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$nJ','type' => 'integer','name' => 'nJ','min' => '$nJ','default' => '$nJ'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$nK','type' => 'integer','name' => 'nK','min' => '$nK','default' => '$nK'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$MaxBlockALL','type' => 'integer','name' => 'MinBlockALL','min' => '1'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'BLOCKLEVELSRELOADED'},'content' => [{'type' => 't','content' => '
#BLOCKLEVELSRELOADED
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'TIMING'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseTiming','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseTiming'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'Frequency'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'none','value' => '-3'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'final only','value' => '-2','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'end of sessions','value' => '-1'},'content' => []},{'type' => 'e','name' => 'optioninput','attrib' => {'name' => 'every X steps','min' => '1','default' => '100'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nDepthTiming','min' => '-1','default' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeTimingReport'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'cumulative','value' => 'cumu','default' => '1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'list'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'tree'},'content' => []}]}]},{'type' => 't','content' => '
#TIMING
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'INITIAL AND BOUNDARY CONDITIONS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!! MAIN INITIAL AND BOUNDARY CONDITION PARAMETERS  !!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'PROBLEMTYPE','required' => 'T'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'iProblem'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Uniform','value' => '1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Shock tube','value' => '2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Heliosphere','value' => '3'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Comet','value' => '5'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Rotation','value' => '6'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Diffusion','value' => '7'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Earth','value' => '11','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Saturn','value' => '12'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Jupiter','value' => '13'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Venus','value' => '14'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Cylinder','value' => '21'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Sphere','value' => '22'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Arcade','value' => '25'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'CME','value' => '26'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Dissipation','value' => '30'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','if' => '$iProblem==30','length' => '20','name' => 'TypeDissipation'},'content' => []},{'type' => 't','content' => '
#PROBLEMTYPE
30			iProblem
...
!\\end{verbatim}
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINDIR'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameRestartInDir','default' => 'GM/restartIN'},'content' => []},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '-d $NameRestartInDir'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'RESTARTINFILE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeRestartInFile'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'block','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'one'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'NEWRESTART'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoRestartBFace','default' => 'F'},'content' => []},{'type' => 't','content' => ' 
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'OUTERBOUNDARY'},'content' => [{'type' => 'e','name' => 'foreach','attrib' => {'name' => 'Side','values' => 'TypeBcEast,TypeBcWest,TypeBcSouth,TypeBcNorth,TypeBcBot,TypeBcTop'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => '$Side'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'coupled'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'vary/inflow','default' => '$Side eq \'TypeBcEast\''},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'float/outflow','default' => '$Side ne \'TypeBcEast\''},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'heliofloat'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'reflect'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'periodic'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'fixed'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'shear'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'linetied'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'raeder'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'arcadetop'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'arcadebot'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'arcadebotcont'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'user'},'content' => []}]}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => 'not($TypeBcEast eq \'periodic\' xor $TypeBcWest eq \'periodic\')'},'content' => [{'type' => 't','content' => '
		East and west BCs must be both periodic or neither
	'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => 'not($TypeBcSouth eq \'periodic\' xor $TypeBcNorth eq \'periodic\')'},'content' => [{'type' => 't','content' => '
		South and North BCs must be both periodic or neither
	'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => 'not($TypeBcBot eq \'periodic\' xor $TypeBcTop eq \'periodic\')'},'content' => [{'type' => 't','content' => '
...
! user          - user defined
!\\end{verbatim}
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'INNERBOUNDARY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeBcInner'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'reflect'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'float'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'fixed'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ionosphere','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ionosphereB0','value' => 'ionosphereB0/ionosphereb0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ionospherefloat'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'coronatoih'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'user'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseBody2'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeBcBody2'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'reflect','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'float'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'fixed'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ionosphere'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ionosphereB0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ionospherefloat'},'content' => []}]}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => 'not($TypeBcBody2 =~ /ionosphere/)'},'content' => [{'type' => 't','content' => ' 
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'EXTRABOUNDARY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseExtraBoundary','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseExtraBoundary'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','name' => 'TypeExtraBoundary'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoFixExtraBoundary','default' => 'F'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'FACEOUTERBC'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '6','type' => 'integer','name' => 'MaxBoundary','min' => '0','default' => '0'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$MaxBoundary >= 1'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoFixOuterBoundary','default' => 'F'},'content' => []}]},{'type' => 't','content' => '
#FACEOUTERBC
0              MaxBoundary            
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'GRID GEOMETRY'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!! GRID GEOMETRY !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'GRID','required' => 'T'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nRootBlockX','min' => '1','default' => '2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nRootBlockY','min' => '1','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nRootBlockZ','min' => '1','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xMin','default' => '-192.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xMax','min' => '$xMin','default' => '  64.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yMin','default' => ' -64.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yMax','min' => '$yMin','default' => '  64.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zMin','default' => ' -64.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zMax','min' => '$zMin','default' => '  64.0'},'content' => []},{'type' => 't','content' => '
#GRID
2                       nRootBlockX
1                       nRootBlockY
1                       nRootBlockZ
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'COORDINATESYSTEM','name' => 'COORDSYSTEM','multiple' => 'T'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeCoordSystem'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'GM\'','name' => 'GSM','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'HGI','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'IH\'','name' => 'HGC'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'HGR','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$_NameComp eq \'SC\'','name' => 'HGI'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession and $_IsStandAlone','name' => 'VERTEXBASEDGRID'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseVertexBasedGrid','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'INITIAL TIME'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!! INITIAL TIME AND STEP !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'SETREALTIME','if' => '$_IsFirstSession','name' => 'STARTTIME'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'iYear','default' => '2000'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '12','type' => 'integer','name' => 'iMonth','min' => '1','default' => '3'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '31','type' => 'integer','name' => 'iDay','min' => '1','default' => '21'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '23','type' => 'integer','name' => 'iHour','min' => '0','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '59','type' => 'integer','name' => 'iMinute','min' => '0','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '59','type' => 'integer','name' => 'iSecond','min' => '0','default' => '0'},'content' => []},{'type' => 't','content' => '
#STARTTIME
2000                    iYear
3                       iMonth
21                      iDay
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'TIMESIMULATION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'tSimulation','min' => '0','default' => '0.0'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'NSTEP'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nStep','min' => '0','default' => '0'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'NPREVIOUS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nPrevious','min' => '-1','default' => '-1'},'content' => []},{'type' => 't','content' => '
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'TIME INTEGRATION'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  TIME INTEGRATION PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TIMESTEPPING'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'nStage'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'value' => '1','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '2'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'CflExpl','min' => '0','default' => '0.8'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'FIXEDTIMESTEP'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseDtFixed','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$UseDtFixed','name' => 'DtFixedDim','min' => '0','default' => '1.0'},'content' => []},{'type' => 't','content' => '
#FIXEDTIMESTEP
T                       UseDtFixed
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'PARTSTEADY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UsePartSteady','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'STEADYCRITERIA','name' => 'PARTSTEADYCRITERIA'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MinCheckVar','min' => '1','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MaxCheckVar','min' => '$MinCheckVar','default' => '8'},'content' => []},{'type' => 'e','name' => 'for','attrib' => {'to' => '$MaxCheckVar','from' => '$MinCheckVar'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'RelativeEps','min' => '0','default' => '0.001'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'AbsoluteEps','min' => '0','default' => '0.0001'},'content' => []}]},{'type' => 't','content' => '
#PARTSTEADYCRITERIA
5               MinCheckVar
8               MaxCheckVar
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'POINTIMPLICIT'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UsePointImplicit','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','if' => '$UsePointImplicit','name' => 'BetaPointImplicit','min' => '0.5','default' => '0.5'},'content' => []},{'type' => 't','content' => '
#POINTIMPLICIT
T		UsePointImplicit
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'PARTLOCAL'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UsePartLocal','default' => 'F'},'content' => []},{'type' => 't','content' => '
#PARTLOCAL
T               UsePartLocal
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'IMPLICIT'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UsePointImplicit','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UsePartImplicit','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseFullImplicit','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$UsePartImplicit or $UseFullImplicit','name' => 'CflImpl','min' => '0','default' => '100'},'content' => []},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '$UsePointImplicit + $UsePartImplicit + $UseFullImplicit <= 1'},'content' => [{'type' => 't','content' => '
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'IMPLICIT PARAMETERS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!! PARAMETERS FOR FULL AND PART IMPLICIT TIME INTEGRATION !!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'STEPPINGCRITERIA','name' => 'IMPLICITCRITERIA'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeImplCrit'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Time step','value' => 'dt','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Radial distance','value' => 'r/R'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Test block','value' => 'test'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$TypeImplCrit eq \'R\'','name' => 'rImplicit','min' => '0'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'PARTIMPLICIT','name' => 'PARTIMPL'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UsePartImplicit2','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
backward compatible.
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'IMPLICITSTEP','name' => 'IMPLSTEP'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'ImplCoeff','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseBdf2','default' => 'T'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseSourceImpl','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'IMPLICITSCHEME','name' => 'IMPLSCHEME'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'nOrderImpl'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => '1','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => '2'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeFluxImpl'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Roe','value' => 'Roe/roe/1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Rusanov','value' => 'Rusanov/rusanov/2/TVDLF','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Linde','value' => 'Linde/linde/3/HLLEL'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Sokolov','value' => 'Sokolov/sokolov/4/AW'},'content' => []}]},{'type' => 't','content' => '
#IMPLSCHEME
1               nOrderImpl
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'IMPLICITCHECK','name' => 'IMPLCHECK'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '0.9','type' => 'real','name' => 'RejectStepLevel','min' => '0','default' => '0.3'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '0.9','type' => 'real','name' => 'RejectStepFactor','min' => '0','default' => '0.5'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '0.9','type' => 'real','name' => 'ReduceStepLevel','min' => '0','default' => '0.6'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'ReduceStepFactor','min' => '0','default' => '0.9'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'IncreaseStepLevel','min' => '0','default' => '0.8'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '2','type' => 'real','name' => 'IncreaseStepFactor','min' => '1','default' => '1.05'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'NEWTON'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseConservativeImplicit','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseNewton','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseNewton'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseNewMatrix','default' => 'T'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MaxIterNewton','min' => '1','default' => '10'},'content' => []}]},{'type' => 't','content' => '
#NEWTON
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'JACOBIAN'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeJacobian'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Preconditioned','value' => 'prec','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'No preconditioning','value' => 'free'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1.e-5','type' => 'real','name' => 'JacobianEps','min' => '0','default' => '$doublePrecision ? 1.e-12 : 1.e-6'},'content' => []},{'type' => 't','content' => '
#JACOBIAN
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'PRECONDITIONER'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypePrecondSide'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'left'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'symmetric','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'right'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypePrecond'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'MBILU','default' => 'T'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'GustafssonPar','min' => '0','default' => '0.5'},'content' => []},{'type' => 't','content' => '
#PRECONDITIONER
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'KRYLOV'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeKrylov'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'gmres','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'bicgstab'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeInitKrylov'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => '0','value' => 'nul','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'previous','value' => 'old'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'explicit'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'scaled explicit','value' => 'explicit'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '0.1','type' => 'real','name' => 'ErrorMaxKrylov','min' => '0','default' => '0.001'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MaxMatvecKrylov','min' => '1','default' => '100'},'content' => []},{'type' => 't','content' => '
#KRYLOV
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'KRYLOVSIZE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nKrylovVector','min' => '1','default' => 'MaxMatvecKrylov'},'content' => []},{'type' => 't','content' => '
#KRYLOVSIZE
10		nKrylovVector
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'STOPPING CRITERIA'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!! STOPPING CRITERIA !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'STOP','required' => '$_IsStandAlone'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MaxIteration','min' => '-1','default' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'tSimulationMax','min' => '-1','default' => '-1'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'CHECKSTOPFILE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoCheckStopFile','default' => 'T'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsStandAlone','name' => 'CPUTIMEMAX'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CpuTimeMax','min' => '-1','default' => '-1'},'content' => []},{'type' => 't','content' => '
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'OUTPUT PARAMETERS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  OUTPUT PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'name' => 'RESTARTOUTDIR'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameRestartOutDir','default' => 'GM/restartOUT'},'content' => []},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '-d $NameRestartOutDir'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'RESTARTOUTFILE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeRestartOutFile'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'block'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'one','default' => 'T'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'SAVERESTART'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoSaveRestart','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$DoSaveRestart'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnSaveRestart','min' => '-1','default' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DtSaveRestart','min' => '-1','default' => '-1'},'content' => []}]},{'type' => 't','content' => '
#SAVERESTART
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'PLOTDIR'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NamePlotDir','default' => 'GM/IO2'},'content' => []},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '-d $NamePlotDir'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'SAVELOGFILE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoSaveLogfile','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$DoSaveLogfile'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '4','type' => 'strings','name' => 'StringLog','min' => '1'},'content' => [{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeLogVar','required' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'MHD vars. dimensional','value' => 'MHD','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Flux vars. dimensional','value' => 'FLX'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Raw vars. dimensional','value' => 'RAW'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Set vars. dimensional','value' => 'VAR'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Flux vars. scaled','value' => 'flx'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Raw vars. scaled','value' => 'raw'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Set vars. scaled','value' => 'var'},'content' => []}]},{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeTime','required' => 'F','multiple' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'exclusive' => 'T','name' => 'none'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'step'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'date'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'time'},'content' => []}]}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnSaveLogfile','min' => '-1','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DtSaveLogfile','min' => '-1','default' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','if' => '$TypeLogVar =~ /var/i','length' => '100','name' => 'NameLogVars'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '10','type' => 'strings','if' => '($TypeLogVar=~/flx/i or $NameLogVars=~/flx/i)','length' => '100','name' => 'StringLogRadii','min' => '1'},'content' => [{'type' => 'e','name' => 'part','attrib' => {'type' => 'real','name' => 'LogRadii','min' => '$rBody','multiple' => 'T'},'content' => []}]}]},{'type' => 't','content' => '
#SAVELOGFILE
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'SATELLITE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nSatellite','min' => '0','default' => '0'},'content' => []},{'type' => 'e','name' => 'for','attrib' => {'to' => '$nSatellite','from' => '1'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '5','type' => 'strings','name' => 'StringSatellite','min' => '1'},'content' => [{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeSatelliteVar','required' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'MHD vars. dimensional','value' => 'MHD','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'All vars. dimensional','value' => 'FUL'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Set vars. dimensional','value' => 'VAR'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'All vars. scaled','value' => 'ful'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Set vars. scaled','value' => 'var'},'content' => []}]},{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeTrajectory','required' => 'F'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'file','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'equation','value' => 'eqn'},'content' => []}]},{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeTime','required' => 'F','multiple' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'exclusive' => 'T','name' => 'none'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'step'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'date'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'time'},'content' => []}]}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnOutput','min' => '-1','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DtOutput','min' => '-1','default' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameTrajectoryFile'},'content' => []},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '-f $NameTrajectoryFile'},'content' => [{'type' => 't','content' => '
			Trajectory file $NameTrajectoryFile must exist
		'}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','if' => '$TypeSatelliteVar =~ /\\bvar\\b/i','length' => '100','name' => 'NameSatelliteVars'},'content' => []}]},{'type' => 't','content' => '
#SATELLITE
2                       nSatellite
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'SAVEPLOT'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '100','type' => 'integer','name' => 'nPlotFile','min' => '0','default' => '0'},'content' => []},{'type' => 'e','name' => 'for','attrib' => {'to' => '$nPlotFile','from' => '1'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '3','type' => 'strings','name' => 'StringPlot','min' => '3'},'content' => [{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'plotform','required' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'TECPLOT','value' => 'tec'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'IDL','value' => 'idl'},'content' => []}]},{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'plotarea','required' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => '3D','value' => '3d/3d_'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => 'x=0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => 'y=0','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => 'z=0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => 'sph'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => 'los'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => 'lin'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => 'cut'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'slc'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'dpl'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$plotform =~ /\\btec\\b/','value' => 'blk'},'content' => []}]},{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'plotvar','required' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'MHD vars. dimensional','value' => 'MHD'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'All vars. dimensional','value' => 'FUL'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Raw vars. dimensional','value' => 'RAW'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Ray tracing vars. dim.','value' => 'RAY'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Flux vars. dimensional','value' => 'FLX'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Solar vars. dimensional','value' => 'SOL'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$plotarea eq \'lin\'','name' => 'Position vars. dimensional','value' => 'POS'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Select dimensional vars.','value' => 'VAR'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'MHD vars. scaled','value' => 'mhd'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'All vars. scaled','value' => 'ful'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Raw vars. scaled','value' => 'raw'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Ray tracing vars. scaled','value' => 'ray'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Flux vars. scaled','value' => 'flx'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Solar vars. scaled','value' => 'sol'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'if' => '$plotarea eq \'lin\'','name' => 'Position vars. scaled','value' => 'pos'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Select scaled vars.','value' => 'var'},'content' => []}]}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnSavePlot','min' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DtSavePlot','min' => '-1'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\bdpl|cut|slc\\b/'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xMinCut'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xMaxCut','min' => '$xMinCut'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yMinCut'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yMaxCut','min' => '$yMinCut'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zMinCut'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zMaxCut','min' => '$zMinCut'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\bslc\\b/'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xPoint'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yPoint'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zPoint'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xNormal'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yNormal'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zNormal'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\bblk\\b/'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xPoint'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yPoint'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zPoint'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$plotarea =~ /\\bsph\\b/','name' => 'Radius','min' => '0','default' => '10'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\blos\\b/'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ObsPosX','default' => '-215'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ObsPosY','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ObsPosZ','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '89','type' => 'real','name' => 'OffsetAngle','min' => '-89','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rSizeImage','min' => '0','default' => '32'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xOffset','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yOffset','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rOccult','min' => '0','default' => '2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'MuLimbDarkening','min' => '0','default' => '0.5'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nPix','min' => '2','default' => '200'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$plotarea =~ /\\blin\\b/'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'NameLine'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Advected B','value' => 'A'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'B','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'U'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'J'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'IsSingleLine','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '20','type' => 'integer','name' => 'nLine','min' => '1','default' => '1'},'content' => []},{'type' => 'e','name' => 'for','attrib' => {'to' => '$nLine','from' => '1'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xStartLine'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yStartLine'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zStartLine'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'IsParallel'},'content' => []}]}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '($plotform=~/\\bidl\\b/ and $plotarea!~/\\b(sph|los|lin)\\b/)','name' => 'DxSavePlot','min' => '-1.0','default' => '-1.0'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$plotvar =~ /\\bvar\\b/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameVars'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NamePars'},'content' => []}]}]},{'type' => 't','content' => '
#SAVEPLOT
9			nPlotfile
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'SAVEBINARY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoSaveBinary','default' => 'T'},'content' => []},{'type' => 't','content' => '
#SAVEBINARY
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'SAVEPLOTSAMR'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoSavePlotsAmr','default' => 'F'},'content' => []},{'type' => 't','content' => '
#SAVEPLOTSAMR
F			DoSavePlotsAmr

! Save plots before each AMR. Default is DoSavePlotsAMR=.false.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'FLUSH'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoFlush','default' => 'T'},'content' => []},{'type' => 't','content' => '
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'AMR PARAMETERS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  AMR PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'AMRINIT'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'InitialRefineType'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'default','default' => '1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'all'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'none'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => '3Dbodyfocus'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'spherefocus'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'magnetosphere'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'points'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'coupledhelio'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'helio_init'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'helio_z=4'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'all_then_focus'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'cme'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'points'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'mag_new'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'magnetosphere'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'magneto_fine'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'magneto12'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'magnetosaturn'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'magnetojupiter'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'paleo'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'comet'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'InitialRefineLevel','min' => '0','default' => '4'},'content' => []},{'type' => 't','content' => '
#AMRINIT
...
!\\end{verbatim}
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'AMRINITPHYSICS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nRefineLevelIC','min' => '0','default' => '0'},'content' => []},{'type' => 't','content' => '
#AMRINITPHYSICS
3			nRefineLevelIC
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'GRIDLEVEL','name' => 'GRIDRESOLUTION','multiple' => 'T'},'content' => [{'type' => 'e','name' => 'set','attrib' => {'name' => 'RotateArea','value' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$_command =~ /RESOLUTION/','name' => 'Resolution','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','if' => '$_command =~ /LEVEL/','name' => 'nLevel','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '2','type' => 'strings','name' => 'StringArea','min' => '1'},'content' => [{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'NameArea','required' => 'T'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'initial','value' => 'init/initial','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'all'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'box'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'brick'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'brick0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'sphere'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'sphere0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'shell'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'shell0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'cylinderx'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'cylinderx0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'cylindery'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'cylindery0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'cylinderz'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'cylinderz0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ringx'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ringx0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ringy'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ringy0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ringz'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'ringz0'},'content' => []}]},{'type' => 'e','name' => 'part','attrib' => {'input' => 'select','type' => 'string','name' => 'RotateArea','required' => 'F'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'rotated'},'content' => []}]}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameArea !~ /box|all|init|0/'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xCenter','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yCenter','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zCenter','default' => '0'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameArea =~ /box/'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xMinBox'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yMinBox'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zMinBox'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xMaxBox'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yMaxBox'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zMaxBox'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameArea =~ /brick/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xSizeBrick','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ySizeBrick','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zSizeBrick','min' => '0'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameArea =~ /sphere/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Radius','min' => '0'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameArea =~ /shell/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Radius1','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Radius2','min' => '0'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameArea =~ /cylinder/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'LengthCylinder','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Radius','min' => '0'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameArea =~ /ring/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'HeightRing','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Radius1','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Radius2','min' => '0'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$RotateArea =~ /rotated/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'xRotate','min' => '-360','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'yRotate','min' => '-360','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'zRotate','min' => '-360','default' => '0'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'AMRLEVELS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MinBlockLevel','min' => '-1','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MaxBlockLevel','min' => '-1','default' => '99'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoFixBodyLevel','default' => 'F'},'content' => []},{'type' => 't','content' => '
#AMRLEVELS
0			MinBlockLevel
99			MaxBlockLevel
F			DoFixBodyLevel
...
! for AMR.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'AMRRESOLUTION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DxCellMin','min' => '-1','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DxCellMax','min' => '-1','default' => '99999'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoFixBodyLevel','default' => 'F'},'content' => []},{'type' => 't','content' => '
#AMRRESOLUTION
0.			DxCellMin
99999.			DxCellMax
F			DoFixBodyLevel
...
! both.  If both are set, the final one in the session will set the values
! for AMR.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'AMR'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnRefine','min' => '-1','default' => '-1'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$DnRefine>0'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoAutoRefine','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$DoAutoRefine'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '100','type' => 'real','name' => 'PercentCoarsen','min' => '0','default' => '20'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '100','type' => 'real','name' => 'PercentRefine','min' => '0','default' => '20'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MaxTotalBlocks','min' => '1','default' => '99999'},'content' => []}]}]},{'type' => 't','content' => '
#AMR
2001			DnRefine
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'AMRCRITERIA'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'nRefineCrit'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => '0'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => '1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => '2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => '3','default' => 'T'},'content' => []}]},{'type' => 'e','name' => 'for','attrib' => {'to' => '$nRefineCrit','from' => '1'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeRefine'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'grad T','value' => 'gradt/gradT'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'grad P','value' => 'gradp/gradP'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'grad log(Rho)','value' => 'gradlogrho'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'grad log(p)','value' => 'gradlogP/gradlogp'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'grad E','value' => 'gradE'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'curl U','value' => 'curlV/curlv/curlU/curlu'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'curl B','value' => 'curlB/curlb'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'div U','value' => 'divU/divu/divV/divv'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'divB','value' => 'divb/divB'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'vAlfven','value' => 'Valfven/vAlfven/valfven'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'heliospheric beta','value' => 'heliobeta'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'flux'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'heliospheric current sheet','value' => 'heliocurrentsheet'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'rCurrents','value' => 'rcurrents/Rcurrents'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Transient','value' => 'transient/Transient'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$TypeRefine =~ /transient/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeTransient'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'P_dot','value' => 'p_dot/P_dot'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'T_dot','value' => 't_dot/T_dot'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Rho_dot','value' => 'rho_dot/Rho_dot','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'RhoU_dot','value' => 'RhoU_dot/rhou_dot'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Rho_2nd_1','value' => 'Rho_2nd_1/rho_2nd_1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Rho_2nd_2','value' => 'Rho_2nd_2/rho_2nd_2'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseSunEarth','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseSunEarth'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'xEarth'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yEarth'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'zEarth'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'InvD2Ray'},'content' => []}]}]}]},{'type' => 't','content' => '
#AMRCRITERIA
...
\\end{verbatim}
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'SCHEME PARAMETERS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  SCHEME PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'name' => 'SCHEME'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'nOrder'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => '1','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => '2'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeFlux'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Roe','value' => 'Roe/roe/1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Rusanov','value' => 'Rusanov/rusanov/2/TVDLF','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Linde','value' => 'Linde/linde/3/HLLEL'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Sokolov','value' => 'Sokolov/sokolov/4/AW'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$nOrder == 2'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeLimiter'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'minmod','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'mc'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'mc3'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'beta'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '2','type' => 'real','if' => '$TypeLimiter ne \'minmod\'','name' => 'LimiterBeta','min' => '1','default' => '1.2'},'content' => []}]},{'type' => 't','content' => '
#SCHEME
2			nOrder (1 or 2)
Rusanov			TypeFlux
...
\\end{verbatim}
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'NONCONSERVATIVE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseNonConservative','default' => 'T'},'content' => []},{'type' => 't','content' => '
#NONCONSERVATIVE
T		UseNonConservative

! For Earth the default is using non-conservative equations 
! (close to the body).
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'CONSERVATIVECRITERIA'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '3','type' => 'integer','name' => 'nConservCrit','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'for','attrib' => {'to' => '$nConservCrit','from' => '1'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeConservCrit'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'radius','value' => 'r/R/radius/Radius','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'parabola','value' => 'parabola/paraboloid'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'p','value' => 'p/P'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'grad P','value' => 'gradp/GradP'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$TypeConservCrit =~ /^r|radius$/i','name' => 'rConserv','min' => '$rBody','default' => '6'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$TypeConservCrit =~ /^parabol/i','name' => 'xParabolaConserv','min' => '0','default' => '6'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$TypeConservCrit =~ /^parabol/i','name' => 'yParabolaConserv','min' => '0','default' => '36'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$TypeConservCrit =~ /^p$/i','name' => 'pCoeffConserv','min' => '0','default' => '0.05'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','if' => '$TypeConservCrit =~ /gradp/i','name' => 'GradPCoeffConserv','min' => '0','default' => '0.1'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'UPDATECHECK'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseUpdateCheck','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseUpdateCheck'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '100','type' => 'real','name' => 'RhoMinPercent','min' => '0','default' => '40'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RhoMaxPercent','min' => '100','default' => '400'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '100','type' => 'real','name' => 'pMinPercent','min' => '0','default' => '40'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'pMaxPercent','min' => '100','default' => '400'},'content' => []}]},{'type' => 't','content' => '
#UPDATECHECK
T			UseUpdateCheck
40.			RhoMinPercent
400.			RhoMaxPercent
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'PROLONGATION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','name' => 'nOrderProlong'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => '1','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => '2'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','if' => '$nOrderProlong==2','name' => 'TypeProlong'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'left-right','value' => 'lr','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'central'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'minmod'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'left-right extrapolate','value' => 'lr2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'central    extrapolate','value' => 'central2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'minmod     extrapolate','value' => 'minmod2'},'content' => []}]},{'type' => 't','content' => '
#PROLONGATION
...
!\\end{verbatim}
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'OPTIMIZE','name' => 'MESSAGEPASS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeMessagePass'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'm_p_cell FACES ONLY','value' => 'allopt','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'm_p_cell','value' => 'all'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'm_p_dir FACES ONLY','value' => 'opt'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'm_p_dir group by directions','value' => 'dir'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'm_p_dir group by faces     ','value' => 'face'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'm_p_dir group by kind and face','value' => 'min'},'content' => []}]},{'type' => 't','content' => '
#MESSAGEPASS
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'RESOLUTIONCHANGE','name' => 'RESCHANGE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseAccurateReschange','default' => 'F'},'content' => []},{'type' => 't','content' => '
#RESCHANGE
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'TVDRESCHANGE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseTvdReschange','default' => 'F'},'content' => []},{'type' => 't','content' => '
#TVDRESCHANGE
T		UseTvdResChange
...
! Default value is false, which results in first order 
! prolongation and restriction operators at the resolution changes.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'BORIS'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseBorisCorrection','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','if' => '$UseBorisCorrection','name' => 'BorisClightFactor','min' => '0','default' => '1'},'content' => []},{'type' => 't','content' => '
#BORIS
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'BORISSIMPLE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseBorisSimple','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','if' => '$UseBorisSimple','name' => 'BorisClightFactor','min' => '0','default' => '1'},'content' => []},{'type' => 't','content' => '
#BORISSIMPLE
T			UseBorisSimple
...
! You can use either Boris or BorisSimple but not both. 
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'DIVB'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseDivbSource','default' => 'T'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseDivbDiffusion','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseProjection','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseConstrainB','default' => 'F'},'content' => []},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '$UseDivbSource or $UseDivbDiffusion or $UseProjection or $UseConstrainB'},'content' => [{'type' => 't','content' => '
		At least one of the options should be true.
	'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => 'not($UseProjection and ($UseDivbSource or $UseDivbDiffusion or $UseConstrainB))'},'content' => [{'type' => 't','content' => '
		If UseProjection is true, all others should be false.
	'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => 'not($UseConstrainB and ($UseDivbSource or $UseDivbDiffusion or $UseProjection))'},'content' => [{'type' => 't','content' => '
...
! If UseConstrainB is true, all others should be false.
! At least one of the options should be true.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'DIVBSOURCE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseB0Source','default' => 'T'},'content' => []},{'type' => 't','content' => '
#DIVBSOURCE
T			UseB0Source

! Add extra source terms related to the non-zero divergence and curl of B0.
! Default is true.
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'PROJECTION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectIter'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Conjugate Gradients','value' => 'cg','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'BiCGSTAB','value' => 'bicgstab'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeProjectStop'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Relative norm','value' => 'rel','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Maximum error','value' => 'max'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'RelativeLimit','min' => '0','default' => '0.1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'AbsoluteLimit','min' => '0','default' => '0.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'MaxMatvec','min' => '1','default' => '50'},'content' => []},{'type' => 't','content' => '
#PROJECTION
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'CORRECTP'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'pRatioLow','min' => '0','default' => '0.01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'pRatioHigh','min' => '$pRatioLow','default' => '0.1'},'content' => []},{'type' => 't','content' => '
#CORRECTP
0.01			pRatioLow
0.1			pRatioHigh
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'RAYTRACE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseAccurateIntegral','default' => 'T'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseAccurateTrace','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '60','type' => 'real','name' => 'DtExchangeRay','min' => '0.01','default' => '0.1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'DnRaytrace','min' => '1','default' => '1'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'IM'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'TauCoupleIm','min' => '1'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'IMCOUPLING'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'TauCoupleIm','min' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoCoupleImPressure','default' => 'T'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoCoupleImDensity','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
tested.
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'PHYSICS PARAMETERS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!  PHYSICS PARAMETERS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'GAMMA'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Gamma','min' => '1','default' => '1.6666666667'},'content' => []},{'type' => 't','content' => '
#GAMMA
1.6666666667		Gamma
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'PLASMA'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'AverageIonMass','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'AverageIonCharge','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ElectronTemperatureRatio','min' => '0','default' => '0'},'content' => []},{'type' => 't','content' => '
#PLASMA
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'SHOCKTUBE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RhoLeft','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'UnLeft','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Ut1Left','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Ut2Left','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BnLeft','default' => '0.75'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Bt1Left','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Bt2Left','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'pRight','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RhoRight','min' => '0','default' => '0.125'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'UnRight','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Ut1Right','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Ut2Right','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BnRight','default' => '0.75'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Bt1Right','default' => '-1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Bt2Right','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'pRight','min' => '0','default' => '0.1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'real','name' => 'ShockSlope'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'no rotation','value' => '0','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '0.25'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '0.3333333333333'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '0.5'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '3'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'value' => '4'},'content' => []}]},{'type' => 't','content' => '
#SHOCKTUBE
1.		rho (left state)
0.		Ux (Un)
0.		Uy (Ut1)
...
! on the grid.
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'SOLARWIND'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SwRhoDim','min' => '-1','default' => '5'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SwTDim','min' => '-1','default' => '181712.175'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '0','type' => 'real','name' => 'SwUxDim','default' => '-400'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SwUyDim','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SwUzDim','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SwBxDim','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SwByDim','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SwBzDim','default' => '5'},'content' => []},{'type' => 't','content' => '
#SOLARWIND
5.0			SwRhoDim [n/cc]
181712.175		SwTDim [K]
-400.0			SwUxDim [km/s]
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'UPSTREAM_INPUT_FILE','name' => 'SOLARWINDFILE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseSolarWindFile','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseSolarWindFile'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameSolarWindFile'},'content' => []}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '-f $NameSolarWindFile'},'content' => [{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'alias' => 'MAGNETOSPHERE','if' => '$_IsFirstSession','name' => 'BODY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseBody','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseBody'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rBody','min' => '0','default' => '3'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$_NameComp eq \'GM\''},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rCurrents','min' => '-1','default' => '4'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BodyRhoDim','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BodyTDim','min' => '0','default' => '10000'},'content' => []}]}]},{'type' => 't','content' => '
#BODY
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'GRAVITY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseGravity','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'integer','if' => '$UseGravity','name' => 'iDirGravity'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'central mass','value' => '0','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'X direction','value' => '1'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Y direction','value' => '2'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'Z direction','value' => '3'},'content' => []}]},{'type' => 't','content' => '
#GRAVITY
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'HALLRESISTIVITY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseHallResist','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseHallResist'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'HallFactor','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'HallCmaxFactor','min' => '0','default' => '1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '1','type' => 'real','name' => 'HallHyperFactor','min' => '0','default' => '0'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'HALLREGION'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'NameHallRegion'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'all','default' => 'T'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'shell'},'content' => []}]},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$NameHallRegion eq \'shell\''},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'R1Hall','min' => '0','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'R2Hall','min' => '$R1Hall','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'HallWidth','min' => '0','default' => '0'},'content' => []}]},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'MASSLOADING'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseMassLoading','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoAccelerateMassLoading','default' => 'F'},'content' => []},{'type' => 't','content' => '
#MASSLOADING
F			UseMassLoading
F			DoAccelerateMassLoading
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'HEATFLUX'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseHeatFlux','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseSpitzerForm','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => 'not $UseSpitzerForm'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Kappa0Heat','default' => '1.23E-11'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Kappa0Heat','default' => '2.5'},'content' => []}]},{'type' => 't','content' => '
#HEATFLUX
T		UseHeatFlux
F		UseSpitzerForm
1.23E-11	Kappa0Heat [W/m/K]	! Only if not UseSpitzerForm
2.50E+00	ExponentHeat [-]	! Only if not UseSpitzerForm
'}]},{'type' => 'e','name' => 'command','attrib' => {'name' => 'RESISTIVEFLUX'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseResistFlux','default' => 'F'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseSpitzerForm','default' => 'T'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => 'not $UseSpitzerForm'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeResist'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'localized','value' => 'Localized/localized'},'content' => []},{'type' => 'e','name' => 'option','attrib' => {'name' => 'constant','value' => 'Constant/constant','default' => 'T'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Eta0Resist','default' => '9.69953E+8'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$TypeResist =~ /localized/i'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Alpha0Resist','default' => '150'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yShiftResist','default' => '0.5'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'TimeInitRise','default' => '0.05'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'TimeConstLev','default' => '1'},'content' => []}]}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseAnomResist','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseAnomResist'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Eta0AnomResist','default' => '1.93991E+09'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'EtaAnomMaxResist','default' => '1.93991E+10'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'jCritResist','min' => '0','default' => '1.0E-9'},'content' => []}]},{'type' => 't','content' => '
#RESISTIVEFLUX
T		UseResistFlux
F		UseSpitzerForm
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'TESTDISSMHD'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseDefaultUnits','default' => 'T'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Grav0Diss','default' => '2.635620E-02'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Beta0Diss','default' => '1.640000E-01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Length0Diss','default' => '1.500000E+06'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Time0Diss','default' => '1.159850E+01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Rho0Diss','default' => '5.019000E-11'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Tem0Diss','default' => '1.000000E+05'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Theta0Diss','default' => '6.000000E-01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Delta0Diss','default' => '2.500000E+01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'EpsilonDiss','default' => '7.000000E+00'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RhoDifDiss','default' => '4.500000E+00'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'yShiftDiss','default' => '4.000000E-01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ScaleHeightDiss','default' => '5.000000E-01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ScaleFactorDiss','default' => '1.159850E+01'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BZ0iss','default' => '5.000000E-01'},'content' => []},{'type' => 't','content' => '
#TESTDISSMHD
F                       UseDefaultUnits
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'SECONDBODY'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'UseBody2','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$UseBody2'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rBody2','min' => '0','default' => '0.1'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$xMax','type' => 'real','name' => 'xBody2','min' => '$xMin','default' => '-40'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$yMax','type' => 'real','name' => 'yBody2','min' => '$yMin','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '$zMax','type' => 'real','name' => 'zBody2','min' => '$zMin','default' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rCurrents2','min' => '$rBody2','default' => '1.3*$rBody2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RhoDimBody2','min' => '0','default' => '5'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'tDimBody2','min' => '0','default' => '25000'},'content' => []}]},{'type' => 't','content' => '
...
! a second body.
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'DIPOLEBODY2'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BdpDimBody2x'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BdpDimBody2y'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BdpDimBody2z'},'content' => []},{'type' => 't','content' => '
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'SOLAR PROBLEM TYPES'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!! SOLAR PROBLEM TYPES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'HELIOSPHERE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BodyTDim','min' => '0','default' => '2.85E06'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'BodyRhoDim','min' => '0','default' => '1.50E8'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'qSun','min' => '0','default' => '25.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'tHeat','min' => '0','default' => '1.75'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rHeat','min' => '0','default' => '1.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'SigmaHeat','min' => '0','default' => '4.5'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoInitRope','default' => 'F'},'content' => []},{'type' => 'e','name' => 'if','attrib' => {'expr' => '$DoInitRope'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeA','min' => '0','default' => '0.7'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeR1','min' => '0','default' => '1.2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeR0','min' => '0','default' => '1.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeA1','default' => '0.23'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeAlpha','default' => '0.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeRho1','min' => '0','default' => '2.5E-12'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeRho2','min' => '0','default' => '2.0E-13'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '10','type' => 'real','name' => 'ModulationRho','min' => '0','default' => '0.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '10','type' => 'real','name' => 'ModulationP','min' => '0','default' => '0.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'OrientationGL98','min' => '-360','default' => '0.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '90','type' => 'real','name' => 'LatitudeGL98','min' => '-90','default' => '0.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '360','type' => 'real','name' => 'LongitudeGL98','min' => '-360','default' => '0.0'},'content' => []}]},{'type' => 't','content' => '
...
(clock-wise).
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOUPDATEB0'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'DtUpdateB0','min' => '-1','default' => '0.0001'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIODIPOLE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'HelioDipoleStrength'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'max' => '90','type' => 'real','name' => 'HelioDipoleTilt','min' => '-90','default' => '0'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_NameComp ne \'GM\'','name' => 'HELIOTEST'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'logical','name' => 'DoSendMHD','default' => 'F'},'content' => []},{'type' => 't','content' => '
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession and $_NameComp eq \'IH\'','name' => 'HELIOBUFFERGRID'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rBuffMin','min' => '1','default' => '19'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'rBuffMax','min' => '1','default' => '21'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nThetaBuff','min' => '18','default' => '45'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'integer','name' => 'nPhiBuff','min' => '36','default' => '90'},'content' => []},{'type' => 't','content' => '
#HELIOBUFFERGRID
19.0		rBuffMin
21.0		rBuffMax
45		nThetaBuff
...
Default values are shown above.
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'CME'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'input' => 'select','type' => 'string','name' => 'TypeCme'},'content' => [{'type' => 'e','name' => 'option','attrib' => {'name' => 'Low','default' => 'T'},'content' => []}]},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeA','min' => '0','default' => '0.7'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeR1','min' => '0','default' => '1.2'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeR0','min' => '0','default' => '1.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeA1','default' => '0.23'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeAlpha','default' => '0.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeRho1','min' => '0','default' => '2.5E-12'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeRho2','min' => '0','default' => '2.0E-13'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeB1Dim','default' => '1.0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'CmeUErupt','min' => '0','default' => '4.0E5'},'content' => []},{'type' => 't','content' => '
#CME
...
'}]},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession and $_NameComp ne \'GM\'','name' => 'ARCADE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'tArcDim','min' => '0','default' => '1.0E6'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'RhoArcDim','min' => '0','default' => '1.0E-12'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'bArcDim','min' => '0','default' => '0.718144'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ByArcDim','default' => '1.0E6'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'UzArcDim','default' => '5.0E3'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'Phi0Arc','default' => '0.5'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'MuArc','default' => '1.3'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ExpArc','min' => '0','default' => '3'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'WidthArc','min' => '0','default' => '0.5'},'content' => []},{'type' => 't','content' => '
#ARCADE
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'COMET PROBLEM TYPE'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!! COMET PROBLEM TYPE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'if' => '$_IsFirstSession','name' => 'COMET'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'ProdRate','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'UrNeutral','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'AverageMass','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'IonizationRate','min' => '0'},'content' => []},{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'real','name' => 'kFriction','min' => '0'},'content' => []},{'type' => 't','content' => '
#COMET
...
'}]}]},{'type' => 'e','name' => 'commandgroup','attrib' => {'name' => 'SCRIPT COMMANDS'},'content' => [{'type' => 't','content' => '
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!! SCRIPT COMMANDS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
'},{'type' => 'e','name' => 'command','attrib' => {'name' => 'INCLUDE'},'content' => [{'type' => 'e','name' => 'parameter','attrib' => {'type' => 'string','length' => '100','name' => 'NameIncludeFile','default' => 'Param/'},'content' => []},{'type' => 't','content' => '

#INCLUDE
Param/SSS_3000		NameIncludeFile

! Include a library file from Param/ or any file from anywhere else.
'}]}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '($SwRhoDim > 0) or $UseSolarWindFile or $_NameComp ne \'GM\''},'content' => [{'type' => 't','content' => '
	Either command #SOLARWIND or #SOLARWINDFILE must be used!
'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '$MaxImplBlock>1 or not $UsePartImplicit or not $MaxImplBlock'},'content' => [{'type' => 't','content' => '
	Part implicit scheme requires more than 1 implicit block!
'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '$MaxImplBlock==$MaxBlock or not $UseFullImplicit'},'content' => [{'type' => 't','content' => '
	Full implicit scheme should be used with equal number of 
	explicit and implicit blocks!
'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '-d $NameRestartOutDir or not $_IsFirstSession'},'content' => [{'type' => 't','content' => '
	Output restart directory $NameRestartOutDir should exist!
'}]},{'type' => 'e','name' => 'rule','attrib' => {'expr' => '-d $NamePlotDir or not $_IsFirstSession'},'content' => [{'type' => 't','content' => '
